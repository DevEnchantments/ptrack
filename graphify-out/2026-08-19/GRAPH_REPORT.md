...
## Corpus Check
- 377 files · ~180,031 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2721 nodes · 6483 edges · 143 communities (122 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6a63fdcb`
...
4. `@nestjs/swagger` - 60 edges
5. `DatabaseService` - 57 edges
6. `Button()` - 51 edges
...
Cohesion: 0.05
Nodes (32): CreateLookupValueDto, ApiProperty, ApiPropertyOptional, IsBoolean, IsIn, IsInt, IsOptional, IsString (+24 more)
...
Cohesion: 0.03
Nodes (88): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), Props, AddLinkDialog(), Props (+80 more)
...
Cohesion: 0.12
Nodes (16): DashboardModule, Module, DashboardActionItemRow, DashboardMilestoneRow, DashboardProjectRow, DashboardRepository, DashboardSource, DashboardSubmissionRow (+8 more)
...
Cohesion: 0.12
Nodes (22): AdjustWeightsDto, IsArray, Type, ValidateNested, CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray (+14 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (63): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+55 more)
...
Cohesion: 0.11
Nodes (25): formatDate(), initials(), PersonLike, personName(), relativeTime(), atOffset(), ActionItemsBreakdown(), ActivityLineChart() (+17 more)
...
Cohesion: 0.24
Nodes (7): ACTION_BODY, CyclesController, ReportsController, Controller, Cycle, Submission, SubmissionListItem
...
Cohesion: 0.11
Nodes (13): ReportsModule, Module, MilestoneDateRow, MilestoneProgressRow, Person, ReportProjectRow, ReportsRepository, SubmissionCycleRow (+5 more)
...
Cohesion: 0.11
Nodes (9): NotificationsController, Controller, NotificationsModule, Module, AppNotification, NotificationsRepository, Injectable, NotificationsService (+1 more)
...
Cohesion: 0.10
Nodes (29): AppLayout(), NAV_ITEMS, FromTemplateDialog(), NotificationBell(), timeAgo(), COLUMNS, ProjectsGrid(), ProjectTree() (+21 more)
...
Cohesion: 0.13
Nodes (25): ExportCsvDialog(), Props, StatusPill(), TONE_CLASSES, toneFor(), Props, TagChips(), Props (+17 more)

### Community 55 - "action-items.repository.ts"
Cohesion: 0.08
Nodes (23): 1. Baseline, measured 2026-08-18 on this branch, 2026-08-19 — B1, public surface per module, 2026-08-19 — B2 + B3, the rule and the last reach-in, 2026-08-19 — B4, contract conformance. **Phase B complete.**, 2026-08-19 — Clearing the register before Phase 1 (APPROVED BEHAVIOUR CHANGES), 2026-08-19 — Gate review, then one APPROVED BEHAVIOUR CHANGE, 2026-08-19 — Phase 0, `access-admin` (seam first, then net), 2026-08-19 — Phase 0, `kpis`. **The three high-value modules are done.** (+15 more)

### Community 56 - "@types/node"
Cohesion: 0.37
Nodes (5): SubmissionsController, ApiBody, Body, Param, Post
...
Cohesion: 0.14
Nodes (6): logger, DatabaseService, Injectable, Issue, IssueListItem, ProgramOutcome
...
Cohesion: 0.09
Nodes (20): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID (+12 more)
...
Cohesion: 0.09
Nodes (20): AuthUser, CurrentUser, Delete, Delete, Get, Param, Post, Delete (+12 more)
...
Cohesion: 0.49
Nodes (9): apiUpload(), apiDelete(), apiGet(), apiPatch(), apiPost(), apiPut(), authHeader(), handle() (+1 more)
...
Cohesion: 0.14
Nodes (13): Props, AppNotification, Cycle, CycleStatusReport, CycleStatusRow, dashboardApi, DashboardChartPoint, DashboardData (+5 more)

### Community 73 - ".add"
Cohesion: 0.19
Nodes (10): ProjectAccess(), PeopleController, ApiBody, Body, Controller, Delete, Param, Patch (+2 more)
...
Cohesion: 0.13
Nodes (50): STATUSES, FREQUENCIES, STATUSES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props (+42 more)
...
Cohesion: 0.05
Nodes (33): CreateProgramOutcomeDto, ApiProperty, ApiPropertyOptional, IsDateString, IsInt, IsOptional, IsString, MaxLength (+25 more)
...
Cohesion: 0.24
Nodes (3): toHttpException(), Injectable, UsersService

### Community 105 - "CreateRiskDto"
Cohesion: 0.08
Nodes (37): App(), ProtectedRoute(), Skeleton(), reportsApi, AuthContext, AuthContextValue, AuthProvider(), useAuth() (+29 more)
...
Cohesion: 0.43
Nodes (3): CAPABILITY_KEYS, GRANTABLE_ROLES, isCapability()
...
Cohesion: 0.21
Nodes (9): AppModule, Module, bootstrap(), AccessAdminModule, Module, IssuesModule, Module, PeopleModule (+1 more)

### Community 115 - "CreateMilestoneDto"
Cohesion: 0.15
Nodes (13): Props, Props, Props, Props, Props, Attachment, AttachmentDetail, ProjectSections (+5 more)
...
Cohesion: 0.16
Nodes (9): UpdateStatusReportDto, StatusReport, StatusReportDetail, StatusReportListItem, StatusReportsRepository, Injectable, COLUMN_SPEC, StatusReportsService (+1 more)
...
Cohesion: 0.06
Nodes (42): CommandPalette(), Entry, hitPath(), KIND_META, Props, accessApi, AdminLookupRow, adminLookupsApi (+34 more)
...
Cohesion: 0.25
Nodes (6): CreateStatusReportDto, ApiProperty, IsDateString, IsIn, IsString, MaxLength
...
Cohesion: 0.38
Nodes (5): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress()
...
## Knowledge Gaps
- **559 isolated node(s):** `DashboardProjectRow`, `DashboardActionItemRow`, `DashboardSubmissionRow`, `DashboardSource`, `ChartPoint` (+554 more)
...
- **Why does `fetchMe()` connect `status-reports.repository.ts` to `templates.service.ts`?**
  _High betweenness centrality (0.229) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `Community 20`, `Community 26`, `nest-cli.json`, `ProjectsRepository`, `CreateProjectDto`, `Community 44`, `nest-cli.json`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `StatusReportsController`, `eslint-plugin-react-hooks`, `action-items.repository.ts`, `ts-loader`, `project-sections.service.ts`, `eslint`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `Community 20`, `Community 26`, `nest-cli.json`, `ProjectsRepository`, `CreateProjectDto`, `Community 44`, `nest-cli.json`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `users.service.ts`, `templates.service.ts`, `ActionItemsController`, `StatusReportsController`, `eslint-plugin-react-hooks`, `action-items.repository.ts`, `ts-loader`, `project-sections.service.ts`, `eslint`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **What connects `DashboardProjectRow`, `DashboardActionItemRow`, `DashboardSubmissionRow` to the rest of the system?**
