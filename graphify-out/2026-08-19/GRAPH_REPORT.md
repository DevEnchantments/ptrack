...
Cohesion: 0.07
Nodes (26): riskScore(), CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString (+18 more)
...
Cohesion: 0.05
Nodes (55): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), AvatarCluster(), colorOf(), InitialsAvatar() (+47 more)
...
Cohesion: 0.15
Nodes (9): logger, toHttpException(), DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow, RegistryService (+1 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (44): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+36 more)
...
Cohesion: 0.10
Nodes (24): Props, Chip(), Kpi, KpiReading, kpisApi, calculatedProgress(), kpiAchievement(), kpiDataQuality() (+16 more)
...
Cohesion: 0.06
Nodes (51): App(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AddStatusReportDialog() (+43 more)
...
Cohesion: 0.13
Nodes (24): ExportCsvDialog(), Props, Props, SectionCard(), Props, TagChips(), Button(), buttonVariants (+16 more)
...
Cohesion: 0.06
Nodes (36): AuthUser, CurrentUser, Delete, Get, Delete, ApiBody, Body, Post (+28 more)
...
### Community 65 - ".add"
Cohesion: 0.11
Nodes (16): AppRole, categoriesApi, lookupCache, MyMembership, MyWork, MyWorkItem, peopleApi, rolesApi (+8 more)
...
Cohesion: 0.27
Nodes (8): MilestonesModule, Module, NotificationsModule, Module, ProjectsModule, Module, SubmissionsModule, Module
...
### Community 73 - ".add"
Cohesion: 0.29
Nodes (8): Props, Props, fmtAed(), ProjectOverviewCards(), Props, ProjectDetail, Issue, atRiskSuggested()
...
### Community 76 - ".add"
Cohesion: 0.09
Nodes (11): AuthedRequest, describeProjectScopedContract(), Mocks, ProjectScopedContract, DatabaseModule, Global, Module, DatabaseService (+3 more)

### Community 78 - "WorkflowPanel.tsx"
Cohesion: 0.09
Nodes (30): AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META, Props, AdminLookupRow (+22 more)
...
Cohesion: 0.12
Nodes (16): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), RequireCapability(), AccessLevel, PeopleController, ApiBody (+8 more)
...
Cohesion: 0.13
Nodes (15): AppModule, Module, bootstrap(), AccessAdminModule, Module, ImportModule, Module, RegistryModule (+7 more)
...
Cohesion: 0.39
Nodes (7): GlobalMilestone, milestonesApi, addDays(), iso(), statusClass(), TimelinePage(), VIEW_MODES

### Community 122 - "project-sections.service.ts"
Cohesion: 0.24
Nodes (3): ProgramOutcome, ProjectSectionsService, Injectable
...
Cohesion: 0.11
Nodes (14): ProjectAccessGuard, Injectable, ProjectAccessService, Injectable, ProjectsController, ApiBody, Body, Controller (+6 more)
...
## Knowledge Gaps
- **554 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+549 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 10`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `status-reports.repository.ts`, `Community 44`, `Community 50`, `@types/node`, `CreateMilestoneDto`, `PaginationQueryDto`, `links.service.ts`, `WorkflowPanel.tsx`, `status-reports.service.ts`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `StatusReportsController`, `DatabaseModule`, `ProgramOutcomesController`, `app.module.ts`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 10`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `status-reports.repository.ts`, `Community 44`, `Community 50`, `@types/node`, `CreateMilestoneDto`, `PaginationQueryDto`, `links.service.ts`, `WorkflowPanel.tsx`, `status-reports.service.ts`, `users.service.ts`, `templates.service.ts`, `StatusReportsController`, `DatabaseModule`, `ProgramOutcomesController`, `app.module.ts`?**
