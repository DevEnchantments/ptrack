...
Cohesion: 0.13
Nodes (14): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), logger, toHttpException(), ChartPoint, CLOSED_PROJECT (+6 more)
...
Cohesion: 0.15
Nodes (7): CAPABILITY_KEYS, GRANTABLE_ROLES, isCapability(), AccessAdminRepository, Injectable, AccessAdminService, Injectable
...
Cohesion: 0.05
Nodes (50): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddMilestoneDialog() (+42 more)
...
Cohesion: 0.15
Nodes (15): fmtAed(), ProjectOverviewCards(), atRiskSuggested(), calculatedProgress(), KpiReadingLike, KpiScoreInput, MilestoneProgressRow, PERIODS_PER_YEAR (+7 more)
...
Cohesion: 0.11
Nodes (19): AppLayout(), NAV_ITEMS, NotificationBell(), timeAgo(), usersApi, AppNotification, notificationsApi, atLeastRole() (+11 more)
...
Cohesion: 0.10
Nodes (17): ApiBody, PeopleController, PeopleModule, Module, PeopleRepository, Injectable, PeopleService, Injectable (+9 more)
...
Cohesion: 0.12
Nodes (27): Props, Props, apiUpload(), Attachment, AttachmentDetail, apiDelete(), apiGet(), apiPatch() (+19 more)
...
### Community 73 - ".add"
Cohesion: 0.24
Nodes (10): Props, Kpi, kpisApi, kpiAchievement(), kpiDataQuality(), formatValue(), KpiDetail(), KpisPage() (+2 more)
...
Cohesion: 0.20
Nodes (30): FREQUENCIES, STATUSES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Props (+22 more)

### Community 76 - ".add"
Cohesion: 0.08
Nodes (12): AuthedRequest, DatabaseService, Injectable, DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow (+4 more)

### Community 78 - "WorkflowPanel.tsx"
Cohesion: 0.20
Nodes (5): AccessAdminController, Controller, Get, ProfileRoleRow, ProfileRow
...
Cohesion: 0.09
Nodes (37): Props, Props, Props, Props, Props, Props, Props, Props (+29 more)
...
Cohesion: 0.21
Nodes (11): AppRole, CAPABILITIES, Capability, DEFAULT_GRANTS, GrantableRole, AppRoleGuard, Injectable, AppRoleService (+3 more)
...
Cohesion: 0.29
Nodes (9): APP_ROLES, atLeastRole(), defaultLevelFor(), isAppRole(), MEMBERSHIP_LEVEL, ProjectAccessInput, resolveProjectLevel(), base (+1 more)
...
Cohesion: 0.06
Nodes (47): App(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AddStatusReportDialog() (+39 more)
...
Cohesion: 0.50
Nodes (4): Chip(), personName(), STATUS_CHIP, WorkflowPanel()

### Community 113 - "ts-loader"
Cohesion: 0.12
Nodes (12): AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, LEVEL_LABEL, CreateCommentDto, ApiProperty, IsString (+4 more)

### Community 114 - "CreateLookupValueDto"
Cohesion: 0.12
Nodes (16): AppModule, Module, DatabaseModule, Global, Module, bootstrap(), AccessAdminModule, Module (+8 more)
...
Cohesion: 0.13
Nodes (16): COLUMN_SPEC, CREATE_DEFAULTS, Owners, ownersLabel(), CreateActionItemDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize (+8 more)
...
### Community 148 - "columnsFrom"
Cohesion: 0.24
Nodes (6): columnsFrom(), ColumnSpec, UpdateProgramOutcomeDto, ProgramOutcome, COLUMN_SPEC, CREATE_DEFAULTS
...
## Knowledge Gaps
- **555 isolated node(s):** `KpiReading`, `KpiActionPlan`, `1. Defects and gaps`, `2. Limits of the checks we have built`, `3. Closed` (+550 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `Community 1`, `.update`, `Community 6`, `Community 8`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 27`, `status-reports.repository.ts`, `Community 44`, `@types/node`, `@types/node`, `CreateMilestoneDto`, `PaginationQueryDto`, `links.service.ts`, `RecordHistoryService`, `WorkflowPanel.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ProgramOutcomesController`, `eslint-plugin-react-hooks`, `ts-loader`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `Community 1`, `.update`, `Community 6`, `Community 8`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 27`, `status-reports.repository.ts`, `Community 44`, `@types/node`, `@types/node`, `CreateMilestoneDto`, `PaginationQueryDto`, `links.service.ts`, `RecordHistoryService`, `WorkflowPanel.tsx`, `users.service.ts`, `templates.service.ts`, `ProgramOutcomesController`, `eslint-plugin-react-hooks`, `ts-loader`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **What connects `KpiReading`, `KpiActionPlan`, `1. Defects and gaps` to the rest of the system?**
