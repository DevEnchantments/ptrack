...
## Corpus Check
- 365 files · ~171,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2649 nodes · 6367 edges · 136 communities (113 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7cd22d72`
...
Cohesion: 0.07
Nodes (26): AccessLevel, riskScore(), CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional (+18 more)
...
Cohesion: 0.13
Nodes (11): ActionItemsController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (54): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), AvatarCluster(), colorOf(), InitialsAvatar() (+46 more)
...
Cohesion: 0.12
Nodes (17): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), logger, ChartPoint, CLOSED_PROJECT (+9 more)

### Community 17 - "CreateProjectDto"
Cohesion: 0.07
Nodes (28): describeProjectScopedContract(), Mocks, ProjectScopedContract, CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString (+20 more)
...
Cohesion: 0.09
Nodes (6): toHttpException(), Get, SubmissionsRepository, Injectable, Injectable, UsersService
...
Cohesion: 0.12
Nodes (26): ImportModule, Module, LinksModule, Module, MilestonesModule, Module, NotificationsModule, Module (+18 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.09
Nodes (34): Props, Button(), buttonVariants, Skeleton(), Chip(), personName(), STATUS_CHIP, WorkflowPanel() (+26 more)
...
Cohesion: 0.10
Nodes (20): 1. Baseline, measured 2026-08-18 on this branch, 2026-08-19 — B1, public surface per module, 2026-08-19 — B2 + B3, the rule and the last reach-in, 2026-08-19 — B4, contract conformance. **Phase B complete.**, 2026-08-19 — Gate review, then one APPROVED BEHAVIOUR CHANGE, 2026-08-19 — Phase 0, `access-admin` (seam first, then net), 2026-08-19 — Phase 0, `submissions` (safety net only, no refactor), 2. Ground rules (+12 more)
...
Cohesion: 0.13
Nodes (8): HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository, Injectable, normalizeOwnerIds(), ownersLabel()
...
Cohesion: 0.06
Nodes (30): LEVEL_LABEL, AuthUser, CurrentUser, Delete, DashboardController, Controller, Get, Delete (+22 more)
...
### Community 65 - ".add"
Cohesion: 0.10
Nodes (22): App(), AddIssueDialog(), emptyPerson(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES (+14 more)
...
Cohesion: 0.11
Nodes (25): AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META, Props, SavedSearch (+17 more)
...
Cohesion: 0.07
Nodes (53): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), PersonAutocomplete(), Props, Card() (+45 more)

### Community 82 - "🚀 Quick start"
Cohesion: 0.10
Nodes (29): Props, Props, Props, Props, Props, Props, Props, formatAed() (+21 more)
...
Cohesion: 0.15
Nodes (12): ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, ApiProperty, IsString (+4 more)
...
Cohesion: 0.09
Nodes (16): AccessAdminController, ApiBody, Body, Controller, Get, Param, Patch, AccessAdminModule (+8 more)
...
Cohesion: 0.40
Nodes (4): ActionItemsModule, Module, AttachmentsModule, Module
...
Cohesion: 0.17
Nodes (10): AdminOnly(), MinAppRole(), ReplaceGrantsDto, ApiProperty, IsArray, IsString, ApiProperty, IsIn (+2 more)
...
## Knowledge Gaps
- **554 isolated node(s):** `ProfileRoleRow`, `1. Defects and gaps`, `2. Limits of the checks we have built`, `3. Closed`, `4. Dismissed after investigation` (+549 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `columnsFrom`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 27`, `nest-cli.json`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `RecordHistoryService`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `PaginationQueryDto`, `links.service.ts`, `WorkflowPanel.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ProgramOutcomesController`, `app.module.ts`, `ts-loader`, `project-sections.service.ts`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `nest-cli.json` to `Community 1`, `columnsFrom`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 27`, `ProjectsRepository`, `CreateProjectDto`, `Community 44`, `nest-cli.json`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `.add`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `ActionItemsController`, `StatusReportsController`, `action-items.repository.ts`, `project-sections.service.ts`, `UpdateMeDto`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **What connects `ProfileRoleRow`, `1. Defects and gaps`, `2. Limits of the checks we have built` to the rest of the system?**
