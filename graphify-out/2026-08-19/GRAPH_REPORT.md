...
Cohesion: 0.14
Nodes (16): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), DashboardController, Controller, DashboardModule (+8 more)
...
Cohesion: 0.07
Nodes (42): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddStatusReportDialog() (+34 more)
...
Cohesion: 0.12
Nodes (23): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), Props, lookupsApi (+15 more)
...
Cohesion: 0.07
Nodes (38): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ProtectedRoute() (+30 more)
...
Cohesion: 0.10
Nodes (30): CategorySelect(), Props, Props, Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+22 more)

### Community 54 - "ProjectsController"
Cohesion: 0.07
Nodes (20): ProjectAccessRow, AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, ACCESS_LEVELS, AdminLookupRow (+12 more)
...
Cohesion: 0.13
Nodes (28): Props, Props, Props, Props, apiUpload(), Attachment, AttachmentDetail, apiDelete() (+20 more)

### Community 59 - "@types/node"
Cohesion: 0.08
Nodes (24): ApiSecurity, AppController, Controller, Get, AppModule, Module, AppService, Injectable (+16 more)
...
Cohesion: 0.08
Nodes (27): CreateTemplateDto, InstantiateTemplateDto, ApiProperty, ApiPropertyOptional, IsDateString, IsOptional, IsString, IsUUID (+19 more)

### Community 63 - "auth-context.tsx"
Cohesion: 0.06
Nodes (29): AuthUser, CurrentUser, ApiBody, Body, Delete, Patch, Post, Delete (+21 more)
...
Cohesion: 0.19
Nodes (9): AdminOnly(), MinAppRole(), AccessLevel, defaultLevelFor(), LEVEL_LABEL, ProjectAccessGuard, Injectable, ProjectAccessService (+1 more)
...
Cohesion: 0.08
Nodes (26): AddKpiDialog(), emptyPerson(), Props, AdminLookupRow, adminLookupsApi, AdminLookupTable, CapabilityInfo, DirectoryMembership (+18 more)
...
Cohesion: 0.11
Nodes (24): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES (+16 more)
...
Cohesion: 0.13
Nodes (6): logger, toHttpException(), KpisRepository, Injectable, KpisService, Injectable
...
Cohesion: 0.31
Nodes (7): CreateStatusReportDto, ApiProperty, IsDateString, IsIn, IsString, MaxLength, @nestjs/swagger
...
Cohesion: 0.40
Nodes (4): ImportModule, Module, ProjectsModule, Module
...
## Knowledge Gaps
- **542 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+537 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `Injectable`, `.update`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `ProjectsRepository`, `Community 44`, `RecordHistoryService`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `CreateLinkDto`, `RecordHistoryService`, `.add`, `README.md`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `DatabaseModule`, `CreateKpiDto`, `CreateRiskDto`, `ProjectsController`, `@nestjs/swagger`, `app.module.ts`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `Injectable`, `.update`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `ProjectsRepository`, `Community 44`, `RecordHistoryService`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `CreateLinkDto`, `.add`, `README.md`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `DatabaseModule`, `CreateKpiDto`, `CreateRiskDto`, `ProjectsController`, `@nestjs/swagger`, `app.module.ts`?**
