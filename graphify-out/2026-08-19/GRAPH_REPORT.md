...
Cohesion: 0.08
Nodes (25): TasksCard(), AppRole, categoriesApi, lookupCache, MyMembership, MyWork, MyWorkItem, peopleApi (+17 more)
...
Cohesion: 0.05
Nodes (48): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), NavSection (+40 more)
...
Cohesion: 0.19
Nodes (13): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), logger, ChartPoint, CLOSED_PROJECT (+5 more)
...
Cohesion: 0.06
Nodes (40): AddStatusReportDialog(), today(), AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts() (+32 more)
...
Cohesion: 0.20
Nodes (10): HistoryEntry, Project, ProjectDetail, ProjectListRow, ProjectListStats, COLUMN_SPEC, projectColumns(), ProjectsService (+2 more)
...
Cohesion: 0.09
Nodes (16): ApiConsumes, ApiBody, Body, Get, Param, Patch, Post, Query (+8 more)
...
Cohesion: 0.06
Nodes (60): ExportCsvDialog(), Props, Props, SectionCard(), Props, TagChips(), Button(), buttonVariants (+52 more)
...
Cohesion: 0.10
Nodes (24): Props, AdminLookupRow, adminLookupsApi, AdminLookupTable, CapabilityInfo, DirectoryMembership, DirectoryPerson, GlobalActionItem (+16 more)
...
Cohesion: 0.20
Nodes (22): Props, Props, Props, Props, Props, apiUpload(), Attachment, AttachmentDetail (+14 more)
...
Cohesion: 0.07
Nodes (30): ProjectAccess(), CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString (+22 more)
...
Cohesion: 0.09
Nodes (19): AuthUser, CurrentUser, Delete, Get, Delete, Delete, Delete, NotificationsController (+11 more)

### Community 64 - "PaginationQueryDto"
Cohesion: 0.09
Nodes (8): CyclesController, Cycle, Submission, SubmissionListItem, SubmissionsRepository, Injectable, SubmissionsService, Injectable

### Community 65 - ".add"
Cohesion: 0.11
Nodes (22): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+14 more)
...
Cohesion: 0.14
Nodes (5): toHttpException(), ProjectsRepository, Injectable, Injectable, UsersService
...
Cohesion: 0.21
Nodes (11): calculatedProgress(), KpiReadingLike, KpiScoreInput, MilestoneProgressRow, PERIODS_PER_YEAR, plannedProgress(), riskScore(), riskSeverityTone() (+3 more)
...
Cohesion: 0.16
Nodes (14): columnsFrom(), ColumnSpec, CreateProgramOutcomeDto, ApiProperty, ApiPropertyOptional, IsDateString, IsInt, IsOptional (+6 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.17
Nodes (39): STATUSES, FREQUENCIES, STATUSES, ACCESS_LEVELS, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect() (+31 more)

### Community 76 - ".add"
Cohesion: 0.11
Nodes (3): describeProjectScopedContract(), Mocks, ProjectScopedContract
...
Cohesion: 0.11
Nodes (18): App(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog() (+10 more)
...
Cohesion: 0.18
Nodes (12): emptyMember(), Props, StepAccess(), StepConfirmation(), Props, StepDetails(), Props, StepProject() (+4 more)
...
Cohesion: 0.16
Nodes (10): defaultLevelFor(), ProjectAccessInput, resolveProjectLevel(), base, LEVEL_LABEL, ProjectAccessGuard, Injectable, ProjectAccessRow (+2 more)

### Community 84 - "users.service.ts"
Cohesion: 0.09
Nodes (20): ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, ApiProperty, IsString (+12 more)

### Community 85 - "@nestjs/swagger"
Cohesion: 0.14
Nodes (19): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES (+11 more)
...
Cohesion: 0.14
Nodes (14): AppModule, Module, AccessModule, Global, Module, bootstrap(), AccessAdminModule, Module (+6 more)
...
Cohesion: 0.16
Nodes (12): AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, CreateCommentDto, ApiProperty, IsString, MinLength (+4 more)
...
Cohesion: 0.13
Nodes (17): CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn, IsNumber (+9 more)
...
Cohesion: 0.09
Nodes (12): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseModule, Global, Module, DatabaseService, Injectable (+4 more)
...
## Knowledge Gaps
- **546 isolated node(s):** `Mocks`, `ProjectScopedContract`, `1. Baseline, measured 2026-08-18 on this branch`, `Verification gate (all must pass before an item is ticked)`, `3. Per-session protocol` (+541 more)
...
- **Why does `fetchMe()` connect `Community 27` to `users.service.ts`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 20`, `Community 44`, `Community 45`, `@types/node`, `PeopleRepository`, `react-dom`, `RecordHistoryService`, `WorkflowPanel.tsx`, `.add`, `DatabaseService`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `app.module.ts`, `CreateLookupValueDto`, `attachments.controller.ts`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `RecordHistoryService` to `Community 1`, `Injectable`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `nest-cli.json`, `PeopleRepository`, `CreateMilestoneDto`, `PaginationQueryDto`, `react-dom`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `ActionItemsController`, `DatabaseModule`, `AuthUser`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ts-loader`, `CreateLookupValueDto`, `CreateMilestoneDto`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **What connects `Mocks`, `ProjectScopedContract`, `1. Baseline, measured 2026-08-18 on this branch` to the rest of the system?**
