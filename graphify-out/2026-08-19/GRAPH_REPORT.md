...
Cohesion: 0.06
Nodes (20): HistoryEntry, HistoryInsert, RecordHistoryService, Injectable, ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository (+12 more)
...
Cohesion: 0.12
Nodes (22): AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell() (+14 more)
...
Cohesion: 0.16
Nodes (8): CAPABILITY_KEYS, GRANTABLE_ROLES, isCapability(), AccessAdminController, Controller, Get, AccessAdminService, Injectable
...
Cohesion: 0.12
Nodes (31): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), CategorySelect(), Props (+23 more)
...
Cohesion: 0.05
Nodes (30): ApiConsumes, AttachmentsController, ApiBody, Body, Controller, Get, Param, Patch (+22 more)
...
Cohesion: 0.07
Nodes (43): App(), EditProjectDialog(), personFromProfile(), ProtectedRoute(), Props, SectionCard(), Skeleton(), Chip() (+35 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.20
Nodes (14): AdminOnly(), MinAppRole(), ProjectAccess(), AccessLevel, APP_ROLES, atLeastRole(), defaultLevelFor(), isAppRole() (+6 more)
...
Cohesion: 0.12
Nodes (9): DatabaseService, Injectable, DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow, RegistryService (+1 more)
...
Cohesion: 0.08
Nodes (22): AuthUser, CurrentUser, Delete, Get, Delete, Delete, NotificationsController, Controller (+14 more)
...
Cohesion: 0.19
Nodes (30): AddIssueDialog(), emptyPerson(), FREQUENCIES, ACCESS_LEVELS, AddRiskDialog(), emptyPerson(), EDITABLE_OPTIONS, VIEWABLE_OPTIONS (+22 more)
...
Cohesion: 0.05
Nodes (46): columnsFrom(), ColumnSpec, CreateActionItemDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize, IsArray, IsDateString (+38 more)
...
## Knowledge Gaps
- **543 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+538 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `react-dom`, `RecordHistoryService`, `WorkflowPanel.tsx`, `.add`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`, `app.module.ts`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `Community 16`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `react-dom`, `RecordHistoryService`, `WorkflowPanel.tsx`, `.add`, `users.service.ts`, `templates.service.ts`, `ActionItemsController`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`, `app.module.ts`?**
