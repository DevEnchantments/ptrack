...
## Corpus Check
- 358 files · ~164,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2617 nodes · 6016 edges · 127 communities (110 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f22ec7e`
...
Cohesion: 0.29
Nodes (9): Invalid, LookupOption, MILESTONE_STATUS, parseBoolValue(), parseDateValue(), parseMilestoneStatus(), parseNumberValue(), resolveLookup() (+1 more)
...
Cohesion: 0.07
Nodes (9): toHttpException(), ActionItemsRepository, Injectable, ProjectsRepository, Injectable, RisksRepository, Injectable, SubmissionsRepository (+1 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (16): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max, Min, Type, UpdateUpdateDto (+8 more)
...
Cohesion: 0.09
Nodes (13): CreateLinkDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsOptional, IsString, MaxLength (+5 more)
...
Cohesion: 0.05
Nodes (49): AddAttachmentDialog(), AddLinkDialog(), Props, AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), AvatarCluster(), colorOf() (+41 more)
...
Cohesion: 0.22
Nodes (11): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData, iso() (+3 more)
...
Cohesion: 0.12
Nodes (5): CyclesController, ReportsController, Controller, SubmissionsService, Injectable
...
Cohesion: 0.24
Nodes (7): UpdateLinkDto, ApiBody, Body, Get, Param, Patch, Post
...
Cohesion: 0.24
Nodes (7): UpdateProgramOutcomeDto, ApiBody, Body, Get, Param, Patch, Post
...
Cohesion: 0.08
Nodes (14): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, COLUMN_SPEC, CREATE_DEFAULTS (+6 more)
...
Cohesion: 0.13
Nodes (7): ImportRowResult, ImportSummary, COLUMN_SPEC, projectColumns(), ProjectsService, Injectable, utilizationRatio()
...
Cohesion: 0.07
Nodes (46): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ExportCsvDialog() (+38 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.08
Nodes (22): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, LinksController, Controller, UpdateMilestoneDto (+14 more)
...
Cohesion: 0.07
Nodes (23): AuthedRequest, logger, DatabaseService, Injectable, Kpi, KpiActionPlan, KpiListItem, KpiReading (+15 more)

### Community 55 - "action-items.repository.ts"
Cohesion: 0.12
Nodes (15): 1. Baseline, measured 2026-08-18 on this branch, 2026-08-19 — B1, public surface per module, 2. Ground rules, 3. Per-session protocol, 4. Decisions already taken, 5. Skill mapping, 6. Phases, 7. Deliberately out of scope (+7 more)
...
Cohesion: 0.07
Nodes (29): AuthUser, CurrentUser, Delete, Get, Delete, Delete, NotificationsController, Controller (+21 more)

### Community 64 - "PaginationQueryDto"
Cohesion: 0.14
Nodes (5): FIELD_KEYS, TemplateListItem, TemplateMilestone, TemplateOutcome, TemplatePayload
...
### Community 73 - ".add"
Cohesion: 0.10
Nodes (20): ApiBody, Body, Patch, Post, CreateActionItemDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize (+12 more)

### Community 74 - "DatabaseService"
Cohesion: 0.10
Nodes (23): Props, formatSize(), Props, TaskAttachments(), Button(), buttonVariants, Skeleton(), Chip() (+15 more)
...
Cohesion: 0.11
Nodes (19): NotificationBell(), timeAgo(), personName(), Props, STATUS_CHIP, WorkflowPanel(), AppNotification, Cycle (+11 more)
...
Cohesion: 0.05
Nodes (45): AddKpiDialog(), emptyPerson(), Props, AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath() (+37 more)
...
Cohesion: 0.08
Nodes (31): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, defaultLevelFor() (+23 more)
...
Cohesion: 0.30
Nodes (5): DatabaseModule, Global, Module, RegistryModule, Module
...
Cohesion: 0.16
Nodes (12): MilestoneProgressRow, HistoryEntry, HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, Milestone, MilestoneListItem (+4 more)
...
Cohesion: 0.16
Nodes (12): ArrayMinSize, ImportRowsDto, ApiProperty, ArrayMaxSize, IsArray, ImportController, ApiBody, Body (+4 more)
...
### Community 111 - "@nestjs/swagger"
Cohesion: 0.67
Nodes (3): AccessModule, Global, Module

### Community 112 - "app.module.ts"
Cohesion: 0.12
Nodes (17): CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString, IsUUID (+9 more)

### Community 119 - "project-sections.service.ts"
Cohesion: 0.12
Nodes (22): AccessAdminModule, Module, ImportModule, Module, KpisModule, MilestonesModule, Module, NotificationsModule (+14 more)
...
Cohesion: 0.24
Nodes (4): RegistryController, Controller, RegistryService, Injectable
...
## Knowledge Gaps
- **548 isolated node(s):** `Owners`, `COLUMN_SPEC`, `CREATE_DEFAULTS`, `ImportRowResult`, `ImportSummary` (+543 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `Injectable`, `.update`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 27`, `nest-cli.json`, `Community 44`, `Community 45`, `RecordHistoryService`, `@types/node`, `CreateMilestoneDto`, `RecordHistoryService`, `.add`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`, `app.module.ts`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `Community 5` to `Injectable`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `CreateProjectDto`, `ProjectsRepository`, `Community 44`, `Community 45`, `nest-cli.json`, `ProjectsController`, `PeopleRepository`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `CreateLookupValueDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`?**
