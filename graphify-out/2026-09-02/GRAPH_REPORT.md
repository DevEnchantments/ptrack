...
## Summary
- 2846 nodes · 6667 edges · 151 communities (128 shown, 23 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 277 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `221af437`
...
Cohesion: 0.06
Nodes (40): AdjustWeightsDialog(), SaveTemplateDialog(), SectionCard(), NavSection, Props, SectionNav(), projectAccessLevel(), kpiAchievement() (+32 more)
...
Cohesion: 0.17
Nodes (12): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData, iso() (+4 more)
...
Cohesion: 0.09
Nodes (16): ProjectAccessService, Injectable, toHttpException(), DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow (+8 more)
...
### Community 22 - "InitialsAvatar.tsx"
Cohesion: 0.47
...
Cohesion: 0.05
Nodes (31): ApiConsumes, ApiBody, Body, Get, Param, Patch, Post, Query (+23 more)
...
Cohesion: 0.04
Nodes (69): dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, Props, formatSize(), Props (+61 more)
...
Cohesion: 0.06
Nodes (31): classifyDue(), inSubmissionWindow(), ReminderKind, reminderType(), resolveRecipients(), submissionPendingType(), DueActionItem, DueMilestone (+23 more)
...
Cohesion: 0.05
Nodes (35): ProjectAccess(), CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString (+27 more)
...
Cohesion: 0.06
Nodes (30): AuthUser, CurrentUser, Delete, Get, Delete, NotificationsController, Controller, Get (+22 more)
...
Cohesion: 0.21
Nodes (10): ActionItemsController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+2 more)
...
### Community 73 - "submissions.service.ts"
Cohesion: 0.14
Nodes (12): HISTORY_SELECT, HistoryEntry, HistoryInsert, PROJECT_HISTORY_SELECT, ActionItem, ActionItemComment, ActionItemListItem, Milestone (+4 more)

### Community 74 - "ProfilePage.tsx"
Cohesion: 0.07
Nodes (34): App(), AppLayout(), NAV_ITEMS, ProtectedRoute(), usersApi, AuthContext, AuthContextValue, AuthProvider() (+26 more)
...
Cohesion: 0.07
Nodes (12): RISK_HIGH_THRESHOLD, riskScore(), NotificationsRepository, Injectable, NotificationsService, Injectable, Risk, RiskListItem (+4 more)

### Community 78 - "Milestone"
Cohesion: 0.11
Nodes (24): Props, Props, Props, Props, Props, formatAed(), milestoneShares(), MONTHS (+16 more)

### Community 79 - "@nestjs/swagger"
Cohesion: 0.10
Nodes (17): AdminOnly(), CAPABILITY_KEY, MIN_APP_ROLE_KEY, MinAppRole(), PROJECT_LEVEL_KEY, PROJECT_PARAM_KEY, ProjectScoped(), CreateCommentDto (+9 more)
...
Cohesion: 0.13
Nodes (17): Props, Props, fmtAed(), ProjectOverviewCards(), Props, Issue, Risk, atRiskSuggested() (+9 more)
...
Cohesion: 0.07
Nodes (17): logger, DatabaseService, Injectable, RecordHistoryService, Injectable, Issue, IssueListItem, Kpi (+9 more)
...
Cohesion: 0.05
Nodes (35): Props, CommandPalette(), Entry, hitPath(), KIND_META, Props, AdminLookupRow, adminLookupsApi (+27 more)
...
- **Why does `toHttpException()` connect `toHttpException` to `import.service.ts`, `ActionItemsRepository`, `links.service.ts`, `resources.controller.ts`, `lookups.service.ts`, `dashboard.service.ts`, `CreateIssueDto`, `updates.controller.ts`, `projects.service.ts`, `attachments.service.ts`, `SubmissionsService`, `people.controller.ts`, `MilestonesService`, `.instantiate`, `submissions.service.ts`, `risks.service.ts`, `DatabaseService`, `users.service.ts`, `access.logic.ts`, `status-reports.service.ts`, `RequireCapability`, `ProgramOutcomesService`, `templates.service.ts`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `AuthUser` to `import.service.ts`, `.add`, `access-admin.controller.ts`, `links.service.ts`, `dashboard.controller.ts`, `resources.controller.ts`, `CreateIssueDto`, `updates.controller.ts`, `search.controller.ts`, `attachments.service.ts`, `SubmissionsService`, `MilestonesController`, `people.controller.ts`, `.instantiate`, `ActionItemsController`, `@nestjs/swagger`, `users.service.ts`, `access.logic.ts`, `status-reports.service.ts`, `RequireCapability`, `risks.controller.ts`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `AuthUser` to `import.service.ts`, `.add`, `access-admin.controller.ts`, `links.service.ts`, `dashboard.controller.ts`, `resources.controller.ts`, `CreateIssueDto`, `updates.controller.ts`, `search.controller.ts`, `attachments.service.ts`, `SubmissionsService`, `MilestonesController`, `people.controller.ts`, `.instantiate`, `ActionItemsController`, `@nestjs/swagger`, `users.service.ts`, `access.logic.ts`, `status-reports.service.ts`, `RequireCapability`, `risks.controller.ts`?**
