...
## Corpus Check
- 170 files · ~67,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 2728 edges · 81 communities (68 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28ec5f14`
...
Cohesion: 0.14
Nodes (10): IssuesController, ApiBody, Body, Controller, Get, Param, Patch, Post (+2 more)
...
Cohesion: 0.05
Nodes (50): EditProjectDialog(), Props, initials(), Props, RecordHistory(), relativeTime(), username(), StatusPill() (+42 more)
...
Cohesion: 0.27
Nodes (3): StepConfirmation(), Props, StepDetails()
...
Cohesion: 0.15
Nodes (10): AuthUser, CurrentUser, Delete, Delete, Delete, Delete, Patch, Delete (+2 more)
...
Cohesion: 0.23
Nodes (10): logger, toHttpException(), Attachment, AttachmentDetail, AttachmentListItem, StatusReport, StatusReportDetail, StatusReportListItem (+2 more)
...
Cohesion: 0.13
Nodes (6): RecordHistoryService, Injectable, Issue, IssueListItem, IssuesRepository, Injectable
...
Cohesion: 0.15
Nodes (11): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsIn, IsOptional, IsString, IsUUID, MaxLength (+3 more)
...
Cohesion: 0.07
Nodes (33): App(), AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry (+25 more)
...
### Community 57 - ".update"
Cohesion: 0.11
Nodes (27): Props, Props, Props, Props, ActionItemComment, ActionItemOwner, apiDelete(), apiGet() (+19 more)

### Community 58 - "reflect-metadata"
Cohesion: 0.07
Nodes (33): ApiSecurity, AppController, Controller, Get, AppModule, Module, AppService, Injectable (+25 more)

### Community 59 - "@types/node"
Cohesion: 0.12
Nodes (29): Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, Props, ConfirmDeleteButton(), Props (+21 more)
...
Cohesion: 0.30
Nodes (5): PeopleController, Controller, PeopleService, Injectable, @nestjs/swagger

### Community 62 - "StepDetails.tsx"
Cohesion: 0.10
Nodes (31): Props, Props, SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton() (+23 more)
...
Cohesion: 0.22
Nodes (4): Delete, Param, PeopleRepository, Injectable
...
Cohesion: 0.25
Nodes (6): ApiPropertyOptional, IsIn, IsOptional, IsString, IsUUID, UpdatePersonDto
...
### Community 71 - "AddStatusReportDialog.tsx"
Cohesion: 0.27
Nodes (10): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), Props, STATUSES, today(), Milestone (+2 more)

### Community 74 - "AddPersonDialog.tsx"
Cohesion: 0.23
Nodes (10): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, PersonAutocomplete(), Props, peopleApi (+2 more)

### Community 75 - "class-validator"
Cohesion: 0.47
Nodes (4): colorOf(), InitialsAvatar(), initialsOf(), PALETTE

## Knowledge Gaps
- **350 isolated node(s):** `Token changes — SHIPPED in Stage 1 (2026-07-29), re-measured after landing`, `A. Tokens + `components/ui` primitives — severity HIGH, effort M`, `B. Dialogs (10 Add*/Edit*) — severity HIGH, effort M`, `C. Detail pages — severity HIGH, effort M-L`, `D. AppLayout + CommandPalette — severity MED, effort S` (+345 more)
...
- **Why does `toHttpException()` connect `Community 27` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 26`, `nest-cli.json`, `Community 34`, `CreateProjectDto`, `CreateProjectDto`, `nest-cli.json`, `status-reports.repository.ts`, `@types/node`, `UpdatesService`, `RecordHistory.tsx`, `attachments.repository.ts`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 2`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `AttachmentDetailPage.tsx`, `Community 28`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `Community 1`, `Community 2`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `AttachmentDetailPage.tsx`, `Community 28`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
