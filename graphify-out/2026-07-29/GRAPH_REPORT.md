...
## Summary
- 1408 nodes · 2597 edges · 82 communities (71 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f67093fd`
...
Cohesion: 0.13
Nodes (20): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), DialogContent() (+12 more)
...
Cohesion: 0.09
Nodes (29): EditProjectDialog(), Props, SectionCard(), NavSection, Props, SectionNav(), ACTIONS, attachmentUploader() (+21 more)
...
Cohesion: 0.17
Nodes (15): PersonAutocomplete(), Props, Lookup, lookupsApi, usersApi, UserSummary, emptyMember(), StepAccess() (+7 more)
...
Cohesion: 0.18
Nodes (14): Props, Button(), buttonVariants, Skeleton(), statusReportsApi, usePageTitle(), HomePage(), initials() (+6 more)
...
Cohesion: 0.13
Nodes (19): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), Props, STATUSES, today(), milestonesApi (+11 more)
...
Cohesion: 0.16
Nodes (14): App(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, ProtectedRoute() (+6 more)

### Community 55 - "AttachmentDetailPage.tsx"
Cohesion: 0.17
Nodes (14): KIND_CLASSES, TOAST_MS, Toaster(), ToastItem, attachmentsApi, Listener, subscribeToasts(), toast (+6 more)
...
### Community 57 - ".update"
Cohesion: 0.08
Nodes (33): ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost(), apiUpload(), Attachment, AttachmentDetail (+25 more)
...
Cohesion: 0.16
Nodes (14): AddAttachmentDialog(), Props, AddIssueDialog(), emptyPerson(), Props, AddLinkDialog(), Props, AddResourceDialog() (+6 more)
...
Cohesion: 0.21
Nodes (12): CategorySelect(), Props, Input(), Label(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue() (+4 more)
...
### Community 78 - "attachments.repository.ts"
Cohesion: 0.83
...
## Knowledge Gaps
- **355 isolated node(s):** `Token changes — SHIPPED in Stage 1 (2026-07-29), re-measured after landing`, `A. Tokens + `components/ui` primitives — severity HIGH, effort M`, `B. Dialogs (10 Add*/Edit*) — severity HIGH, effort M`, `C. Detail pages — severity HIGH, effort M-L`, `D. AppLayout + CommandPalette — severity MED, effort S` (+350 more)
...
- **Why does `toHttpException()` connect `Community 27` to `UpdatesService`, `nest-cli.json`, `Community 2`, `Community 1`, `CreateProjectDto`, `Community 5`, `Community 6`, `Community 8`, `DatabaseModule`, `CreateProjectDto`, `Community 10`, `Community 12`, `attachments.repository.ts`, `nest-cli.json`, `status-reports.repository.ts`, `@types/node`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
