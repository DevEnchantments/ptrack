...
## Corpus Check
- 170 files · ~67,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 2925 edges · 81 communities (69 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa560f28`
...
Cohesion: 0.10
Nodes (28): AddResourceDialog(), AddUpdateDialog(), NavSection, Props, SectionNav(), ACTIONS, attachmentUploader(), collapsePrefsKey() (+20 more)
...
Cohesion: 0.16
Nodes (17): PersonAutocomplete(), Props, emptyMember(), Listener, toast, Props, StepAccess(), StepConfirmation() (+9 more)
...
Cohesion: 0.23
Nodes (9): logger, toHttpException(), Issue, IssueListItem, Link, LinkListItem, StatusReport, StatusReportDetail (+1 more)
...
Cohesion: 0.16
Nodes (5): AuthedRequest, DatabaseService, Injectable, Resource, ResourceListItem
...
Cohesion: 0.14
Nodes (16): App(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, ProtectedRoute() (+8 more)

### Community 55 - "AttachmentDetailPage.tsx"
Cohesion: 0.21
Nodes (12): usePageTitle(), AttachmentDetailPage(), formatSize(), longDate(), relativeTime(), uploaderName(), HomePage(), initials() (+4 more)
...
### Community 57 - ".update"
Cohesion: 0.14
Nodes (21): Props, Props, Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost() (+13 more)
...
Cohesion: 0.10
Nodes (32): AddAttachmentDialog(), Props, AddIssueDialog(), emptyPerson(), Props, AddLinkDialog(), Props, AddStatusReportDialog() (+24 more)
...
Cohesion: 0.20
Nodes (25): CategorySelect(), Props, EditProjectDialog(), Props, Input(), Label(), SelectContent(), SelectGroup() (+17 more)
...
- **Why does `toHttpException()` connect `Community 27` to `nest-cli.json`, `Community 2`, `Community 1`, `Community 34`, `CreateProjectDto`, `Community 6`, `Community 5`, `Community 8`, `DatabaseModule`, `CreateProjectDto`, `Community 10`, `Community 12`, `attachments.repository.ts`, `status-reports.repository.ts`, `@types/node`, `Community 26`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `Community 34`, `.update`, `Community 6`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `PeopleRepository`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `Community 34`, `.update`, `Community 6`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `nest-cli.json`, `PeopleRepository`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
