...
## Corpus Check
- 218 files · ~89,416 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1718 nodes · 3780 edges · 90 communities (74 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97f2d510`
...
4. `DatabaseService` - 45 edges
5. `@nestjs/swagger` - 43 edges
6. `cn()` - 36 edges
7. `Button()` - 33 edges
...
Cohesion: 0.16
Nodes (15): StatusPill(), TONE_CLASSES, toneFor(), actionItemsApi, auditLine(), formatLongDate(), MilestoneDetailPage(), MONTHS (+7 more)
...
Cohesion: 0.07
Nodes (31): AuthUser, CurrentUser, PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max, Min (+23 more)
...
Cohesion: 0.05
Nodes (30): ArrayMaxSize, HistoryInsert, ActionItemsController, Controller, Get, Param, ActionItem, ActionItemComment (+22 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.10
Nodes (28): Props, Props, Props, ACTIONS, Entry, Props, Props, Props (+20 more)
...
Cohesion: 0.13
Nodes (31): AddIssueDialog(), emptyPerson(), Props, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, Props (+23 more)
...
Cohesion: 0.15
Nodes (17): App(), attachmentsApi, CycleStatusReport, reportsApi, AuthProvider(), usePageTitle(), AttachmentDetailPage(), formatSize() (+9 more)
...
Cohesion: 0.13
Nodes (29): AddRiskDialog(), emptyPerson(), CategorySelect(), Props, EditProjectDialog(), personFromProfile(), PersonAutocomplete(), Props (+21 more)
...
Cohesion: 0.16
Nodes (14): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, NotificationBell(), timeAgo(), AppNotification (+6 more)

### Community 89 - "ProjectsGrid.tsx"
Cohesion: 0.13
Nodes (19): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), Props, STATUSES, today() (+11 more)
...
## Knowledge Gaps
- **360 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+355 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 34`, `ProjectsRepository`, `Community 5`, `status-reports.repository.ts`, `Community 7`, `Community 10`, `Community 12`, `Community 45`, `nest-cli.json`, `CreateProjectDto`, `RecordHistoryService`, `Community 20`, `ProjectsController`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 13`, `nest-cli.json`, `Community 16`, `CreateProjectDto`, `RecordHistoryService`, `action-items.repository.ts`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 13`, `nest-cli.json`, `Community 16`, `CreateProjectDto`, `RecordHistoryService`, `action-items.repository.ts`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
