...
## Summary
- 1650 nodes · 3584 edges · 94 communities (74 shown, 20 thin omitted)
...
Cohesion: 0.09
Nodes (23): devDependencies, eslint, @eslint/eslintrc, @eslint/js, eslint-plugin-prettier, globals, jest, @nestjs/cli (+15 more)
...
Cohesion: 0.13
Nodes (20): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), milestonesApi, outcomesApi (+12 more)
...
Cohesion: 0.11
Nodes (15): AuthUser, CurrentUser, ApiBody, Body, Patch, Post, Delete, Delete (+7 more)
...
Cohesion: 0.22
Nodes (9): calculatedProgress(), MilestoneProgressRow, plannedProgress(), Project, ProjectDetail, ProjectListRow, ProjectListStats, SubmissionsModule (+1 more)
...
Cohesion: 0.07
Nodes (37): Props, Props, Props, Props, Props, ACTIONS, CommandPalette(), Entry (+29 more)
...
Cohesion: 0.21
Nodes (29): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props (+21 more)
...
Cohesion: 0.14
Nodes (19): Props, Button(), buttonVariants, Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+11 more)
...
Cohesion: 0.09
Nodes (26): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog() (+18 more)
...
- **Why does `toHttpException()` connect `Community 16` to `Community 1`, `Community 2`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 7`, `Community 9`, `CreateProjectDto`, `Community 10`, `Community 44`, `Community 12`, `nest-cli.json`, `Community 13`, `RecordHistoryService`, `ProjectsController`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `status-reports.repository.ts`, `Community 7`, `Community 10`, `Community 44`, `tw-animate-css`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `ApiPropertyOptional`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `status-reports.repository.ts`, `Community 7`, `Community 10`, `Community 44`, `tw-animate-css`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `ApiPropertyOptional`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
