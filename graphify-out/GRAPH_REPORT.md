...
## Corpus Check
- 262 files · ~163,595 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3256 nodes · 5133 edges · 205 communities (169 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 107 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `238e9d62`
...
## Communities (205 total, 36 thin omitted)
...
Cohesion: 0.06
Nodes (30): ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn, IsInt, IsNumber, IsOptional (+22 more)
...
Cohesion: 0.10
Nodes (19): AppModule, Module, bootstrap(), ActionItemsModule, Module, IssuesModule, Module, LinksModule (+11 more)
...
Cohesion: 0.18
Nodes (12): AttachmentsModule, Module, Attachment, AttachmentDetail, AttachmentListItem, UploadedFileLike, ApiPropertyOptional, IsArray (+4 more)
...
Cohesion: 0.15
Nodes (14): AuthUser, CurrentUser, ActionItemsController, ApiBody, Body, Controller, Delete, Get (+6 more)
...
Cohesion: 0.07
Nodes (23): AuthedRequest, SupabaseAuthGuard, Injectable, HistoryEntry, HistoryInsert, logger, DatabaseService, Injectable (+15 more)
...
### Community 57 - ".update"
Cohesion: 0.08
Nodes (22): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Min, Type, CreateUpdateDto, ApiProperty (+14 more)
...
## Knowledge Gaps
- **1197 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+1192 more)
...
- **Why does `toHttpException()` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `CreateProjectDto`, `Community 10`, `Community 12`, `Community 13`, `.update`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `.add`, `Community 1`, `Community 2`, `Community 5`, `StatusPill.tsx`, `.add`, `Community 8`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `RecordHistoryService`, `Community 20`, `CreateActionItemDto`, `Community 27`, `PeopleRepository`, `.update`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `.add`, `Community 1`, `Community 2`, `Community 5`, `StatusPill.tsx`, `.add`, `Community 8`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `RecordHistoryService`, `Community 20`, `CreateActionItemDto`, `Community 27`, `PeopleRepository`, `.update`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
