...
## Summary
- 1565 nodes · 3331 edges · 84 communities (74 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11072d85`
...
Cohesion: 0.17
Nodes (15): AddStatusReportDialog(), Props, today(), StatusReport, StatusReportDetail, usePageTitle(), AttachmentDetailPage(), formatSize() (+7 more)
...
Cohesion: 0.08
Nodes (38): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), NavSection, Props, SectionNav() (+30 more)
...
Cohesion: 0.29
Nodes (5): UpdateLinkDto, LinksController, Controller, LinksService, Injectable
...
Cohesion: 0.05
Nodes (122): STATUSES, Props, Props, Props, AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName() (+114 more)
...
- **Why does `toHttpException()` connect `react-dom` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 26`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `nest-cli.json`, `status-reports.repository.ts`, `RecordHistoryService`, `AttachmentDetailPage.tsx`, `PeopleRepository`, `CreateLinkDto`, `CreateRiskDto`, `CreatePersonDto`, `.update`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `.add`, `Community 26`, `Community 5`, `Community 7`, `status-reports.repository.ts`, `.add`, `Community 10`, `CreateProjectDto`, `tw-animate-css`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `@nestjs/swagger`, `PeopleRepository`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `.add`, `Community 26`, `Community 5`, `Community 7`, `status-reports.repository.ts`, `.add`, `Community 10`, `CreateProjectDto`, `tw-animate-css`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `@nestjs/swagger`, `PeopleRepository`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
