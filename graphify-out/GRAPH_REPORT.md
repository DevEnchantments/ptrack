...
## Corpus Check
- 379 files · ~181,411 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2739 nodes · 6483 edges · 136 communities (116 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `730f6fe9`
...
Cohesion: 0.07
Nodes (23): CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString, IsUUID (+15 more)
...
Cohesion: 0.05
Nodes (52): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), SectionCard() (+44 more)
...
Cohesion: 0.05
Nodes (36): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), DashboardController, Controller, DashboardModule (+28 more)
...
Cohesion: 0.16
Nodes (5): DatabaseService, Injectable, Cycle, Submission, SubmissionListItem
...
Cohesion: 0.08
Nodes (10): logger, toHttpException(), AttachmentsRepository, Injectable, Risk, RiskListItem, RisksRepository, Injectable (+2 more)
...
Cohesion: 0.05
Nodes (35): HistoryEntry, HistoryInsert, ActionItemsController, ApiBody, Body, Controller, Delete, Get (+27 more)

### Community 59 - "@types/node"
Cohesion: 0.12
Nodes (16): columnsFrom(), ColumnSpec, COLUMN_SPEC, CREATE_DEFAULTS, CreateProgramOutcomeDto, ApiProperty, ApiPropertyOptional, IsDateString (+8 more)
...
Cohesion: 0.07
Nodes (27): AuthUser, CurrentUser, Get, Delete, NotificationsController, Controller, Get, Param (+19 more)
...
Cohesion: 0.18
Nodes (20): Props, apiUpload(), AttachmentDetail, apiDelete(), apiGet(), apiPatch(), apiPost(), apiPut() (+12 more)
...
### Community 73 - ".add"
Cohesion: 0.12
Nodes (14): ApiTags, AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, CreateCommentDto, ApiProperty, IsString (+6 more)
...
Cohesion: 0.08
Nodes (45): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), CategorySelect(), Props (+37 more)
...
Cohesion: 0.06
Nodes (34): ApiConsumes, AttachmentsController, ApiBody, Body, Controller, Delete, Get, Param (+26 more)
...
Cohesion: 0.06
Nodes (45): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ProtectedRoute() (+37 more)
...
Cohesion: 0.10
Nodes (19): AppModule, Module, bootstrap(), AccessAdminModule, Module, ImportModule, Module, KpisModule (+11 more)
...
## Knowledge Gaps
- **569 isolated node(s):** `COLUMN_SPEC`, `COLUMN_SPEC`, `CREATE_DEFAULTS`, `GateProject`, `GateMilestone` (+564 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 10`, `CreateProjectDto`, `Community 20`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 45`, `@types/node`, `@nestjs/swagger`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `users.service.ts`, `eslint-plugin-react-hooks`, `project-sections.service.ts`, `ProjectSectionsController`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 10`, `CreateProjectDto`, `Community 20`, `CreateProjectDto`, `Community 45`, `@types/node`, `@nestjs/swagger`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `users.service.ts`, `eslint-plugin-react-hooks`, `project-sections.service.ts`, `ProjectSectionsController`?**
