...
## Corpus Check
- 171 files · ~68,530 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1425 nodes · 2890 edges · 89 communities (70 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebb60f66`
...
10. `RecordHistoryService` - 20 edges
...
Cohesion: 0.07
Nodes (25): ApiProperty, ApiPropertyOptional, CreateIssueDto, UpdateIssueDto, IssuesController, ApiBody, Body, Controller (+17 more)
...
Cohesion: 0.09
Nodes (24): CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn, IsNumber (+16 more)
...
Cohesion: 0.15
Nodes (21): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, Props, ActionItemOwner, apiDelete() (+13 more)
...
Cohesion: 0.10
Nodes (29): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), EditProjectDialog(), ACTIONS, attachmentUploader(), collapsePrefsKey() (+21 more)
...
Cohesion: 0.12
Nodes (15): AuthUser, CurrentUser, Delete, Delete, Delete, Delete, Delete, ApiBody (+7 more)
...
Cohesion: 0.09
Nodes (31): dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, ProjectListItem, usePageTitle(), DashboardPage() (+23 more)
...
Cohesion: 0.17
Nodes (22): CategorySelect(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+14 more)
...
Cohesion: 0.12
Nodes (14): HistoryEntry, HistoryInsert, logger, toHttpException(), ActionItem, ActionItemComment, ActionItemListItem, ACCESS_LEVELS (+6 more)
...
Cohesion: 0.15
Nodes (13): App(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, ProtectedRoute() (+5 more)
...
Cohesion: 0.21
Nodes (14): PersonAutocomplete(), Props, usersApi, UserSummary, emptyMember(), Props, StepAccess(), Props (+6 more)
...
Cohesion: 0.13
Nodes (27): Props, Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, Props, ConfirmDeleteButton() (+19 more)
...
Cohesion: 0.23
Nodes (10): Props, Props, categoriesApi, Lookup, lookupsApi, Project, ProjectDetail, Listener (+2 more)
...
Cohesion: 0.47
Nodes (5): AddIssueDialog(), emptyPerson(), Props, Issue, issuesApi
...
### Community 75 - "@types/node"
Cohesion: 0.50
Nodes (3): supabase, supabaseKey, supabaseUrl

## Knowledge Gaps
- **342 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+337 more)
...
- **Why does `toHttpException()` connect `status-reports.repository.ts` to `Community 1`, `CreateProjectDto`, `Community 5`, `status-reports.repository.ts`, `Community 8`, `Community 10`, `Community 12`, `nest-cli.json`, `.update`, `Community 26`, `Community 27`, `PeopleRepository`?**
