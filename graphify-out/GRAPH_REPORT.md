...
## Corpus Check
- 337 files · ~153,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2527 nodes · 6094 edges · 134 communities (113 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e0e4d6a`
...
Cohesion: 0.06
Nodes (29): HistoryInsert, ActionItemsController, ApiBody, Body, Controller, Get, Param, Post (+21 more)
...
Cohesion: 0.20
Nodes (10): ACTION_BODY, CyclesController, ReportsController, SubmissionsController, ApiBody, Body, Controller, Get (+2 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (17): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ProtectedRoute() (+9 more)
...
Cohesion: 0.11
Nodes (19): CreateResourceDto, ApiProperty, ApiPropertyOptional, IsOptional, IsString, IsUUID, MaxLength, UpdateResourceDto (+11 more)
...
Cohesion: 0.06
Nodes (46): AddAttachmentDialog(), AddLinkDialog(), Props, AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog() (+38 more)
...
Cohesion: 0.17
Nodes (14): ProjectAccessRow, calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData (+6 more)
...
Cohesion: 0.14
Nodes (10): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, Owners, COLUMN_SPEC (+2 more)
...
Cohesion: 0.05
Nodes (51): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), dateParts() (+43 more)
...
Cohesion: 0.10
Nodes (35): ExportCsvDialog(), FromTemplateDialog(), COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow, StatusPill() (+27 more)
...
Cohesion: 0.12
Nodes (11): toHttpException(), Project, ProjectDetail, ProjectListRow, ProjectListStats, ProjectsRepository, Injectable, COLUMN_SPEC (+3 more)
...
Cohesion: 0.09
Nodes (36): Props, NavSection, Props, Button(), buttonVariants, Skeleton(), Chip(), personName() (+28 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.14
Nodes (14): AppModule, Module, DatabaseModule, Global, Module, bootstrap(), AccessAdminModule, Module (+6 more)
...
Cohesion: 0.09
Nodes (17): logger, DatabaseService, Injectable, Issue, IssueListItem, ProgramOutcome, Resource, ResourceListItem (+9 more)
...
Cohesion: 0.08
Nodes (22): AuthUser, CurrentUser, Delete, Patch, Delete, DashboardController, Controller, Get (+14 more)
...
Cohesion: 0.12
Nodes (23): CategorySelect(), Props, Props, SelectContent(), SelectItem(), SelectTrigger(), categoriesApi, sectorsApi (+15 more)
...
### Community 73 - ".add"
Cohesion: 0.12
Nodes (9): AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, LEVEL_LABEL, UpdateActionItemDto, RisksController, Controller (+1 more)
...
Cohesion: 0.16
Nodes (36): FREQUENCIES, AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), ACCESS_LEVELS (+28 more)
...
Cohesion: 0.30
Nodes (9): APP_ROLES, atLeastRole(), DEFAULT_GRANTS, defaultLevelFor(), isAppRole(), MEMBERSHIP_LEVEL, ProjectAccessInput, resolveProjectLevel() (+1 more)
...
Cohesion: 0.10
Nodes (13): CAPABILITY_KEYS, ApiProperty, IsString, MaxLength, UpdateMeDto, Body, Controller, Get (+5 more)
...
Cohesion: 0.27
Nodes (7): MilestoneProgressRow, HistoryEntry, ActionItem, ActionItemComment, ActionItemListItem, Milestone, MilestoneListItem
...
### Community 123 - "lookups.service.ts"
Cohesion: 0.22
...
### Community 126 - "templates.module.ts"
Cohesion: 0.40
...
## Knowledge Gaps
- **511 isolated node(s):** `1. Where the project stands`, `2. What is built, by area`, `3. The fifteen functional requirements, one by one`, `4. Decisions taken under your delegation (18 August)`, `5. The two remaining items` (+506 more)
...
- **Why does `fetchMe()` connect `Community 9` to `.grants`?**
  _High betweenness centrality (0.218) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `CreateProjectDto` to `Community 1`, `Injectable`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 20`, `Community 27`, `ProjectsRepository`, `Community 44`, `Community 45`, `ProjectsController`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `PaginationQueryDto`, `CreateLinkDto`, `WorkflowPanel.tsx`, `DatabaseService`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `AuthUser`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ts-jest`, `project-sections.service.ts`, `ResourcesRepository`, `lookups.service.ts`, `.grants`?**
  _High betweenness centrality (0.152) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `Community 1`, `Community 5`, `Community 6`, `.update`, `Community 7`, `Community 10`, `Community 11`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 45`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `PaginationQueryDto`, `.add`, `README.md`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `ActionItemsController`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `app.module.ts`, `ProgramOutcomesService`, `.grants`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **What connects `1. Where the project stands`, `2. What is built, by area`, `3. The fifteen functional requirements, one by one` to the rest of the system?**
