...
## Summary
- 1829 nodes · 4085 edges · 91 communities (80 shown, 11 thin omitted)
...
Cohesion: 0.14
Nodes (14): AppModule, Module, DatabaseModule, Module, bootstrap(), ActionItemsModule, Module, KpisModule (+6 more)
...
Cohesion: 0.12
Nodes (16): AttachmentsModule, Module, IssuesModule, Module, LinksModule, Module, MilestonesModule, Module (+8 more)
...
Cohesion: 0.06
Nodes (114): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+106 more)
...
Cohesion: 0.06
Nodes (41): Props, Props, Props, Props, Props, Props, ActionItemOwner, apiDelete() (+33 more)
...
Cohesion: 0.09
Nodes (23): logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue, IssueListItem (+15 more)
...
Cohesion: 0.40
Nodes (4): NotificationsModule, Module, SubmissionsModule, Module
...
### Community 73 - ".add"
Cohesion: 0.10
Nodes (21): ArrayMaxSize, RecordHistoryService, Injectable, ActionItemsService, Owners, Injectable, CreateActionItemDto, ApiProperty (+13 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.16
Nodes (16): App(), Chip(), attachmentsApi, CycleStatusReport, reportsApi, AuthProvider(), usePageTitle(), AttachmentDetailPage() (+8 more)
...
Cohesion: 0.24
Nodes (10): COLUMNS, ProjectsGrid(), StatusPill(), TONE_CLASSES, toneFor(), Project, ProjectListItem, GridSort (+2 more)

### Community 89 - "ProjectsGrid.tsx"
Cohesion: 0.19
Nodes (10): AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, NotificationBell(), timeAgo() (+2 more)
...
## Knowledge Gaps
- **368 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+363 more)
...
- **Why does `toHttpException()` connect `nest-cli.json` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `WorkflowPanel.tsx`, `transform`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `@types/node`, `Community 1`, `Community 34`, `nest-cli.json`, `CreateRiskDto`, `status-reports.repository.ts`, `Community 7`, `.add`, `CreateProjectDto`, `Community 10`, `WorkflowPanel.tsx`, `RecordHistoryService`, `ProjectsController`, `action-items.repository.ts`, `.update`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `@types/node`, `Community 1`, `Community 34`, `nest-cli.json`, `CreateRiskDto`, `status-reports.repository.ts`, `Community 7`, `.add`, `CreateProjectDto`, `Community 10`, `WorkflowPanel.tsx`, `RecordHistoryService`, `ProjectsController`, `action-items.repository.ts`, `.update`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
