...
## Corpus Check
- 300 files · ~142,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2341 nodes · 5333 edges · 119 communities (100 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e418ea7d`
...
1. `toHttpException()` - 131 edges
2. `AuthUser` - 78 edges
3. `CurrentUser` - 76 edges
4. `@nestjs/swagger` - 56 edges
...
Cohesion: 0.09
Nodes (11): HistoryEntry, HistoryInsert, RecordHistoryService, Injectable, ActionItem, ActionItemComment, ActionItemListItem, Milestone (+3 more)
...
Cohesion: 0.19
Nodes (10): UpdateIssueDto, IssuesController, ApiBody, Body, Controller, Delete, Get, Param (+2 more)

### Community 17 - "CreateProjectDto"
Cohesion: 0.09
Nodes (16): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString, IsIn, IsOptional, IsString (+8 more)
...
Cohesion: 0.05
Nodes (55): AddStatusReportDialog(), Props, today(), ProtectedRoute(), Props, SectionCard(), Skeleton(), Chip() (+47 more)
...
Cohesion: 0.08
Nodes (25): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), DashboardController, Controller, Get, DashboardModule (+17 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (20): ArrayMinSize, AuthUser, CurrentUser, Delete, ImportRowsDto, ApiProperty, ArrayMaxSize, IsArray (+12 more)
...
Cohesion: 0.09
Nodes (24): App(), AppLayout(), NAV_ITEMS, sectorsApi, AuthContext, AuthContextValue, AuthProvider(), useAuth() (+16 more)
...
Cohesion: 0.10
Nodes (17): CreateUpdateDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsOptional, IsString, IsUUID (+9 more)
...
Cohesion: 0.15
Nodes (13): CommandPalette(), Entry, hitPath(), KIND_META, Props, SavedSearch, searchApi, SearchHit (+5 more)

### Community 47 - "Community 47"
Cohesion: 0.10
Nodes (22): AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts(), MiniCalendar(), MONTHS (+14 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.06
Nodes (44): Props, Props, Props, Props, Props, NotificationBell(), timeAgo(), ActionItemOwner (+36 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.11
Nodes (8): StatusReport, StatusReportDetail, StatusReportListItem, StatusReportsRepository, Injectable, COLUMN_SPEC, StatusReportsService, Injectable

### Community 50 - "Community 50"
Cohesion: 0.10
Nodes (15): AuthedRequest, logger, DatabaseService, Injectable, Kpi, KpiActionPlan, KpiListItem, KpiReading (+7 more)

### Community 54 - "ProjectsController"
Cohesion: 0.07
Nodes (27): 1. Ground rules (every session obeys these), 2026-08-13 — Phase 0a, frontend test runner (no skill; a port, not a design pass), 2026-08-13 — Phase 0b, characterization tests for the three pilot modules, 2026-08-13 — Phase 1a, `modules/links/` (the control case), 2026-08-13 — Phase 1b, `modules/projects/` (the complex case), 2026-08-17 — Phase 1c, `modules/action-items/` + the shared-helper promotion, 2026-08-17 — Phase 2a, `modules/program-outcomes/` (+ a bug fix), 2026-08-17 — Phase 2b, `modules/milestones/` (+19 more)
...
### Community 65 - ".add"
Cohesion: 0.10
Nodes (22): riskScore(), CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString (+14 more)
...
Cohesion: 0.20
Nodes (10): columnsFrom(), ColumnSpec, MilestoneProgressRow, Project, ProjectDetail, ProjectListRow, ProjectListStats, COLUMN_SPEC (+2 more)
...
## Knowledge Gaps
- **498 isolated node(s):** `COLUMN_SPEC`, `CREATE_DEFAULTS`, `1. The headline finding: 9 modules return 500 where they should return 404`, `2. Other bugs found, all still present on `main``, `3. Two things that look like bugs and are not` (+493 more)
...
- **Why does `toHttpException()` connect `Community 20` to `Community 1`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `status-reports.repository.ts`, `Community 44`, `Community 50`, `action-items.repository.ts`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `2. Core functional modules`, `.add`, `lookups.service.ts`, `@nestjs/swagger`, `Get`, `ts-loader`, `@types/supertest`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 34` to `Community 1`, `Community 5`, `Community 6`, `Community 10`, `Community 16`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `.add`, `2. Core functional modules`, `@nestjs/config`, `.add`, `DatabaseService`, `AddMilestoneDialog.tsx`, `ts-loader`, `@types/supertest`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 34` to `Community 1`, `Community 5`, `Community 6`, `Community 10`, `Community 16`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `.add`, `2. Core functional modules`, `@nestjs/config`, `.add`, `DatabaseService`, `AddMilestoneDialog.tsx`, `ts-loader`, `@types/supertest`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **What connects `COLUMN_SPEC`, `CREATE_DEFAULTS`, `1. The headline finding: 9 modules return 500 where they should return 404` to the rest of the system?**
