...
## Summary
- 1233 nodes · 2463 edges · 61 communities (52 shown, 9 thin omitted)
...
Cohesion: 0.08
Nodes (23): CreateLinkDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsOptional, IsString, MaxLength (+15 more)
...
Cohesion: 0.11
Nodes (26): AddAttachmentDialog(), Props, AddLinkDialog(), Props, Card(), CardAction(), CardContent(), CardDescription() (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.10
Nodes (27): Props, AddResourceDialog(), Props, AddUpdateDialog(), Props, EditProjectDialog(), ProjectMemberDetail, Resource (+19 more)
...
Cohesion: 0.14
Nodes (22): Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost(), apiUpload(), AttachmentDetail (+14 more)
...
Cohesion: 0.23
Nodes (21): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), CategorySelect(), Props, Dialog(), Input() (+13 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (17): logger, toHttpException(), DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue (+9 more)
...
Cohesion: 0.06
Nodes (32): ArrayMaxSize, AuthUser, CurrentUser, ActionItemsController, ApiBody, Body, Controller, Delete (+24 more)
...
Cohesion: 0.17
Nodes (16): AddStatusReportDialog(), EDITABLE_OPTIONS, Props, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Button() (+8 more)
...
Cohesion: 0.12
Nodes (21): App(), ProtectedRoute(), projectsApi, AuthContext, AuthContextValue, AuthProvider(), useAuth(), supabase (+13 more)
...
## Knowledge Gaps
- **272 isolated node(s):** `$schema`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)`, `Bash(npm run build:*)` (+267 more)
...
- **Why does `toHttpException()` connect `Community 27` to `CreateActionItemDto`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `status-reports.repository.ts`, `Community 10`, `Community 9`, `Community 16`, `Community 28`, `StatusReportDetailPage.tsx`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `CreateActionItemDto` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `ProjectsRepository`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `CreateActionItemDto` to `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `ProjectsRepository`?**
