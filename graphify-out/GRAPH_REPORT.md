...
## Corpus Check
- 337 files · ~153,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2528 nodes · 6095 edges · 127 communities (109 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a728c518`
...
Cohesion: 0.13
Nodes (27): AddPersonDialog(), emptyPerson(), memberName(), CreateAccountDialog(), Props, ExportCsvDialog(), Props, Button() (+19 more)
...
Cohesion: 0.14
Nodes (16): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), logger, ChartPoint, CLOSED_PROJECT, DashboardData (+8 more)
...
Cohesion: 0.12
Nodes (6): toHttpException(), SubmissionsRepository, Injectable, Query, Injectable, UsersService
...
Cohesion: 0.06
Nodes (51): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog() (+43 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.10
Nodes (18): AccessModule, Global, Module, DatabaseModule, Global, Module, AccessAdminModule, Module (+10 more)
...
Cohesion: 0.09
Nodes (14): AuthedRequest, DatabaseService, Injectable, Issue, IssueListItem, Milestone, MilestoneListItem, ChildRow (+6 more)
...
Cohesion: 0.07
Nodes (28): AuthUser, CurrentUser, Delete, DashboardController, Controller, Get, NotificationsController, Controller (+20 more)
...
Cohesion: 0.09
Nodes (29): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, defaultLevelFor() (+21 more)
...
Cohesion: 0.12
Nodes (14): AccessLevel, AccessLevelValue, MEMBERSHIP_LEVEL, projectAccessLevel(), AppRole, lookupCache, Me, MyMembership (+6 more)
...
Cohesion: 0.12
Nodes (19): AdjustWeightsDto, IsArray, Type, ValidateNested, CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray (+11 more)

### Community 111 - "ts-jest"
Cohesion: 0.40
Nodes (5): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), today()
...
Cohesion: 0.10
Nodes (17): TemplatesController, ApiBody, Body, Controller, Delete, Get, Param, Post (+9 more)
...
## Knowledge Gaps
- **512 isolated node(s):** `PALETTE`, `ROLE_META`, `CAPABILITY_LABEL`, `ACCESS_META`, `WORK_ICON` (+507 more)
...
- **Why does `toHttpException()` connect `Community 20` to `Community 1`, `Injectable`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `Community 26`, `Community 27`, `ProjectsRepository`, `CreateProjectDto`, `Community 44`, `Community 45`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `CreateLinkDto`, `WorkflowPanel.tsx`, `users.service.ts`, `@nestjs/swagger`, `AuthUser`, `CreateRiskDto`, `project-sections.service.ts`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 50`, `@types/node`, `PeopleRepository`, `.add`, `DatabaseService`, `README.md`, `users.service.ts`, `@nestjs/swagger`, `ActionItemsController`, `CreateRiskDto`, `ProjectsController`, `app.module.ts`, `project-sections.service.ts`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **What connects `PALETTE`, `ROLE_META`, `CAPABILITY_LABEL` to the rest of the system?**
