...
## Corpus Check
- 310 files · ~138,967 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2340 nodes · 5245 edges · 138 communities (117 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bf92e653`
...
Cohesion: 0.18
Nodes (10): 2. Functionality inventory (FDD FR-01…15 → status), 3. Use cases UC-01…18 — acceptance checklist, 4. Key validations / business rules (FDD 3.3.2), 5. Reports & notifications (defer until math lands), 6. Open questions for the supervisor (blockers marked ⛔), 7. Execution roadmap, 8. Security phase — access model (stage 1, ASSUMED 2026-08-17, awaiting Fares sign-off), 9. Conventions carried forward (+2 more)
...
Cohesion: 0.16
Nodes (7): ActionItemsService, COLUMN_SPEC, CREATE_DEFAULTS, normalizeOwnerIds(), Owners, ownersLabel(), Injectable
...
Cohesion: 0.07
Nodes (40): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), NavSection (+32 more)
...
Cohesion: 0.08
Nodes (26): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), DashboardController, Controller, Get, DashboardModule (+18 more)
...
Cohesion: 0.12
Nodes (36): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), AddRiskDialog(), emptyPerson(), CategorySelect(), Props (+28 more)
...
Cohesion: 0.07
Nodes (13): SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, CyclesController, ReportsController, Controller (+5 more)
...
Cohesion: 0.11
Nodes (24): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddMilestoneDialog() (+16 more)
...
Cohesion: 0.19
Nodes (5): CurrentUser, UpdateLinkDto, UpdateMilestoneDto, ACTION_BODY, @nestjs/swagger
...
Cohesion: 0.14
Nodes (19): App(), InitiativeProgressRow, MonthlyPerformanceMonth, reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor() (+11 more)
...
Cohesion: 0.13
Nodes (9): ProjectsController, Controller, Delete, Get, Param, Query, ProjectsService, Injectable (+1 more)
...
Cohesion: 0.11
Nodes (15): AuthUser, Delete, Delete, NotificationsController, Controller, Get, Param, Post (+7 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.19
Nodes (20): Props, Props, Props, apiUpload(), Attachment, AttachmentDetail, apiDelete(), apiGet() (+12 more)

### Community 49 - "RecordHistoryService"
Cohesion: 0.19
Nodes (11): columnsFrom(), ColumnSpec, COLUMN_SPEC, CREATE_DEFAULTS, COLUMN_SPEC, CREATE_DEFAULTS, COLUMN_SPEC, CREATE_DEFAULTS (+3 more)
...
Cohesion: 0.06
Nodes (31): MilestoneProgressRow, DatabaseService, Injectable, RecordHistoryService, Injectable, Attachment, AttachmentDetail, AttachmentListItem (+23 more)
...
Cohesion: 0.09
Nodes (8): logger, toHttpException(), ActionItemsRepository, Injectable, MilestonesRepository, Injectable, ProgramOutcomesRepository, Injectable
...
Cohesion: 0.12
Nodes (9): ApiTags, ProjectSectionsController, Controller, Get, Param, ProjectSectionsService, Injectable, StatusReportsService (+1 more)
...
Cohesion: 0.38
Nodes (7): CreateAccountDialog(), Props, usersApi, inviteDraft(), isPocEmail(), pocEmail(), tempPassword()
...
Cohesion: 0.16
Nodes (15): NotificationBell(), timeAgo(), formatSize(), Props, TaskAttachments(), Chip(), personName(), STATUS_CHIP (+7 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.20
Nodes (20): AddIssueDialog(), emptyPerson(), AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props (+12 more)
...
Cohesion: 0.15
Nodes (15): initials(), Props, RecordHistory(), relativeTime(), TABLE_NOUNS, username(), Props, SectionCard() (+7 more)
...
Cohesion: 0.11
Nodes (16): CreateStatusReportDto, ApiProperty, IsDateString, IsIn, IsString, MaxLength, UpdateStatusReportDto, StatusReportsController (+8 more)
...
Cohesion: 0.15
Nodes (12): ActionItemsModule, Module, AttachmentsModule, Module, IssuesModule, Module, ProgramOutcomesModule, Module (+4 more)
...
Cohesion: 0.17
Nodes (11): AppModule, Module, bootstrap(), LinksModule, Module, ProjectSectionsModule, Module, ResourcesModule (+3 more)
...
### Community 115 - "StatusReportsRepository"
Cohesion: 0.16
...
Cohesion: 0.19
Nodes (12): Props, TagChips(), GlobalActionItem, GlobalMilestone, registryApi, ActionItemsPage(), isOverdue(), ownerNames() (+4 more)

### Community 119 - "app.controller.ts"
Cohesion: 0.23
Nodes (7): ApiSecurity, AppController, Controller, Get, AppService, Injectable, Public()

### Community 120 - "AddKpiDialog.tsx"
Cohesion: 0.24
Nodes (10): AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, Kpi, formatValue(), KpiDetail(), KpisPage() (+2 more)

### Community 121 - "records.ts"
Cohesion: 0.15
Nodes (13): Props, Props, Props, Props, ProjectSections, issuesApi, Link, linksApi (+5 more)

### Community 122 - "CreateKpiDto"
Cohesion: 0.15
...
### Community 125 - "ProjectOverviewCards.tsx"
Cohesion: 0.22
...
### Community 127 - "StatusReportDetailPage.tsx"
Cohesion: 0.23
...
### Community 129 - "CreateKpiActionPlanDto"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (7): Cycle, CycleStatusReport, CycleStatusRow, dashboardApi, DashboardChartPoint, DashboardData, submissionsApi
...
### Community 135 - "DatabaseModule"
Cohesion: 0.67
Nodes (3): DatabaseModule, Module, Global

## Knowledge Gaps
- **478 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+473 more)
...
- **Why does `toHttpException()` connect `PaginationQueryDto` to `Community 1`, `ProjectsRepository`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 47`, `ProjectsController`, `PeopleRepository`, `.add`, `transform`, `@nestjs/swagger`, `eslint-plugin-react-hooks`, `RisksService`, `ApiProperty`, `StatusReportsRepository`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `RecordHistoryService`?**
  _High betweenness centrality (0.242) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `.update`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 44`, `action-items.repository.ts`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `.add`, `README.md`, `AddMilestoneDialog.tsx`, `@nestjs/swagger`, `eslint-plugin-react-hooks`, `ApiProperty`, `ProgramOutcomesService`?**
