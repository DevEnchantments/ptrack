...
## Summary
- 2283 nodes · 4911 edges · 134 communities (113 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f75d20e`
...
Cohesion: 0.08
Nodes (25): DatabaseModule, Module, RecordHistoryService, Injectable, ActionItemsService, Owners, ownersLabel(), Injectable (+17 more)
...
Cohesion: 0.09
Nodes (23): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), DashboardController, Controller, Get (+15 more)
...
Cohesion: 0.11
Nodes (35): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CategorySelect(), Props, EditProjectDialog() (+27 more)
...
Cohesion: 0.13
Nodes (21): App(), Skeleton(), registryApi, reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor() (+13 more)
...
Cohesion: 0.16
Nodes (17): AuthUser, CurrentUser, Delete, Get, Param, Post, SubmissionActionDto, ApiPropertyOptional (+9 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.04
Nodes (70): Props, Props, Props, Props, AppLayout(), NAV_ITEMS, CommandPalette(), Entry (+62 more)
...
### Community 65 - ".add"
Cohesion: 0.13
Nodes (7): logger, toHttpException(), ProgramOutcome, ProgramOutcomesRepository, Injectable, ProjectsRepository, Injectable

### Community 66 - "react-dom"
Cohesion: 0.11
Nodes (7): StatusReport, StatusReportDetail, StatusReportListItem, StatusReportsRepository, Injectable, StatusReportsService, Injectable
...
Cohesion: 0.22
Nodes (23): FREQUENCIES, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FieldError() (+15 more)
...
Cohesion: 0.14
Nodes (6): Resource, ResourceListItem, ResourcesRepository, Injectable, ResourcesService, Injectable
...
### Community 90 - "Get"
Cohesion: 0.15
Nodes (7): HistoryEntry, HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository, Injectable
...
Cohesion: 0.14
Nodes (6): Injectable, Update, UpdateListItem, UpdatesRepository, Injectable, UpdatesService

### Community 113 - "KpisController"
Cohesion: 0.21
...
### Community 125 - "toast.ts"
Cohesion: 0.33
Nodes (5): formatSize(), Props, TaskAttachments(), attachmentsApi, Listener

### Community 126 - "InitialsAvatar.tsx"
Cohesion: 0.47
...
### Community 128 - "AppModule"
Cohesion: 0.50
Nodes (3): AppModule, Module, bootstrap()

### Community 129 - "submissions.service.ts"
Cohesion: 0.50
Nodes (3): Cycle, Submission, SubmissionListItem

### Community 130 - "SectionNav.tsx"
Cohesion: 0.50
Nodes (3): NavSection, Props, SectionNav()

## Knowledge Gaps
- **467 isolated node(s):** `PARENT_TABLES`, `Cycle`, `1. The headline finding: 9 modules return 500 where they should return 404`, `2. Other bugs found, all still present on `main``, `3. Two things that look like bugs and are not` (+462 more)
...
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `README.md`, `@nestjs/swagger`, `status-reports.repository.ts`, `tailwind-merge`, `KpisController`, `ApiProperty`, `templates.controller.ts`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 47` to `Community 1`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `README.md`, `@nestjs/swagger`, `status-reports.repository.ts`, `tailwind-merge`, `KpisController`, `ApiProperty`, `templates.controller.ts`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `Community 8` to `AppModule`, `templates.controller.ts`, `Community 34`, `Community 1`, `Community 5`, `nest-cli.json`, `status-reports.repository.ts`, `Community 10`, `Community 47`, `CreateProjectDto`, `Community 50`, `RecordHistoryService`, `@nestjs/swagger`, `app.controller.ts`, `status-reports.repository.ts`, `@nestjs/swagger`, `auth-context.tsx`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **What connects `PARENT_TABLES`, `Cycle`, `1. The headline finding: 9 modules return 500 where they should return 404` to the rest of the system?**
