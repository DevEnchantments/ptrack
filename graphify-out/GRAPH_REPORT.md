...
## Corpus Check
- 249 files · ~109,276 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2026 nodes · 4491 edges · 103 communities (91 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3bbb083b`
...
Cohesion: 0.13
Nodes (21): EditProjectDialog(), FY_YEARS, personFromProfile(), PersonAutocomplete(), Props, categoriesApi, Project, sectorsApi (+13 more)
...
Cohesion: 0.11
Nodes (15): AuthUser, CurrentUser, Delete, ApiBody, Body, Post, Delete, Get (+7 more)
...
Cohesion: 0.14
Nodes (27): STATUSES, Props, CategorySelect(), Props, Input(), SelectContent(), SelectItem(), SelectTrigger() (+19 more)
...
Cohesion: 0.15
Nodes (14): AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ProtectedRoute(), risksApi (+6 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.08
Nodes (35): AddStatusReportDialog(), Props, today(), CommandPalette(), Entry, hitPath(), KIND_META, Props (+27 more)
...
Cohesion: 0.19
Nodes (13): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), Textarea(), personName() (+5 more)
...
Cohesion: 0.11
Nodes (28): App(), Props, TagChips(), GlobalActionItem, registryApi, AuthProvider(), usePageTitle(), ActionItemsPage() (+20 more)
...
Cohesion: 0.08
Nodes (20): AuthedRequest, logger, DatabaseModule, Module, DatabaseService, Injectable, Issue, IssueListItem (+12 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.13
Nodes (29): Props, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, ConfirmDeleteButton(), Props, Props (+21 more)
...
Cohesion: 0.16
Nodes (16): COLUMNS, ProjectsGrid(), StatusPill(), TONE_CLASSES, toneFor(), GlobalMilestone, ProjectListItem, GridSort (+8 more)
...
## Knowledge Gaps
- **426 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+421 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `.add`, `.add`, `DatabaseService`, `.add`, `AddActionItemDialog.tsx`, `undici`, `@supabase/supabase-js`, `lookups.service.ts`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 10`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `.add`, `CreateRiskDto`, `.add`, `RecordHistory.tsx`, `@types/node`, `PeoplePage.tsx`?**
