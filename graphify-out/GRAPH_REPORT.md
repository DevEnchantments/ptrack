...
## Corpus Check
- 273 files · ~118,348 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2180 nodes · 4730 edges · 113 communities (95 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `567b7dc8`
...
Cohesion: 0.18
Nodes (15): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+7 more)
...
Cohesion: 0.06
Nodes (48): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CreateAccountDialog(), Props, issuesApi (+40 more)
...
Cohesion: 0.12
Nodes (11): KpisController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+3 more)
...
Cohesion: 0.11
Nodes (5): toHttpException(), KpisRepository, Injectable, SubmissionsRepository, Injectable
...
Cohesion: 0.14
Nodes (31): Props, Props, AddRiskDialog(), emptyPerson(), Props, Props, CategorySelect(), Props (+23 more)
...
Cohesion: 0.09
Nodes (20): ApiBody, ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, UsersController, PendingMembershipRow (+12 more)
...
Cohesion: 0.07
Nodes (40): CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell(), timeAgo(), ActionItemOwner (+32 more)
...
Cohesion: 0.13
Nodes (24): EditProjectDialog(), FY_YEARS, personFromProfile(), Props, PersonAutocomplete(), Props, categoriesApi, Project (+16 more)

### Community 56 - "@types/node"
Cohesion: 0.06
Nodes (42): ApiSecurity, AppController, Controller, Get, AppModule, Module, AppService, Injectable (+34 more)
...
Cohesion: 0.21
Nodes (8): UploadedFileLike, ApiPropertyOptional, IsArray, IsBoolean, IsOptional, IsString, UpdateAttachmentDto, @nestjs/swagger

### Community 70 - "SectionNav.tsx"
Cohesion: 0.23
Nodes (7): Props, Props, FieldError(), HelpDot(), Attachment, AttachmentDetail, Link
...
Cohesion: 0.12
Nodes (23): App(), CycleStatusReport, GlobalMilestone, registryApi, AuthProvider(), usePageTitle(), CategoriesPage(), DashboardPage() (+15 more)

### Community 73 - ".add"
Cohesion: 0.08
Nodes (24): DatabaseModule, Module, RecordHistoryService, Injectable, ActionItemsService, Owners, Injectable, CreateActionItemDto (+16 more)

### Community 74 - "DatabaseService"
Cohesion: 0.07
Nodes (29): AuthedRequest, logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Kpi (+21 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.08
Nodes (26): AddStatusReportDialog(), EDITABLE_OPTIONS, Props, today(), VIEWABLE_OPTIONS, Props, Props, Props (+18 more)
...
Cohesion: 0.13
Nodes (19): AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, Textarea(), Chip(), personName(), Props (+11 more)
...
### Community 112 - "RecordHistory.tsx"
Cohesion: 0.33
...
## Knowledge Gaps
- **449 isolated node(s):** `Props`, `GlobalMilestone`, `GlobalActionItem`, `DirectoryMembership`, `DirectoryPerson` (+444 more)
...
- **Why does `toHttpException()` connect `Community 28` to `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `CreateProjectDto`, `Community 26`, `Community 27`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `react-dom`, `DatabaseService`, `AddActionItemDialog.tsx`, `undici`, `PeoplePage.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `WorkflowPanel.tsx` to `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 26`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `RecordHistoryService`, `.add`, `WorkflowPanel.tsx`, `nest-cli.json`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 16`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `react-dom`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **What connects `Props`, `GlobalMilestone`, `GlobalActionItem` to the rest of the system?**
