...
## Summary
- 2309 nodes · 5254 edges · 128 communities (115 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f97b06db`
...
Cohesion: 0.13
Nodes (12): ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, Get, Query (+4 more)
...
Cohesion: 0.09
Nodes (36): App(), Props, TagChips(), GlobalActionItem, GlobalMilestone, registryApi, reportsApi, AuthProvider() (+28 more)
...
Cohesion: 0.15
Nodes (16): DashboardModule, Module, ImportModule, Module, MilestonesModule, Module, ProgramOutcomesModule, Module (+8 more)
...
Cohesion: 0.10
Nodes (9): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, RecordHistoryService, Injectable, Milestone (+1 more)
...
Cohesion: 0.30
Nodes (7): Owners, CreateCommentDto, ApiProperty, IsString, MinLength, UpdateActionItemDto, @nestjs/swagger
...
### Community 123 - "@nestjs/platform-express"
Cohesion: 0.62
...
- **Why does `toHttpException()` connect `Community 26` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 34`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `.add`, `transform`, `Get`, `eslint-plugin-react-hooks`, `ApiProperty`, `@nestjs/platform-express`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.280) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `RecordHistoryService`?**
  _High betweenness centrality (0.232) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `action-items.repository.ts`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `.add`, `README.md`, `status-reports.repository.ts`, `jose`, `eslint-plugin-react-hooks`, `eslint-plugin-prettier`, `ProjectsController`, `ApiProperty`, `.add`, `ProgramOutcomesService`?**
