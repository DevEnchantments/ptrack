...
## Summary
- 1406 nodes · 2902 edges · 78 communities (67 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9886991c`
...
Cohesion: 0.06
Nodes (44): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddLinkDialog(), AddResourceDialog(), AddStatusReportDialog(), today(), AddUpdateDialog() (+36 more)
...
Cohesion: 0.22
Nodes (10): AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, ProtectedRoute(), useAuth() (+2 more)
...
### Community 57 - ".update"
Cohesion: 0.09
Nodes (29): Props, Props, Props, Props, Props, Props, ActionItemOwner, apiDelete() (+21 more)
...
Cohesion: 0.19
Nodes (22): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props (+14 more)
...
- **Why does `toHttpException()` connect `Community 27` to `nest-cli.json`, `Community 2`, `Community 1`, `CreateProjectDto`, `Community 5`, `Community 6`, `Community 8`, `DatabaseModule`, `CreateProjectDto`, `Community 10`, `Community 12`, `Community 9`, `nest-cli.json`, `status-reports.repository.ts`, `@types/node`, `PeopleRepository`?**
