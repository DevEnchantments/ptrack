...
## Summary
- 2324 nodes · 5320 edges · 123 communities (105 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f04ec5f`
...
Cohesion: 0.11
Nodes (15): ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, ApiBody, Body (+7 more)
...
Cohesion: 0.08
Nodes (22): AuthedRequest, logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+14 more)

### Community 8 - "Community 8"
Cohesion: 0.19
Nodes (9): UpdateRiskDto, RisksController, ApiBody, Body, Controller, Get, Param, Patch (+1 more)
...
Cohesion: 0.06
Nodes (46): AddAttachmentDialog(), AddLinkDialog(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), today(), AddResourceDialog(), AddUpdateDialog() (+38 more)
...
Cohesion: 0.10
Nodes (29): Props, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, FromTemplateDialog(), Props, HelpDot(), Props (+21 more)

### Community 17 - "CreateProjectDto"
Cohesion: 0.11
Nodes (19): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString, IsIn, IsOptional, IsString (+11 more)
...
Cohesion: 0.11
Nodes (12): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, ActionItemsService, COLUMN_SPEC, CREATE_DEFAULTS, Owners (+4 more)
...
Cohesion: 0.14
Nodes (20): App(), reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage(), DashboardPage() (+12 more)
...
Cohesion: 0.07
Nodes (36): ArrayMinSize, ImportRowsDto, ApiProperty, ArrayMaxSize, IsArray, ImportController, ApiBody, Body (+28 more)
...
Cohesion: 0.15
Nodes (15): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), today(), actionItemsApi, auditLine(), formatLongDate() (+7 more)
...
Cohesion: 0.08
Nodes (27): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max, Min, Type, CreateUpdateDto (+19 more)
...
Cohesion: 0.13
Nodes (10): SearchController, Controller, Delete, Get, Param, Query, SearchModule, Module (+2 more)
...
Cohesion: 0.14
Nodes (15): initials(), Props, RecordHistory(), TABLE_NOUNS, username(), Props, SectionCard(), Skeleton() (+7 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.06
Nodes (41): Props, Props, Props, CommandPalette(), Entry, hitPath(), KIND_META, Props (+33 more)
...
Cohesion: 0.14
Nodes (16): Chip(), Props, STATUS_CHIP, WorkflowPanel(), Cycle, cyclesApi, ProjectSections, Submission (+8 more)
...
Cohesion: 0.24
Nodes (9): formatDate(), initials(), PersonLike, relativeTime(), atOffset(), AttachmentDetailPage(), formatSize(), longDate() (+1 more)
...
Cohesion: 0.08
Nodes (28): AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog(), personFromProfile() (+20 more)
...
Cohesion: 0.22
Nodes (27): STATUSES, FREQUENCIES, STATUSES, CategorySelect(), Props, ConfirmDeleteButton(), Props, FY_YEARS (+19 more)

### Community 76 - ".add"
Cohesion: 0.13
Nodes (8): ProgramOutcomesModule, Module, COLUMN_SPEC, CREATE_DEFAULTS, ProgramOutcomesService, TemplatesModule, Module, Injectable
...
Cohesion: 0.11
Nodes (27): Props, Props, Props, Props, Props, Props, formatAed(), milestoneShares() (+19 more)
...
Cohesion: 0.15
Nodes (16): ImportModule, Module, MilestonesModule, Module, NotificationsModule, Module, PeopleModule, Module (+8 more)
...
### Community 90 - "Get"
Cohesion: 0.11
Nodes (7): toHttpException(), ActionItemsRepository, Injectable, normalizeOwnerIds(), ProgramOutcome, ProgramOutcomesRepository, Injectable
...
Cohesion: 0.09
Nodes (28): COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow, importApi, ImportSummary, Project (+20 more)
...
Cohesion: 0.18
Nodes (14): StatusPill(), TONE_CLASSES, toneFor(), Props, TagChips(), GlobalMilestone, registryApi, ActionItemsPage() (+6 more)
...
## Knowledge Gaps
- **487 isolated node(s):** `COLUMN_SPEC`, `CREATE_DEFAULTS`, `$schema`, `includeCoAuthoredBy`, `defaultMode` (+482 more)
...
- **Why does `toHttpException()` connect `Get` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `2. Core functional modules`, `lookups.service.ts`, `AddMilestoneDialog.tsx`, `transform`, `@nestjs/swagger`, `projects.module.ts`, `PeoplePage.tsx`, `.add`, `ProjectsGrid.tsx`, `ProjectProgressReportPage.tsx`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `@nestjs/config` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `.add`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `ProjectProgressReportPage.tsx`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `@nestjs/config` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `.add`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **What connects `COLUMN_SPEC`, `CREATE_DEFAULTS`, `$schema` to the rest of the system?**
