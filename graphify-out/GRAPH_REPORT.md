...
## Summary
- 2195 nodes · 4970 edges · 117 communities (105 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c20c920e`
...
Cohesion: 0.12
Nodes (25): dashboardApi, DashboardData, ActionItemsBreakdown(), ActivityHeatmap(), ActivityLineChart(), BudgetBar(), CategoryDonut(), ChartPoint (+17 more)
...
Cohesion: 0.12
Nodes (25): Props, Props, Props, Props, Props, Props, formatAed(), milestoneShares() (+17 more)
...
Cohesion: 0.04
Nodes (60): Props, Props, Props, Props, NAV_ITEMS, CommandPalette(), Entry, hitPath() (+52 more)
...
Cohesion: 0.15
Nodes (19): App(), AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage(), DashboardPage(), ImportPage() (+11 more)
...
Cohesion: 0.08
Nodes (25): logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue, IssueListItem (+17 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.23
Nodes (23): STATUSES, FREQUENCIES, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FieldError(), Props (+15 more)
...
Cohesion: 0.29
Nodes (8): Chip(), calculatedProgress(), MilestoneProgressRow, plannedProgress(), riskScore(), riskSeverityTone(), MILESTONE_LABELS, ProjectProgressReportPage()
...
## Knowledge Gaps
- **451 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+446 more)
...
- **Why does `toHttpException()` connect `Community 28` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `.add`, `CreateLinkDto`, `.add`, `DatabaseService`, `milestones.repository.ts`, `Get`, `PeoplePage.tsx`, `IsArray`, `ApiProperty`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 9`, `Community 10`, `Community 16`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `RecordHistoryService`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `undici`, `AppModule`, `ApiProperty`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 6`, `Community 9`, `Community 10`, `Community 16`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `RecordHistoryService`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `undici`, `AppModule`, `ApiProperty`?**
