...
## Corpus Check
- 379 files · ~182,126 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2745 nodes · 6604 edges · 149 communities (130 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ea7ce17`
...
Cohesion: 0.25
Nodes (7): columnsFrom(), ColumnSpec, UpdateRiskDto, Risk, RiskListItem, COLUMN_SPEC, CREATE_DEFAULTS
...
Cohesion: 0.07
Nodes (33): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog() (+25 more)
...
Cohesion: 0.10
Nodes (15): ResourcesController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+7 more)
...
Cohesion: 0.04
Nodes (71): AddAttachmentDialog(), AddKpiDialog(), emptyPerson(), Props, AddLinkDialog(), Props, AddResourceDialog(), AddStatusReportDialog() (+63 more)
...
Cohesion: 0.37
Nodes (11): apiUpload(), apiDelete(), apiGet(), apiPatch(), apiPost(), apiPut(), authHeader(), handle() (+3 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (46): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+38 more)
...
Cohesion: 0.11
Nodes (8): ApiBody, Body, Get, Patch, Post, Query, Injectable, UsersService
...
Cohesion: 0.15
Nodes (12): AccessLevel, atLeastRole(), defaultLevelFor(), ProjectAccessInput, resolveProjectLevel(), base, LEVEL_LABEL, ProjectAccessGuard (+4 more)
...
Cohesion: 0.06
Nodes (29): AppNotification, NotificationsRepository, Injectable, NotificationsService, Injectable, classifyDue(), inSubmissionWindow(), ReminderKind (+21 more)
...
Cohesion: 0.11
Nodes (27): AddPersonDialog(), emptyPerson(), memberName(), CreateAccountDialog(), Props, ExportCsvDialog(), Props, Props (+19 more)

### Community 55 - "action-items.repository.ts"
Cohesion: 0.07
Nodes (27): 1. Baseline, measured 2026-08-18 on this branch, 2026-08-19 — B1, public surface per module, 2026-08-19 — B2 + B3, the rule and the last reach-in, 2026-08-19 — B4, contract conformance. **Phase B complete.**, 2026-08-19 — Clearing the register before Phase 1 (APPROVED BEHAVIOUR CHANGES), 2026-08-19 — Gate review, then one APPROVED BEHAVIOUR CHANGE, 2026-08-19 — Phase 0, `access-admin` (seam first, then net), 2026-08-19 — Phase 0, `kpis`. **The three high-value modules are done.** (+19 more)
...
Cohesion: 0.10
Nodes (11): HistoryEntry, HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository, Injectable, ActionItemsService (+3 more)
...
Cohesion: 0.09
Nodes (20): AuthUser, CurrentUser, Delete, Get, Delete, Delete, NotificationsController, Controller (+12 more)
...
Cohesion: 0.14
Nodes (13): NotificationBell(), timeAgo(), AppNotification, Cycle, cyclesApi, CycleStatusReport, CycleStatusRow, dashboardApi (+5 more)

### Community 73 - ".add"
Cohesion: 0.19
Nodes (6): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), ACTION_BODY, @nestjs/swagger
...
Cohesion: 0.15
Nodes (17): APP_ROLES, AppRole, CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES, GrantableRole (+9 more)
...
Cohesion: 0.23
Nodes (6): ChildRow, NamedRow, SavedSearch, CHILD_KINDS, SearchHit, SearchKind
...
Cohesion: 0.10
Nodes (16): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, AttachmentsRepository, PARENT_TABLES, Injectable (+8 more)
...
Cohesion: 0.07
Nodes (19): logger, toHttpException(), DatabaseService, Injectable, LookupsRepository, Injectable, ACCESS_LEVELS, AdminLookupRow (+11 more)

### Community 105 - "CreateRiskDto"
Cohesion: 0.06
Nodes (56): Props, SectionCard(), NavSection, Props, SectionNav(), formatSize(), Props, TaskAttachments() (+48 more)

### Community 107 - "eslint-plugin-react-hooks"
Cohesion: 0.24
Nodes (5): SearchRepository, Injectable, childHits(), toPattern(), topLevelHits()
...
Cohesion: 0.20
Nodes (16): Props, Props, Props, formatAed(), milestoneShares(), MONTHS, ProjectDashboardTab(), Props (+8 more)

### Community 113 - "ts-loader"
Cohesion: 0.08
Nodes (21): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID (+13 more)

### Community 114 - "CreateLookupValueDto"
Cohesion: 0.10
Nodes (19): AppModule, Module, AccessModule, Global, Module, DatabaseModule, Global, Module (+11 more)
...
### Community 131 - "columnsFrom"
Cohesion: 0.15
Nodes (8): SearchController, Controller, Delete, Param, SearchModule, Module, SearchService, Injectable
...
### Community 147 - "AccessAdminModule"
Cohesion: 0.15
...
### Community 152 - "seed-generic-lookups.mjs"
Cohesion: 0.25
Nodes (7): db, ensure(), env, PROGRAMS, root, rows(), STANDARD

### Community 154 - "kpis.repository.ts"
Cohesion: 0.50
Nodes (4): Kpi, KpiActionPlan, KpiListItem, KpiReading

## Knowledge Gaps
- **574 isolated node(s):** `COLUMN_SPEC`, `CREATE_DEFAULTS`, `1. Baseline, measured 2026-08-18 on this branch`, `Verification gate (all must pass before an item is ticked)`, `3. Per-session protocol` (+569 more)
...
- **Why does `fetchMe()` connect `Community 8` to `WorkflowPanel.tsx`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `columnsFrom`, `.update`, `Community 6`, `Community 9`, `Community 10`, `ProjectSectionsController`, `ProjectsGrid.tsx`, `Community 16`, `CreateProjectDto`, `HomePage`, `Community 20`, `UsersModule`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `nest-cli.json`, `Community 50`, `@types/node`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `🚀 Quick start`, `users.service.ts`, `ActionItemsController`, `StatusReportsController`, `CreateMilestoneDto`, `project-sections.service.ts`, `.me`, `ProjectSectionsController`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `ProgramOutcomesController` to `Community 1`, `columnsFrom`, `.update`, `AdjustWeightsDto`, `WeightEntryDto`, `Community 5`, `Community 9`, `Community 6`, `Community 11`, `ProjectSectionsController`, `Community 16`, `CreateProjectDto`, `kpis.repository.ts`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@types/node`, `@nestjs/swagger`, `CreateMilestoneDto`, `PaginationQueryDto`, `RecordHistoryService`, `lookups.service.ts`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `eslint-plugin-react-hooks`, `action-items.repository.ts`, `ts-loader`, `CreateMilestoneDto`, `project-sections.service.ts`, `.me`, `ProjectSectionsController`, `UpdateMeDto`, `milestones.service.ts`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **What connects `COLUMN_SPEC`, `CREATE_DEFAULTS`, `1. Baseline, measured 2026-08-18 on this branch` to the rest of the system?**
