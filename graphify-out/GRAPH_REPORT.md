...
Cohesion: 0.05
Nodes (34): HistoryInsert, ActionItemsController, ApiBody, Body, Controller, Delete, Get, Param (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (68): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), Props, AddLinkDialog(), Props (+60 more)
...
Cohesion: 0.05
Nodes (56): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+48 more)
...
Cohesion: 0.06
Nodes (56): App(), ExportCsvDialog(), Props, ProtectedRoute(), Props, TagChips(), GlobalMilestone, registryApi (+48 more)
...
Cohesion: 0.31
Nodes (13): Props, apiUpload(), apiDelete(), apiGet(), apiPatch(), apiPost(), apiPut(), authHeader() (+5 more)
...
Cohesion: 0.07
Nodes (26): AuthUser, CurrentUser, Get, Delete, Delete, Delete, NotificationsController, Controller (+18 more)

### Community 64 - "PaginationQueryDto"
Cohesion: 0.11
Nodes (5): toHttpException(), SubmissionsRepository, Injectable, Injectable, UsersService
...
Cohesion: 0.11
Nodes (25): Props, Props, Props, Props, Props, Props, Props, fmtAed() (+17 more)
...
Cohesion: 0.10
Nodes (24): Props, SectionCard(), NavSection, Props, SectionNav(), Button(), buttonVariants, Skeleton() (+16 more)
...
Cohesion: 0.15
Nodes (12): NotificationBell(), timeAgo(), AppNotification, CycleStatusReport, CycleStatusRow, dashboardApi, DashboardChartPoint, DashboardData (+4 more)
...
Cohesion: 0.15
Nodes (11): atLeastRole(), defaultLevelFor(), ProjectAccessInput, resolveProjectLevel(), base, LEVEL_LABEL, ProjectAccessGuard, Injectable (+3 more)
...
Cohesion: 0.28
Nodes (12): APP_ROLES, AppRole, CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES, GrantableRole (+4 more)
...
Cohesion: 0.09
Nodes (20): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, CreateCommentDto, ApiProperty, IsString (+12 more)
...
Cohesion: 0.09
Nodes (34): AppLayout(), NAV_ITEMS, FromTemplateDialog(), COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow (+26 more)
...
Cohesion: 0.08
Nodes (17): AuthedRequest, logger, DatabaseService, Injectable, Kpi, KpiActionPlan, KpiListItem, KpiReading (+9 more)
...
## Knowledge Gaps
- **547 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+542 more)
...
- **Why does `fetchMe()` connect `CreateAccountDialog.tsx` to `auth-context.tsx`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 44`, `Community 45`, `@types/node`, `PaginationQueryDto`, `.add`, `react-dom`, `WorkflowPanel.tsx`, `.add`, `DatabaseService`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `templates.service.ts`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `app.module.ts`, `CreateLookupValueDto`, `attachments.controller.ts`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 44`, `Community 45`, `@types/node`, `.add`, `react-dom`, `WorkflowPanel.tsx`, `.add`, `DatabaseService`, `@nestjs/swagger`, `templates.service.ts`, `CreateKpiDto`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `app.module.ts`, `CreateLookupValueDto`, `attachments.controller.ts`?**
