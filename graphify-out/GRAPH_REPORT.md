...
## Corpus Check
- 170 files · ~67,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 2896 edges · 80 communities (68 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b7e8d20`
...
Cohesion: 0.15
Nodes (13): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsIn, IsOptional, IsString, IsUUID (+5 more)
...
Cohesion: 0.11
Nodes (26): NavSection, Props, SectionNav(), ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES, fileExt() (+18 more)
...
Cohesion: 0.38
Nodes (6): AddIssueDialog(), emptyPerson(), Props, PersonAutocomplete(), Issue, issuesApi
...
Cohesion: 0.10
Nodes (18): AuthUser, CurrentUser, Delete, Delete, IssuesController, ApiBody, Body, Controller (+10 more)
...
Cohesion: 0.15
Nodes (14): App(), ProtectedRoute(), AuthContext, AuthContextValue, AuthProvider(), useAuth(), supabase, supabaseKey (+6 more)

### Community 55 - "AttachmentDetailPage.tsx"
Cohesion: 0.19
Nodes (13): Props, SectionCard(), Skeleton(), usePageTitle(), AttachmentDetailPage(), formatSize(), longDate(), relativeTime() (+5 more)
...
### Community 57 - ".update"
Cohesion: 0.26
Nodes (13): Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost(), apiUpload(), authHeader() (+5 more)
...
Cohesion: 0.10
Nodes (36): AddAttachmentDialog(), Props, AddLinkDialog(), Props, AddResourceDialog(), Props, AddStatusReportDialog(), EDITABLE_OPTIONS (+28 more)
...
Cohesion: 0.12
Nodes (37): CategorySelect(), Props, EditProjectDialog(), Props, Props, Input(), Label(), SelectContent() (+29 more)
...
Cohesion: 0.18
Nodes (11): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, peopleApi, ProjectMemberDetail, rolesApi (+3 more)
...
- **Why does `toHttpException()` connect `Community 27` to `nest-cli.json`, `Community 2`, `Community 1`, `CreateProjectDto`, `Community 5`, `Community 6`, `Community 8`, `DatabaseModule`, `CreateProjectDto`, `Community 10`, `Community 12`, `Community 9`, `nest-cli.json`, `status-reports.repository.ts`, `@types/node`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 34`, `Community 2`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `Community 1`, `Community 34`, `Community 2`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `PeopleRepository`, `.add`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
