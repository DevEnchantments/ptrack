...
## Corpus Check
- 282 files · ~126,844 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2239 nodes · 5070 edges · 121 communities (103 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33156a76`
...
Cohesion: 0.08
Nodes (30): AuthUser, CurrentUser, ApiBody, Body, Delete, Patch, Post, Delete (+22 more)
...
Cohesion: 0.07
Nodes (40): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddRiskDialog(), emptyPerson(), AddStatusReportDialog(), today(), AddUpdateDialog() (+32 more)
...
Cohesion: 0.09
Nodes (20): CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString, IsUUID (+12 more)
...
Cohesion: 0.11
Nodes (24): App(), AppLayout(), NAV_ITEMS, ProtectedRoute(), GlobalActionItem, AuthContext, AuthContextValue, AuthProvider() (+16 more)
...
Cohesion: 0.14
Nodes (15): AppModule, Module, bootstrap(), AttachmentsModule, Module, KpisModule, Module, NotificationsModule (+7 more)

### Community 34 - "Community 34"
Cohesion: 0.20
Nodes (13): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), NotificationBell() (+5 more)
...
Cohesion: 0.11
Nodes (34): AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, CategorySelect(), Props, EditProjectDialog(), FY_YEARS (+26 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.06
Nodes (46): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+38 more)
...
Cohesion: 0.05
Nodes (41): Invalid, LookupOption, MILESTONE_STATUS, parseBoolValue(), parseDateValue(), parseMilestoneStatus(), parseNumberValue(), resolveLookup() (+33 more)
...
Cohesion: 0.13
Nodes (17): Props, SectionCard(), Skeleton(), Chip(), cyclesApi, CycleStatusReport, InitiativeProgressRow, MonthlyPerformanceMonth (+9 more)

### Community 56 - "@types/node"
Cohesion: 0.14
Nodes (16): IssuesModule, Module, LinksModule, Module, MilestonesModule, Module, ProgramOutcomesModule, Module (+8 more)
...
Cohesion: 0.18
Nodes (15): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CreateAccountDialog(), Props, DirectoryPerson (+7 more)
...
Cohesion: 0.09
Nodes (8): riskScore(), AppNotification, NotificationsRepository, Injectable, NotificationsService, Injectable, RisksService, Injectable
...
Cohesion: 0.19
Nodes (10): Props, TagChips(), ActionItemComment, actionItemsApi, ActionItemDetailPage(), commentAuthor(), ownersLabel(), STATUS_LABELS (+2 more)
...
### Community 73 - ".add"
Cohesion: 0.09
Nodes (21): RecordHistoryService, Injectable, ActionItemsService, Owners, Injectable, CreateActionItemDto, ApiProperty, ApiPropertyOptional (+13 more)
...
Cohesion: 0.18
Nodes (26): EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FieldError(), FromTemplateDialog(), Props, HelpDot() (+18 more)
...
Cohesion: 0.26
Nodes (10): GlobalMilestone, registryApi, isOverdue(), MilestonesPage(), STATUS_LABELS, addDays(), iso(), statusClass() (+2 more)
...
Cohesion: 0.33
Nodes (8): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), milestonesApi, outcomesApi
...
Cohesion: 0.08
Nodes (27): logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue, IssueListItem (+19 more)
...
Cohesion: 0.15
Nodes (15): Textarea(), personName(), Props, STATUS_CHIP, WorkflowPanel(), Cycle, KpiReading, kpisApi (+7 more)
...
## Knowledge Gaps
- **450 isolated node(s):** `AppNotification`, `ReminderKind`, `ProjectRef`, `DueActionItem`, `DueMilestone` (+445 more)
...
- **Why does `toHttpException()` connect `Get` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `lookups.service.ts`, `@nestjs/swagger`, `AppModule`, `PeoplePage.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `.add`, `AppModule`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `.add`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **What connects `AppNotification`, `ReminderKind`, `ProjectRef` to the rest of the system?**
