...
## Summary
- 2519 nodes · 6098 edges · 124 communities (106 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `15434552`
...
Cohesion: 0.10
Nodes (27): Props, Props, Props, Props, Props, Props, Props, Props (+19 more)
...
Cohesion: 0.09
Nodes (33): AddPersonDialog(), emptyPerson(), memberName(), CreateAccountDialog(), Props, ExportCsvDialog(), Props, TagChips() (+25 more)
...
Cohesion: 0.06
Nodes (45): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddStatusReportDialog(), today() (+37 more)
...
Cohesion: 0.17
Nodes (12): ActionItemsModule, Module, AttachmentsModule, Module, IssuesModule, Module, LinksModule, Module (+4 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.05
Nodes (53): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog() (+45 more)
...
Cohesion: 0.17
Nodes (7): ApiBody, Body, Controller, Get, Patch, Post, UsersController

### Community 64 - "PaginationQueryDto"
Cohesion: 0.09
Nodes (17): AdjustWeightsDto, IsArray, Type, ValidateNested, MilestonesController, ApiBody, Body, Controller (+9 more)
...
### Community 73 - ".add"
Cohesion: 0.09
Nodes (22): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, LEVEL_LABEL, AuthUser, CurrentUser (+14 more)
...
Cohesion: 0.13
Nodes (16): NotificationBell(), timeAgo(), personName(), Props, STATUS_CHIP, WorkflowPanel(), AppNotification, Cycle (+8 more)
...
Cohesion: 0.07
Nodes (29): CommandPalette(), Entry, hitPath(), KIND_META, Props, accessApi, AdminLookupRow, adminLookupsApi (+21 more)
...
- **Why does `AuthUser` connect `.add` to `.update`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 16`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 45`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `PaginationQueryDto`, `CreateLinkDto`, `README.md`, `lookups.service.ts`, `users.service.ts`, `@nestjs/swagger`, `CreateRiskDto`, `app.module.ts`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `.add` to `.update`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 16`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 45`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `PaginationQueryDto`, `CreateLinkDto`, `README.md`, `lookups.service.ts`, `@nestjs/swagger`, `CreateRiskDto`, `app.module.ts`, `ProgramOutcomesService`?**
