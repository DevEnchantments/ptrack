...
## Summary
- 2181 nodes · 4865 edges · 118 communities (106 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b181bf0e`
...
Cohesion: 0.08
Nodes (39): Props, Props, addDays(), formatAed(), iso(), milestoneShares(), MONTHS, ProjectDashboardTab() (+31 more)
...
Cohesion: 0.14
Nodes (17): AddIssueDialog(), emptyPerson(), Props, Props, Props, ConfirmDeleteButton(), Props, FieldError() (+9 more)
...
Cohesion: 0.08
Nodes (31): App(), AddRiskDialog(), emptyPerson(), Props, AppLayout(), NAV_ITEMS, CommandPalette(), Entry (+23 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.09
Nodes (29): Props, Props, ActionItemOwner, actionItemsApi, apiDelete(), apiGet(), apiPatch(), apiPost() (+21 more)
...
Cohesion: 0.10
Nodes (42): STATUSES, AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, CategorySelect(), Props, EditProjectDialog() (+34 more)
...
Cohesion: 0.13
Nodes (20): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CreateAccountDialog(), Props, NavSection (+12 more)
...
Cohesion: 0.13
Nodes (16): AddStatusReportDialog(), EDITABLE_OPTIONS, Props, today(), VIEWABLE_OPTIONS, Textarea(), Chip(), personName() (+8 more)
...
Cohesion: 0.16
Nodes (17): ProtectedRoute(), CycleStatusReport, reportsApi, usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage(), CreateProjectWizard() (+9 more)
...
Cohesion: 0.09
Nodes (20): logger, DatabaseModule, Module, DatabaseService, Injectable, Kpi, KpiActionPlan, KpiListItem (+12 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.12
Nodes (20): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), Props, Props (+12 more)
...
### Community 105 - "ActionItemsPage.tsx"
Cohesion: 0.20
...
### Community 116 - "TimelinePage.tsx"
Cohesion: 0.60
...
## Knowledge Gaps
- **447 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+442 more)
...
- **Why does `toHttpException()` connect `Community 28` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `AddMilestoneDialog.tsx`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `.add`, `DatabaseService`, `undici`, `Get`, `PeoplePage.tsx`, `AppModule`, `RecordHistoryService`, `ApiProperty`, `attachments.repository.ts`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `react-dom`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `users.module.ts`, `AppModule`, `AddMilestoneDialog.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `react-dom`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `users.module.ts`, `AppModule`, `AddMilestoneDialog.tsx`, `ApiProperty`?**
