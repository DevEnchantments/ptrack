...
## Corpus Check
- 186 files · ~73,766 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1539 nodes · 3020 edges · 92 communities (66 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d535cc3`
...
Cohesion: 0.07
Nodes (28): CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn, IsNumber (+20 more)
...
Cohesion: 0.15
Nodes (20): Props, Props, Props, Props, ActionItem, ActionItemOwner, apiDelete(), apiGet() (+12 more)
...
Cohesion: 0.11
Nodes (27): AddRiskDialog(), emptyPerson(), ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES, fileExt(), formatReportDate() (+19 more)
...
Cohesion: 0.11
Nodes (17): AuthUser, CurrentUser, Delete, Delete, Delete, Delete, ProgramOutcomesController, ApiBody (+9 more)
...
Cohesion: 0.06
Nodes (33): ApiBody, ApiProperty, ApiPropertyOptional, AppModule, Module, bootstrap(), ProjectsModule, Module (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.15
Nodes (17): PersonAutocomplete(), Props, usersApi, UserSummary, emptyMember(), Listener, toast, Props (+9 more)
...
Cohesion: 0.11
Nodes (10): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, Issue, IssueListItem, Project (+2 more)
...
Cohesion: 0.12
Nodes (20): ArrayMaxSize, ActionItemsModule, Module, Owners, CreateActionItemDto, ApiProperty, ApiPropertyOptional, IsArray (+12 more)
...
Cohesion: 0.11
Nodes (21): App(), AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry (+13 more)
...
### Community 57 - ".update"
Cohesion: 0.06
Nodes (33): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Min, Type, CreateUpdateDto, ApiProperty (+25 more)
...
Cohesion: 0.12
Nodes (28): STATUSES, Props, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, ConfirmDeleteButton(), Props (+20 more)
...
Cohesion: 0.17
Nodes (22): CategorySelect(), Props, Props, Input(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue() (+14 more)

## Knowledge Gaps
- **343 isolated node(s):** `ALLOWED`, `CacheSlot`, `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)` (+338 more)
...
- **Why does `@nestjs/swagger` connect `nest-cli.json` to `Community 1`, `Community 2`, `nest-cli.json`, `Community 6`, `Community 7`, `Community 8`, `Community 5`, `Community 10`, `Community 45`, `Community 13`, `Community 20`, `.update`, `Community 26`, `PeopleRepository`, `AddMilestoneDialog.tsx`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `nest-cli.json`, `Community 2`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `nest-cli.json`, `RecordHistoryService`, `.update`, `PeopleRepository`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `nest-cli.json`, `Community 2`, `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 13`, `nest-cli.json`, `RecordHistoryService`, `.update`, `PeopleRepository`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **What connects `ALLOWED`, `CacheSlot`, `1.1 Project → `projects` (EXTEND)` to the rest of the system?**
