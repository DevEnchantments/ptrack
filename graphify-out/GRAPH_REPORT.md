...
## Summary
- 1548 nodes · 3165 edges · 71 communities (62 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3245208c`
...
Cohesion: 0.14
Nodes (19): App(), Props, attachmentsApi, StatusReport, StatusReportDetail, statusReportsApi, AuthProvider(), usePageTitle() (+11 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (39): Props, Props, Props, Props, Props, Props, Props, Props (+31 more)
...
Cohesion: 0.11
Nodes (30): calculatedProgress(), MilestoneProgressRow, plannedProgress(), riskScore(), riskSeverityTone(), ACTIONS, attachmentUploader(), collapsePrefsKey() (+22 more)
...
Cohesion: 0.33
Nodes (8): ProjectListItem, HomePage(), initials(), prefersReducedMotion(), relativeTime(), ROWS_OPTIONS, SORTS, useEntranceFlag()
...
Cohesion: 0.10
Nodes (16): CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString, IsUUID (+8 more)
...
Cohesion: 0.11
Nodes (15): AuthUser, CurrentUser, Delete, Delete, Delete, Delete, ApiBody, Body (+7 more)
...
Cohesion: 0.05
Nodes (103): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+95 more)
...
Cohesion: 0.07
Nodes (25): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsIn, IsOptional, IsString, IsUUID, MaxLength (+17 more)
...
Cohesion: 0.05
Nodes (34): calculatedProgress(), MilestoneProgressRow, plannedProgress(), ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn (+26 more)
...
## Knowledge Gaps
- **351 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+346 more)
...
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `CreateProjectDto`, `tw-animate-css`, `Community 13`, `status-reports.repository.ts`, `Community 20`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `CreateProjectDto`, `tw-animate-css`, `Community 13`, `status-reports.repository.ts`, `Community 20`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `nest-cli.json` to `Community 1`, `react-dom`, `Community 2`, `Community 34`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 12`, `CreateProjectDto`, `.update`, `PeopleRepository`?**
