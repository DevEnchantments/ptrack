...
## Summary
- 2400 nodes · 5703 edges · 121 communities (105 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d593918`
...
Cohesion: 0.09
Nodes (13): columnsFrom(), ColumnSpec, HistoryInsert, ActionItemsRepository, Injectable, ActionItemsService, COLUMN_SPEC, CREATE_DEFAULTS (+5 more)
...
Cohesion: 0.08
Nodes (18): ApiConsumes, ApiBody, Body, Delete, Get, Param, Patch, Post (+10 more)
...
Cohesion: 0.05
Nodes (51): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddStatusReportDialog(), today(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog() (+43 more)
...
Cohesion: 0.09
Nodes (41): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), PersonAutocomplete(), Props, SelectContent() (+33 more)
...
Cohesion: 0.17
Nodes (10): AdminOnly(), ProjectScoped(), AttachmentsController, Controller, ProgramOutcomesController, Controller, RisksController, Controller (+2 more)
...
Cohesion: 0.11
Nodes (28): App(), Props, SectionCard(), Skeleton(), statusReportsApi, reportsApi, AuthProvider(), usePageTitle() (+20 more)
...
Cohesion: 0.11
Nodes (21): Props, initials(), Props, RecordHistory(), relativeTime(), TABLE_NOUNS, username(), actionItemsApi (+13 more)
...
Cohesion: 0.13
Nodes (20): AccessLevel, APP_ROLES, AppRole, atLeastRole(), defaultLevelFor(), isAppRole(), MEMBERSHIP_LEVEL, ProjectAccessInput (+12 more)
...
Cohesion: 0.11
Nodes (14): MilestoneProgressRow, toHttpException(), Project, ProjectDetail, ProjectListRow, ProjectListStats, ProjectsRepository, Injectable (+6 more)
...
Cohesion: 0.07
Nodes (29): AuthUser, CurrentUser, DashboardController, Controller, Get, Delete, Delete, Delete (+21 more)
...
Cohesion: 0.07
Nodes (25): AuthedRequest, HistoryEntry, logger, DatabaseService, Injectable, ActionItem, ActionItemComment, ActionItemListItem (+17 more)
...
### Community 65 - ".add"
Cohesion: 0.16
Nodes (10): RecordHistoryService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, PARENT_TABLES (+2 more)
...
Cohesion: 0.19
Nodes (13): Props, fmtAed(), ProjectOverviewCards(), Chip(), ProjectDetail, atRiskSuggested(), calculatedProgress(), MilestoneProgressRow (+5 more)
...
Cohesion: 0.11
Nodes (19): AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts(), MiniCalendar(), MONTHS (+11 more)

### Community 71 - "moduleFileExtensions"
Cohesion: 0.11
Nodes (29): AppLayout(), NAV_ITEMS, FromTemplateDialog(), COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow (+21 more)
...
Cohesion: 0.16
Nodes (13): NotificationBell(), timeAgo(), formatSize(), Props, TaskAttachments(), personName(), STATUS_CHIP, WorkflowPanel() (+5 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.24
Nodes (19): FREQUENCIES, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FieldError(), Props, HelpDot() (+11 more)
...
Cohesion: 0.23
Nodes (10): MinAppRole(), KpisController, ApiBody, Body, Controller, Delete, Get, Param (+2 more)
...
Cohesion: 0.07
Nodes (33): AddKpiDialog(), emptyPerson(), Props, CommandPalette(), Entry, hitPath(), KIND_META, Props (+25 more)
...
Cohesion: 0.14
Nodes (18): StatusPill(), TONE_CLASSES, toneFor(), GlobalActionItem, GlobalMilestone, registryApi, ActionItemsPage(), isOverdue() (+10 more)
...
## Knowledge Gaps
- **485 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+480 more)
...
- **Why does `toHttpException()` connect `CreateProjectDto` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `.add`, `AddMilestoneDialog.tsx`, `eslint-plugin-react-hooks`, `RisksService`, `ApiProperty`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `.update`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `action-items.repository.ts`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `.add`, `README.md`, `AddMilestoneDialog.tsx`, `eslint-plugin-react-hooks`, `ApiProperty`, `ProgramOutcomesService`?**
