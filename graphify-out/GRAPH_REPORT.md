...
Cohesion: 0.09
Nodes (17): CurrentUser, UpdateMilestoneDto, UpdateRiskDto, ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength (+9 more)
...
Cohesion: 0.06
Nodes (29): logger, DatabaseService, Injectable, Issue, IssueListItem, Kpi, KpiActionPlan, KpiListItem (+21 more)
...
Cohesion: 0.08
Nodes (15): RecordHistoryService, Injectable, ActionItemsService, COLUMN_SPEC, CREATE_DEFAULTS, Owners, ownersLabel(), Injectable (+7 more)
...
Cohesion: 0.04
Nodes (91): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), today(), AddAttachmentDialog(), AddIssueDialog(), emptyPerson() (+83 more)
...
Cohesion: 0.15
Nodes (15): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), DashboardController, Controller, Get, ChartPoint (+7 more)
...
Cohesion: 0.04
Nodes (53): Props, Props, Props, Props, Props, Props, Props, Props (+45 more)
...
Cohesion: 0.07
Nodes (27): AuthUser, Delete, NotificationsController, Controller, Get, Param, Post, ApiBody (+19 more)
...
Cohesion: 0.07
Nodes (23): columnsFrom(), ColumnSpec, CreateLinkDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsOptional (+15 more)
...
## Knowledge Gaps
- **490 isolated node(s):** `COLUMN_SPEC`, `CREATE_DEFAULTS`, `Verification gate (all must pass before a phase is ticked)`, `2. Per-session protocol`, `3. Skill mapping` (+485 more)
...
- **Why does `toHttpException()` connect `Get` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 20`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `2. Core functional modules`, `WorkflowPanel.tsx`, `lookups.service.ts`, `AddMilestoneDialog.tsx`, `transform`, `@nestjs/swagger`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `@nestjs/config` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `.add`, `transform`, `Get`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 1` to `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `@nestjs/config`, `.add`, `transform`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **What connects `COLUMN_SPEC`, `CREATE_DEFAULTS`, `Verification gate (all must pass before a phase is ticked)` to the rest of the system?**
