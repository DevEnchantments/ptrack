...
## Corpus Check
- 282 files · ~125,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2234 nodes · 4948 edges · 122 communities (105 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6f18967`
...
Cohesion: 0.13
Nodes (12): AuthUser, CurrentUser, Delete, Delete, Delete, Get, Param, Post (+4 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (29): ApiConsumes, AttachmentsController, ApiBody, Body, Controller, Delete, Get, Param (+21 more)
...
Cohesion: 0.13
Nodes (17): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), DashboardController, Controller, Get (+9 more)

### Community 17 - "CreateProjectDto"
Cohesion: 0.13
Nodes (8): IssuesModule, Module, Issue, IssueListItem, IssuesRepository, Injectable, IssuesService, Injectable
...
Cohesion: 0.07
Nodes (27): CreateRiskDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsOptional, IsString, IsUUID (+19 more)
...
Cohesion: 0.10
Nodes (10): ACTION_BODY, CyclesController, ReportsController, SubmissionsController, Controller, Get, SubmissionsRepository, Injectable (+2 more)
...
Cohesion: 0.18
Nodes (9): App(), InitiativeProgressRow, MonthlyPerformanceMonth, reportsApi, AuthProvider(), ReportingPage(), BUCKET_CHIP, InitiativeProgressReportPage() (+1 more)

### Community 34 - "Community 34"
Cohesion: 0.10
Nodes (25): AdjustWeightsDto, ApiProperty, ApiPropertyOptional, IsArray, IsNumber, IsOptional, IsUUID, Min (+17 more)
...
Cohesion: 0.13
Nodes (31): Props, Props, CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), Label() (+23 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.07
Nodes (41): AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell() (+33 more)
...
Cohesion: 0.12
Nodes (23): Props, TagChips(), CycleStatusReport, DirectoryPerson, GlobalActionItem, GlobalMilestone, registryApi, usePageTitle() (+15 more)

### Community 56 - "@types/node"
Cohesion: 0.16
Nodes (14): ActionItemsModule, Module, ImportModule, Module, MilestonesModule, Module, ProgramOutcomesModule, Module (+6 more)
...
Cohesion: 0.08
Nodes (20): NotificationsController, Controller, NotificationsModule, Module, AppNotification, NotificationsRepository, Injectable, NotificationsService (+12 more)
...
### Community 73 - ".add"
Cohesion: 0.16
Nodes (6): toHttpException(), ActionItemsRepository, Injectable, ActionItemsService, ownersLabel(), Injectable
...
Cohesion: 0.08
Nodes (46): Props, AddIssueDialog(), emptyPerson(), Props, AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName() (+38 more)
...
Cohesion: 0.19
Nodes (9): SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, ApiBody, Body, Param (+1 more)

### Community 79 - "README.md"
Cohesion: 0.20
Nodes (7): PortfolioReportsController, MONTH_LABELS, ReportsService, Injectable, Controller, Get, Query
...
Cohesion: 0.12
Nodes (23): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddRiskDialog() (+15 more)
...
Cohesion: 0.14
Nodes (10): DatabaseModule, Module, DatabaseService, Injectable, RecordHistoryService, Injectable, Cycle, Submission (+2 more)
...
### Community 103 - "@types/node"
Cohesion: 0.36
Nodes (5): AppModule, Module, bootstrap(), ReportsModule, Module
...
## Knowledge Gaps
- **450 isolated node(s):** `ChartPoint`, `DashboardData`, `MONTH_LABELS`, `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)` (+445 more)
...
- **Why does `toHttpException()` connect `.add` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `.add`, `CreateLinkDto`, `2. Core functional modules`, `WorkflowPanel.tsx`, `milestones.repository.ts`, `@nestjs/swagger`, `undici`, `Get`, `PeoplePage.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 9`, `Community 10`, `Community 26`, `Community 27`, `Community 28`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `CreateLinkDto`, `2. Core functional modules`, `WorkflowPanel.tsx`, `milestones.repository.ts`, `AppModule`, `users.module.ts`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 9`, `Community 10`, `Community 26`, `Community 27`, `Community 28`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `CreateLinkDto`, `2. Core functional modules`, `WorkflowPanel.tsx`, `milestones.repository.ts`, `AppModule`, `users.module.ts`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **What connects `ChartPoint`, `DashboardData`, `MONTH_LABELS` to the rest of the system?**
