...
## Summary
- 2250 nodes · 5155 edges · 123 communities (106 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `409ce60e`
...
Cohesion: 0.21
Nodes (10): AuthUser, Delete, Delete, Delete, Delete, SubmissionsController, ApiBody, Body (+2 more)
...
Cohesion: 0.12
Nodes (30): CategorySelect(), Props, FY_YEARS, SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), categoriesApi (+22 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.04
Nodes (68): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+60 more)
...
Cohesion: 0.13
Nodes (8): CurrentUser, Delete, ApiBody, Body, Post, Delete, Delete, @nestjs/swagger
...
Cohesion: 0.10
Nodes (24): logger, toHttpException(), DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+16 more)
...
- **Why does `toHttpException()` connect `@nestjs/swagger` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `lookups.service.ts`, `AppModule`, `Get`, `PeoplePage.tsx`, `eslint-plugin-react-hooks`, `ApiProperty`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `CreateLinkDto`, `.add`, `README.md`, `AppModule`, `DatabaseModule`, `tailwind-merge`, `jose`, `ApiProperty`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `CreateLinkDto`, `.add`, `README.md`, `DatabaseModule`, `tailwind-merge`, `jose`, `ApiProperty`?**
