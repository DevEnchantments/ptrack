...
Cohesion: 0.05
Nodes (50): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), SectionCard() (+42 more)
...
Cohesion: 0.11
Nodes (14): ReportsModule, Module, MilestoneDateRow, MilestoneProgressRow, Person, ReportProjectRow, ReportsRepository, SubmissionCycleRow (+6 more)
...
Cohesion: 0.15
Nodes (19): ActionItemsBreakdown(), ActivityLineChart(), BudgetBar(), CategoryDonut(), ChartPoint, ChartSegment, CompletionRadial(), FlowLineChart() (+11 more)
...
Cohesion: 0.09
Nodes (23): AppRole, categoriesApi, lookupCache, MyMembership, MyWork, MyWorkItem, peopleApi, rolesApi (+15 more)
...
Cohesion: 0.12
Nodes (10): ApiBody, Body, Controller, Get, Patch, Post, Query, UsersController (+2 more)
...
Cohesion: 0.07
Nodes (25): CreateSavedSearchDto, ApiProperty, IsString, MaxLength, MinLength, SearchController, ApiBody, Body (+17 more)
...
Cohesion: 0.11
Nodes (17): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID (+9 more)
...
Cohesion: 0.08
Nodes (21): AuthUser, CurrentUser, Delete, Get, Delete, Delete, Get, Param (+13 more)

### Community 64 - "PaginationQueryDto"
Cohesion: 0.19
Nodes (4): AccessAdminRepository, ProfileRoleRow, ProfileRow, Injectable
...
### Community 73 - ".add"
Cohesion: 0.18
Nodes (11): ApiTags, AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, LEVEL_LABEL, ProjectSectionsController (+3 more)
...
Cohesion: 0.19
Nodes (14): Props, emptyMember(), Props, StepAccess(), StepConfirmation(), Props, StepDetails(), Props (+6 more)
...
Cohesion: 0.25
Nodes (8): Capability, GRANTABLE_ROLES, GrantableRole, isCapability(), CapabilityService, Injectable, AccessAdminService, Injectable
...
Cohesion: 0.22
Nodes (6): AppRole, AppRoleGuard, Injectable, AppRoleService, Injectable, ProjectAccessRow
...
Cohesion: 0.15
Nodes (13): CAPABILITY_KEYS, ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, ApiProperty (+5 more)
...
Cohesion: 0.07
Nodes (41): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ProtectedRoute() (+33 more)
...
Cohesion: 0.12
Nodes (12): ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID, UpdatePersonDto, PeopleRepository (+4 more)

### Community 114 - "CreateLookupValueDto"
Cohesion: 0.13
Nodes (15): AppModule, Module, bootstrap(), AccessAdminModule, Module, KpisModule, Module, LookupsModule (+7 more)
...
Cohesion: 0.21
Nodes (10): columnsFrom(), ColumnSpec, CreateStatusReportDto, ApiProperty, IsDateString, IsIn, IsString, MaxLength (+2 more)
...
Cohesion: 0.10
Nodes (20): accessApi, AdminLookupRow, adminLookupsApi, AdminLookupTable, AdminUser, CapabilityGrants, CapabilityInfo, DirectoryMembership (+12 more)

### Community 130 - "attachments.repository.ts"
Cohesion: 0.26
Nodes (11): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, PARENT_TABLES, COLUMN_SPEC, PARENT_TYPES (+3 more)

### Community 131 - "columnsFrom"
Cohesion: 0.21
Nodes (10): APP_ROLES, atLeastRole(), CAPABILITIES, DEFAULT_GRANTS, defaultLevelFor(), isAppRole(), MEMBERSHIP_LEVEL, ProjectAccessInput (+2 more)
...
### Community 144 - "HistoryEntry"
Cohesion: 0.52
Nodes (4): HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem

### Community 145 - "status-reports.repository.ts"
Cohesion: 0.26
Nodes (5): ProjectSectionsService, Injectable, StatusReport, StatusReportDetail, StatusReportListItem
...
### Community 153 - "WorkflowPanel.tsx"
Cohesion: 0.40
Nodes (5): Chip(), personName(), STATUS_CHIP, WorkflowPanel(), cyclesApi
...
## Knowledge Gaps
- **574 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+569 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `ProjectsGrid.tsx`, `CreateProjectDto`, `HomePage`, `Community 20`, `SearchModule`, `UsersModule`, `Community 26`, `ProjectsRepository`, `Community 45`, `nest-cli.json`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `🚀 Quick start`, `users.service.ts`, `ActionItemsController`, `eslint-plugin-react-hooks`, `CreateMilestoneDto`, `eslint`, `ProjectSectionsController`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `ProjectsGrid.tsx`, `CreateProjectDto`, `HomePage`, `Community 20`, `SearchModule`, `UsersModule`, `Community 26`, `ProjectsRepository`, `Community 45`, `nest-cli.json`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `users.service.ts`, `ActionItemsController`, `eslint-plugin-react-hooks`, `CreateMilestoneDto`, `eslint`, `ProjectSectionsController`?**
