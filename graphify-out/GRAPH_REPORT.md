...
## Summary
- 2333 nodes · 5381 edges · 120 communities (101 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9dfb34d9`
...
Cohesion: 0.09
Nodes (18): HistoryEntry, HistoryInsert, logger, DatabaseService, Injectable, RecordHistoryService, Injectable, ActionItem (+10 more)
...
Cohesion: 0.05
Nodes (63): App(), AppLayout(), NAV_ITEMS, ProtectedRoute(), Props, SectionCard(), Props, TagChips() (+55 more)
...
Cohesion: 0.09
Nodes (34): ActionItemsModule, Module, AttachmentsModule, Module, DashboardModule, Module, ImportModule, Module (+26 more)
...
Cohesion: 0.08
Nodes (21): AuthUser, CurrentUser, Delete, Delete, Delete, NotificationsController, Controller, Get (+13 more)
...
## Knowledge Gaps
- **492 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+487 more)
...
- **Why does `toHttpException()` connect `Community 20` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `2. Core functional modules`, `@nestjs/swagger`, `Get`, `ts-node`, `ProjectsGrid.tsx`, `@types/supertest`, `lookups.service.ts`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `DatabaseService` to `Community 1`, `Community 6`, `Community 10`, `CreateProjectDto`, `Community 26`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `@nestjs/config`, `.add`, `.add`, `transform`, `DatabaseModule`, `ts-loader`, `ProjectsGrid.tsx`?**
