...
## Corpus Check
- 188 files · ~75,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1525 nodes · 3236 edges · 80 communities (70 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `faf0de8d`
...
Cohesion: 0.08
Nodes (36): AddAttachmentDialog(), AddLinkDialog(), Props, AddResourceDialog(), AddStatusReportDialog(), today(), AddUpdateDialog(), NavSection (+28 more)
...
Cohesion: 0.13
Nodes (12): AuthUser, CurrentUser, Delete, Delete, Delete, Delete, Delete, Delete (+4 more)
...
Cohesion: 0.13
Nodes (28): CategorySelect(), Props, SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), Lookup, lookupsApi (+20 more)
...
Cohesion: 0.14
Nodes (11): HistoryEntry, HistoryInsert, logger, toHttpException(), ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository (+3 more)
...
Cohesion: 0.21
Nodes (12): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString, IsIn, IsOptional, IsString (+4 more)
...
Cohesion: 0.24
Nodes (3): ActionItemsService, ownersLabel(), Injectable
...
Cohesion: 0.18
Nodes (10): App(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props, AuthProvider() (+2 more)
...
Cohesion: 0.25
Nodes (18): EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FieldError(), HelpDot(), Button(), buttonVariants (+10 more)
...
Cohesion: 0.10
Nodes (11): AuthedRequest, DatabaseModule, Module, DatabaseService, Injectable, RecordHistoryService, Injectable, Issue (+3 more)
...
- **Why does `toHttpException()` connect `Community 34` to `Community 1`, `Community 2`, `react-dom`, `RecordHistoryService`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `status-reports.repository.ts`, `Community 12`, `links.repository.ts`, `@types/node`, `CreateProjectDto`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `nest-cli.json`, `Community 1`, `CreateProjectDto`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `links.repository.ts`, `Community 13`, `nest-cli.json`, `.update`, `Community 26`, `PeopleRepository`, `StepDetails.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `nest-cli.json`, `Community 1`, `CreateProjectDto`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `links.repository.ts`, `Community 13`, `nest-cli.json`, `.update`, `Community 26`, `PeopleRepository`, `StepDetails.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
