...
Cohesion: 0.36
Nodes (5): UpdateRiskDto, Risk, RiskListItem, COLUMN_SPEC, CREATE_DEFAULTS
...
Cohesion: 0.05
Nodes (64): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ExportCsvDialog() (+56 more)
...
Cohesion: 0.06
Nodes (27): db, ensure(), env, PROGRAMS, root, rows(), STANDARD, CreateLookupValueDto (+19 more)

### Community 13 - "Community 13"
Cohesion: 0.16
Nodes (14): COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow, StatusPill(), TONE_CLASSES, toneFor() (+6 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (49): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), projectAccessLevel() (+41 more)
...
Cohesion: 0.16
Nodes (11): AttachmentsModule, Module, AttachmentsService, COLUMN_SPEC, PARENT_TYPES, parseParent(), parseUploadBody(), safeName() (+3 more)
...
Cohesion: 0.05
Nodes (52): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+44 more)
...
Cohesion: 0.16
Nodes (16): Props, sectorsApi, Project, emptyMember(), Props, StepAccess(), StepConfirmation(), Props (+8 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (21): CreateSavedSearchDto, ApiProperty, IsString, MaxLength, MinLength, ApiBody, Body, Post (+13 more)

### Community 46 - "nest-cli.json"
Cohesion: 0.12
Nodes (13): AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, CreateCommentDto, ApiProperty, IsString, MinLength (+5 more)
...
Cohesion: 0.08
Nodes (22): AuthUser, CurrentUser, Get, NotificationsController, Controller, Get, Param, Post (+14 more)
...
### Community 65 - ".add"
Cohesion: 0.10
Nodes (11): describeProjectScopedContract(), Mocks, ProjectScopedContract, RecordHistoryService, Injectable, PeopleModule, Module, PeopleRepository (+3 more)
...
Cohesion: 0.16
Nodes (12): RequireCapability(), UpdateKpiActionPlanDto, UpdateKpiDto, KpisController, ApiBody, Body, Controller, Delete (+4 more)
...
### Community 73 - ".add"
Cohesion: 0.15
Nodes (5): ProjectsRepository, Injectable, projectColumns(), ProjectsService, Injectable
...
Cohesion: 0.10
Nodes (26): AddStatusReportDialog(), today(), Props, SectionCard(), formatSize(), Props, TaskAttachments(), Button() (+18 more)
...
Cohesion: 0.10
Nodes (7): logger, toHttpException(), AttachmentsRepository, Injectable, ProgramOutcome, ProgramOutcomesRepository, Injectable

### Community 84 - "users.service.ts"
Cohesion: 0.15
Nodes (9): UpdateIssueDto, Issue, IssueListItem, IssuesRepository, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, IssuesService (+1 more)
...
Cohesion: 0.18
Nodes (8): columnsFrom(), ColumnSpec, Kpi, KpiActionPlan, KpiListItem, KpiReading, COLUMN_SPEC, CREATE_DEFAULTS

### Community 91 - "DatabaseModule"
Cohesion: 0.11
Nodes (18): ActionItemsModule, Module, IssuesModule, Module, LinksModule, Module, ProgramOutcomesModule, Module (+10 more)
...
### Community 103 - "vite"
Cohesion: 0.19
Nodes (10): UpdateLinkDto, LinksController, ApiBody, Body, Controller, Delete, Get, Param (+2 more)
...
Cohesion: 0.17
Nodes (10): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID (+2 more)
...
Cohesion: 0.11
Nodes (15): ApiBody, ApiConsumes, AttachmentsController, Body, Controller, CurrentUser, Delete, Get (+7 more)
...
Cohesion: 0.15
Nodes (8): Link, LinkListItem, LinksRepository, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, LinksService, Injectable

### Community 124 - "UpdateMeDto"
Cohesion: 0.42
Nodes (6): Project, ProjectDetail, ProjectListRow, ProjectListStats, COLUMN_SPEC, utilizationRatio()

### Community 125 - "milestones.service.ts"
Cohesion: 0.18
Nodes (9): HistoryEntry, HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, COLUMN_SPEC, CREATE_DEFAULTS, Owners (+1 more)
...
Cohesion: 0.22
Nodes (9): ImportSummary, parseCsv(), FieldDef, ImportPage(), MILESTONE_FIELDS, PROJECT_FIELDS, RowCheck, validDate() (+1 more)
...
### Community 131 - "milestones.service.ts"
Cohesion: 0.36
...
### Community 135 - "attachments.repository.ts"
Cohesion: 0.42
...
## Knowledge Gaps
- **580 isolated node(s):** `COLUMN_SPEC`, `COLUMN_SPEC`, `CREATE_DEFAULTS`, `NotificationContext`, `WorkflowNotification` (+575 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `Community 1`, `.update`, `Community 6`, `Community 10`, `ProjectSectionsController`, `UsersModule`, `ProjectsRepository`, `Community 45`, `nest-cli.json`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `users.service.ts`, `globals`, `ActionItemsController`, `vite`, `project-sections.service.ts`, `eslint`, `.me`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `Community 1`, `.update`, `Community 6`, `Community 10`, `ProjectSectionsController`, `UsersModule`, `ProjectsRepository`, `Community 45`, `nest-cli.json`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `users.service.ts`, `globals`, `ActionItemsController`, `vite`, `project-sections.service.ts`, `eslint`, `.me`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **What connects `COLUMN_SPEC`, `COLUMN_SPEC`, `CREATE_DEFAULTS` to the rest of the system?**
