...
## Summary
- 1524 nodes · 3227 edges · 83 communities (74 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d7ab683`
...
Cohesion: 0.10
Nodes (13): IssuesController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+5 more)
...
Cohesion: 0.08
Nodes (35): Props, Props, Props, Props, Props, Props, Props, ActionItemOwner (+27 more)
...
Cohesion: 0.19
Nodes (13): PersonAutocomplete(), Props, emptyMember(), Props, StepAccess(), StepConfirmation(), Props, StepDetails() (+5 more)
...
Cohesion: 0.13
Nodes (8): HistoryInsert, logger, toHttpException(), ActionItemsRepository, Injectable, ActionItemsService, ownersLabel(), Injectable
...
Cohesion: 0.13
Nodes (17): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS (+9 more)
...
Cohesion: 0.18
Nodes (13): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), milestonesApi (+5 more)
...
Cohesion: 0.21
Nodes (17): CategorySelect(), Props, Input(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), Lookup (+9 more)
...
- **Why does `toHttpException()` connect `Community 34` to `Community 1`, `Community 2`, `.update`, `CreateProjectDto`, `react-dom`, `Community 6`, `Community 7`, `Community 8`, `Community 5`, `CreateProjectDto`, `Community 10`, `Community 12`, `links.repository.ts`, `@types/node`, `CreateProjectDto`, `.update`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 5`, `StatusPill.tsx`, `Community 6`, `Community 8`, `Community 7`, `Community 10`, `moduleFileExtensions`, `Community 13`, `nest-cli.json`, `Community 20`, `.update`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 5`, `StatusPill.tsx`, `Community 6`, `Community 8`, `Community 7`, `Community 10`, `moduleFileExtensions`, `Community 13`, `nest-cli.json`, `Community 20`, `.update`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
