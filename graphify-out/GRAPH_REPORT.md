...
## Corpus Check
- 246 files · ~106,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2009 nodes · 4290 edges · 100 communities (83 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b8badd1`
...
Cohesion: 0.11
Nodes (22): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, PersonAutocomplete(), Props, peopleApi (+14 more)
...
Cohesion: 0.19
Nodes (25): Props, Props, CategorySelect(), Props, Input(), Label(), SelectContent(), SelectItem() (+17 more)
...
Cohesion: 0.10
Nodes (15): AppModule, Module, bootstrap(), RegistryController, RegistryModule, Module, DirectoryMembership, DirectoryPerson (+7 more)
...
Cohesion: 0.13
Nodes (19): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddRiskDialog() (+11 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.07
Nodes (41): CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell(), timeAgo(), Chip() (+33 more)
...
Cohesion: 0.06
Nodes (29): RecordHistoryService, Injectable, CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString, IsIn (+21 more)
...
Cohesion: 0.08
Nodes (28): App(), AppLayout(), NAV_ITEMS, COLUMNS, ProjectsGrid(), GlobalActionItem, GlobalMilestone, ProjectListItem (+20 more)
...
### Community 73 - ".add"
Cohesion: 0.06
Nodes (29): ArrayMaxSize, HistoryEntry, HistoryInsert, ActionItemsModule, Module, ActionItem, ActionItemComment, ActionItemListItem (+21 more)

### Community 74 - "DatabaseService"
Cohesion: 0.14
Nodes (7): AuthedRequest, DatabaseModule, Module, DatabaseService, Injectable, AppNotification, Global
...
Cohesion: 0.15
Nodes (15): calculatedProgress(), MilestoneProgressRow, plannedProgress(), MilestonesModule, Module, NotificationsModule, Module, ProjectsModule (+7 more)
...
Cohesion: 0.29
Nodes (8): projectsApi, calculatedProgress(), MilestoneProgressRow, plannedProgress(), riskScore(), riskSeverityTone(), MILESTONE_LABELS, ProjectProgressReportPage()

### Community 86 - "undici"
Cohesion: 0.24
Nodes (7): logger, Kpi, KpiActionPlan, KpiListItem, KpiReading, Milestone, MilestoneListItem
...
## Knowledge Gaps
- **418 isolated node(s):** `What this project is`, `Tech stack`, `Hard architectural rules (do not violate)`, `Repo & environment`, `Current state — Phase 1 complete (full CRUD)` (+413 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `.add`, `.add`, `DatabaseService`, `WorkflowPanel.tsx`, `RecordHistory.tsx`, `undici`, `kpis.repository.ts`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `@nestjs/swagger` to `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `CreateRiskDto`, `.add`, `nest-cli.json`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `nest-cli.json`, `Community 34`, `CreateRiskDto`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `.add`, `Community 10`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `ProjectsController`, `.update`, `Community 26`, `PeopleRepository`, `auth-context.tsx`?**
