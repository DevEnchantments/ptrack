...
## Corpus Check
- 168 files · ~66,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1408 nodes · 2768 edges · 85 communities (72 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72a3167a`
...
Cohesion: 0.18
Nodes (12): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsIn, IsOptional, IsString, IsUUID (+4 more)
...
Cohesion: 0.16
Nodes (7): UpdateLinkDto, Link, LinkListItem, LinksRepository, Injectable, LinksService, Injectable
...
Cohesion: 0.12
Nodes (24): linksApi, ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES, fileExt(), formatReportDate(), formatSize() (+16 more)
...
Cohesion: 0.13
Nodes (21): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), Props, STATUSES, today(), Milestone (+13 more)
...
Cohesion: 0.10
Nodes (35): Props, EditProjectDialog(), Props, PersonAutocomplete(), Props, ActionItemOwner, apiDelete(), apiGet() (+27 more)
...
Cohesion: 0.12
Nodes (16): AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props (+8 more)
...
Cohesion: 0.13
Nodes (24): Props, Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, ConfirmDeleteButton(), Props, FieldError() (+16 more)
...
Cohesion: 0.17
Nodes (14): App(), attachmentsApi, usePageTitle(), AttachmentDetailPage(), formatSize(), longDate(), relativeTime(), uploaderName() (+6 more)
...
### Community 81 - "SectionNav.tsx"
Cohesion: 0.27
Nodes (5): Props, NavSection, Props, Button(), buttonVariants

### Community 82 - "AppModule"
Cohesion: 0.50
Nodes (3): AppModule, Module, bootstrap()

### Community 83 - "StatusPill.tsx"
Cohesion: 0.67
Nodes (3): StatusPill(), TONE_CLASSES, toneFor()

### Community 84 - "Attachment"
Cohesion: 0.67
Nodes (3): Props, Attachment, AttachmentDetail

## Knowledge Gaps
- **341 isolated node(s):** `Proposed token changes (Stage 1), before → after, all computed`, `A. Tokens + `components/ui` primitives — severity HIGH, effort M`, `B. Dialogs (10 Add*/Edit*) — severity HIGH, effort M`, `C. Detail pages — severity HIGH, effort M-L`, `D. AppLayout + CommandPalette — severity MED, effort S` (+336 more)
...
- **Why does `toHttpException()` connect `nest-cli.json` to `Community 1`, `Community 2`, `AddActionItemDialog.tsx`, `Community 6`, `Community 7`, `Community 8`, `Community 5`, `Community 10`, `Community 9`, `nest-cli.json`, `status-reports.repository.ts`, `PeopleRepository`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `Community 28` to `Community 1`, `Community 2`, `Community 5`, `status-reports.repository.ts`, `Community 6`, `Community 8`, `DatabaseModule`, `Community 9`, `Community 10`, `AppModule`, `Community 20`, `@types/node`, `PeopleRepository`, `AddMilestoneDialog.tsx`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 2`, `AddActionItemDialog`, `.update`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `transform`, `Community 28`, `PeopleRepository`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **What connects `Proposed token changes (Stage 1), before → after, all computed`, `A. Tokens + `components/ui` primitives — severity HIGH, effort M`, `B. Dialogs (10 Add*/Edit*) — severity HIGH, effort M` to the rest of the system?**
