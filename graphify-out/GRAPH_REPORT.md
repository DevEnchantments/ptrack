...
Cohesion: 0.07
Nodes (24): CreateKpiActionPlanDto, CreateKpiReadingDto, ApiProperty, ApiPropertyOptional, IsDateString, IsIn, IsNumber, IsOptional (+16 more)
...
Cohesion: 0.07
Nodes (22): ArrayMinSize, AuthUser, Delete, ImportRowsDto, ApiProperty, ArrayMaxSize, IsArray, ImportController (+14 more)
...
Cohesion: 0.07
Nodes (40): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddStatusReportDialog(), today(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog() (+32 more)
...
Cohesion: 0.11
Nodes (7): HistoryEntry, toHttpException(), Cycle, Submission, SubmissionListItem, SubmissionsRepository, Injectable
...
Cohesion: 0.10
Nodes (20): App(), sectorsApi, AuthContext, AuthContextValue, AuthProvider(), emptyMember(), supabase, supabaseKey (+12 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.04
Nodes (63): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+55 more)
...
Cohesion: 0.05
Nodes (61): AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, EditProjectDialog(), personFromProfile() (+53 more)
...
Cohesion: 0.10
Nodes (24): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddMilestoneDialog(), emptyOwner() (+16 more)

### Community 73 - ".add"
Cohesion: 0.06
Nodes (31): ActionItemsController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+23 more)
...
Cohesion: 0.07
Nodes (25): AuthedRequest, logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue (+17 more)
...
## Knowledge Gaps
- **450 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+445 more)
...
- **Why does `toHttpException()` connect `AddMilestoneDialog.tsx` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 28`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `.add`, `CreateLinkDto`, `.add`, `@nestjs/swagger`, `Get`, `PeoplePage.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `2. Core functional modules`, `.add`, `WorkflowPanel.tsx`, `@nestjs/swagger`, `AppModule`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `status-reports.repository.ts` to `Community 1`, `Community 34`, `Community 26`, `nest-cli.json`, `Community 6`, `Community 8`, `.add`, `Community 9`, `Community 10`, `Community 12`, `Community 45`, `Community 44`, `WorkflowPanel.tsx`, `CreateProjectDto`, `RecordHistoryService`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`?**
