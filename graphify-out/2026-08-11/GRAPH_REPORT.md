...
Cohesion: 0.24
Nodes (10): ProjectTree(), Props, TreeRow, HomePage(), initials(), prefersReducedMotion(), relativeTime(), ROWS_OPTIONS (+2 more)
...
Cohesion: 0.13
Nodes (18): Owners, CreateActionItemDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize, IsArray, IsDateString, IsIn (+10 more)
...
Cohesion: 0.05
Nodes (51): AddAttachmentDialog(), AddLinkDialog(), Props, AddResourceDialog(), Props, AddStatusReportDialog(), today(), AddUpdateDialog() (+43 more)
...
Cohesion: 0.11
Nodes (28): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CategorySelect(), PersonAutocomplete(), Props (+20 more)
...
Cohesion: 0.11
Nodes (23): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), Props, STATUSES, today() (+15 more)
...
Cohesion: 0.06
Nodes (47): Props, Props, AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META (+39 more)
...
Cohesion: 0.10
Nodes (31): Props, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+23 more)

### Community 56 - "@types/node"
Cohesion: 0.16
Nodes (12): ActionItemsModule, Module, NotificationsModule, Module, ResourcesModule, Module, StatusReportsModule, Module (+4 more)
...
Cohesion: 0.15
Nodes (12): AppModule, Module, DatabaseModule, Module, bootstrap(), IssuesModule, Module, KpisModule (+4 more)
...
Cohesion: 0.14
Nodes (21): App(), Chip(), GlobalActionItem, registryApi, AuthProvider(), usePageTitle(), ActionItemsPage(), isOverdue() (+13 more)

### Community 73 - ".add"
Cohesion: 0.14
Nodes (7): logger, toHttpException(), ActionItemsRepository, Injectable, ActionItemsService, ownersLabel(), Injectable

### Community 74 - "DatabaseService"
Cohesion: 0.10
Nodes (20): AuthedRequest, DatabaseService, Injectable, Issue, IssueListItem, Kpi, KpiActionPlan, KpiListItem (+12 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.24
Nodes (20): FREQUENCIES, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, FY_YEARS, FieldError(), HelpDot() (+12 more)
...
Cohesion: 0.38
Nodes (5): AdjustWeightsDto, IsArray, Type, ValidateNested, UpdateMilestoneDto
...
Cohesion: 0.32
Nodes (6): Props, TagChips(), GlobalMilestone, isOverdue(), MilestonesPage(), STATUS_LABELS
...
## Knowledge Gaps
- **440 isolated node(s):** `What this project is`, `Tech stack`, `Hard architectural rules (do not violate)`, `Repo & environment`, `Current state — Phase 1 complete (full CRUD)` (+435 more)
...
- **Why does `toHttpException()` connect `.add` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `nest-cli.json`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `Community 50`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `CreatePersonDto`, `DatabaseService`, `WorkflowPanel.tsx`, `AddActionItemDialog.tsx`, `undici`, `@types/node`, `PeoplePage.tsx`, `AppModule`, `kpis.repository.ts`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `react-dom`, `Community 34`, `CreateRiskDto`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 9`, `Community 10`, `.add`, `Community 44`, `RecordHistory.tsx`, `Community 50`, `RecordHistoryService`, `tw-animate-css`, `Community 26`, `PeopleRepository`, `AddPersonDialog.tsx`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `react-dom`, `Community 34`, `CreateRiskDto`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 9`, `Community 10`, `.add`, `Community 44`, `RecordHistory.tsx`, `Community 50`, `RecordHistoryService`, `tw-animate-css`, `Community 26`, `PeopleRepository`, `AddPersonDialog.tsx`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
