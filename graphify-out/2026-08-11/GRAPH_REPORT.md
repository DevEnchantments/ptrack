...
## Corpus Check
- 248 files · ~108,011 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2020 nodes · 4314 edges · 104 communities (90 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5c46b64`
...
1. `toHttpException()` - 120 edges
2. `AuthUser` - 67 edges
3. `CurrentUser` - 67 edges
4. `DatabaseService` - 51 edges
...
Cohesion: 0.14
Nodes (19): EditProjectDialog(), FY_YEARS, personFromProfile(), Props, categoriesApi, Project, projectsApi, sectorsApi (+11 more)
...
Cohesion: 0.13
Nodes (13): AuthUser, CurrentUser, Delete, ApiBody, Body, Post, Delete, Get (+5 more)
...
Cohesion: 0.06
Nodes (44): Props, Props, Props, fmtAed(), ProjectOverviewCards(), Props, Issue, issuesApi (+36 more)
...
Cohesion: 0.18
Nodes (24): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, Props, CategorySelect(), Props (+16 more)
...
Cohesion: 0.15
Nodes (14): AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, NotificationBell(), timeAgo() (+6 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.08
Nodes (36): Props, CommandPalette(), Entry, hitPath(), KIND_META, Props, ActionItemOwner, AdminLookupRow (+28 more)
...
Cohesion: 0.13
Nodes (5): toHttpException(), MilestonesRepository, Injectable, SubmissionsRepository, Injectable
...
Cohesion: 0.13
Nodes (18): AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, FieldError(), Textarea(), personName(), Props (+10 more)
...
Cohesion: 0.22
Nodes (12): App(), Chip(), AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage(), DashboardPage() (+4 more)
...
Cohesion: 0.09
Nodes (22): logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem, AppNotification (+14 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.09
Nodes (29): Props, Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, Props, ConfirmDeleteButton() (+21 more)

### Community 76 - ".add"
Cohesion: 0.18
Nodes (14): Props, TagChips(), GlobalActionItem, ActionItemsPage(), isOverdue(), ownerNames(), STATUS_LABELS, HomePage() (+6 more)
...
Cohesion: 0.27
Nodes (5): DatabaseModule, Module, LookupsModule, Module, Global
...
Cohesion: 0.19
Nodes (10): colorOf(), InitialsAvatar(), initialsOf(), PALETTE, GlobalMilestone, registryApi, isOverdue(), MilestonesPage() (+2 more)
...
## Knowledge Gaps
- **425 isolated node(s):** `GlobalMilestone`, `GlobalActionItem`, `DirectoryMembership`, `DirectoryPerson`, `MemberRow` (+420 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `.add`, `.add`, `DatabaseService`, `RecordHistory.tsx`, `AddActionItemDialog.tsx`, `undici`, `@supabase/supabase-js`, `lookups.service.ts`, `RecordHistory.tsx`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `.add`, `Community 1`, `Community 34`, `CreateRiskDto`, `status-reports.repository.ts`, `Community 7`, `.add`, `Community 10`, `Community 44`, `CreateProjectDto`, `RecordHistoryService`, `PeopleRepository`, `RecordHistory.tsx`, `ProjectsController`, `Community 26`, `@types/node`, `auth-context.tsx`, `AddPersonDialog.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `.add`, `Community 1`, `Community 34`, `CreateRiskDto`, `status-reports.repository.ts`, `Community 7`, `.add`, `Community 10`, `Community 44`, `CreateProjectDto`, `RecordHistoryService`, `PeopleRepository`, `RecordHistory.tsx`, `ProjectsController`, `Community 26`, `@types/node`, `auth-context.tsx`, `AddPersonDialog.tsx`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
