...
Cohesion: 0.12
Nodes (24): EditProjectDialog(), FY_YEARS, personFromProfile(), PersonAutocomplete(), Props, categoriesApi, Project, projectsApi (+16 more)
...
Cohesion: 0.13
Nodes (12): AuthUser, CurrentUser, Delete, Delete, Get, Param, Post, Delete (+4 more)
...
Cohesion: 0.24
Nodes (26): FREQUENCIES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props, ConfirmDeleteButton(), Props (+18 more)
...
Cohesion: 0.05
Nodes (56): Props, Props, Props, Props, AddStatusReportDialog(), Props, today(), Props (+48 more)
...
Cohesion: 0.16
Nodes (17): App(), Chip(), registryApi, AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage() (+9 more)
...
Cohesion: 0.43
Nodes (6): COLUMNS, ProjectsGrid(), ProjectListItem, GridSort, GridSortKey, gridSortValue()
...
## Knowledge Gaps
- **425 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+420 more)
