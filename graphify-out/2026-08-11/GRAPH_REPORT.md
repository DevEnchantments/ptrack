...
Cohesion: 0.13
Nodes (22): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, PersonAutocomplete(), Props, Lookup (+14 more)
...
Cohesion: 0.14
Nodes (26): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), Input(), SelectContent(), SelectItem() (+18 more)
...
Cohesion: 0.06
Nodes (41): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), EditOutcomeDialog(), NavSection, Props (+33 more)
...
Cohesion: 0.19
Nodes (24): Props, Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, Props, ConfirmDeleteButton() (+16 more)
...
Cohesion: 0.12
Nodes (20): Props, initials(), Props, RecordHistory(), relativeTime(), TABLE_NOUNS, username(), ActionItem (+12 more)
...
Cohesion: 0.06
Nodes (46): Props, CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell(), timeAgo() (+38 more)
...
Cohesion: 0.14
Nodes (22): App(), GlobalActionItem, GlobalMilestone, registryApi, AuthProvider(), usePageTitle(), ActionItemsPage(), isOverdue() (+14 more)
...
Cohesion: 0.06
Nodes (32): AuthedRequest, logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+24 more)
...
Cohesion: 0.36
Nodes (6): Attachment, AttachmentDetail, AttachmentListItem, StatusReport, StatusReportDetail, StatusReportListItem

### Community 89 - "ProjectsGrid.tsx"
Cohesion: 0.30
Nodes (5): DatabaseModule, Module, KpisModule, Module, Global
...
## Knowledge Gaps
- **424 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+419 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `.add`, `DatabaseService`, `RecordHistory.tsx`, `AddActionItemDialog.tsx`, `undici`, `@supabase/supabase-js`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `ProjectsController`, `.update`, `PeopleRepository`, `auth-context.tsx`, `.add`, `react-dom`, `CreateRiskDto`, `.add`, `RecordHistory.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `ProjectsController`, `.update`, `PeopleRepository`, `auth-context.tsx`, `.add`, `react-dom`, `CreateRiskDto`, `.add`, `RecordHistory.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
