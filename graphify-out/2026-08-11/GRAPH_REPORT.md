...
Cohesion: 0.11
Nodes (35): CategorySelect(), Props, EditProjectDialog(), personFromProfile(), Props, PersonAutocomplete(), Props, SelectContent() (+27 more)
...
Cohesion: 0.04
Nodes (68): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), Props, AddLinkDialog(), AddResourceDialog(), AddRiskDialog(), emptyPerson() (+60 more)
...
Cohesion: 0.22
Nodes (23): FREQUENCIES, ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton() (+15 more)
...
Cohesion: 0.10
Nodes (24): dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, initials(), Props, RecordHistory() (+16 more)
...
Cohesion: 0.05
Nodes (58): Props, Props, Props, Props, AddStatusReportDialog(), Props, today(), Props (+50 more)
...
Cohesion: 0.13
Nodes (21): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), Props, STATUSES, today() (+13 more)

### Community 68 - "RecordHistoryService"
Cohesion: 0.07
Nodes (40): App(), AppLayout(), NAV_ITEMS, ProtectedRoute(), Chip(), attachmentsApi, CycleStatusReport, DirectoryPerson (+32 more)
...
Cohesion: 0.40
Nodes (4): ChildRow, SavedSearch, SearchHit, SearchKind
...
Cohesion: 0.16
Nodes (19): COLUMNS, ProjectsGrid(), StatusPill(), TONE_CLASSES, toneFor(), ProjectListItem, buildCsv(), downloadCsv() (+11 more)
...
Cohesion: 0.13
Nodes (13): logger, Kpi, KpiActionPlan, KpiListItem, KpiReading, ACCESS_LEVELS, AdminLookupRow, AdminLookupTable (+5 more)

## Knowledge Gaps
- **418 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+413 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreatePersonDto`, `.add`, `WorkflowPanel.tsx`, `ActionItemsController`, `RecordHistory.tsx`, `undici`, `kpis.repository.ts`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `@nestjs/swagger` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 12`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `CreateRiskDto`, `nest-cli.json`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `nest-cli.json`, `react-dom`, `Community 1`, `Community 34`, `CreateRiskDto`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `@nestjs/swagger`, `ProjectsController`, `.update`, `Community 26`, `PeopleRepository`, `auth-context.tsx`?**
