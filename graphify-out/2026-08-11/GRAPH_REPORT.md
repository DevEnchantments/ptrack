...
## Summary
- 2033 nodes · 4499 edges · 100 communities (87 shown, 13 thin omitted)
...
Cohesion: 0.15
Nodes (11): AuthUser, CurrentUser, Get, Param, Post, Delete, Delete, Delete (+3 more)
...
Cohesion: 0.13
Nodes (27): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), Input(), SelectContent(), SelectItem() (+19 more)
...
Cohesion: 0.21
Nodes (10): AddStatusReportDialog(), today(), Props, SectionCard(), Skeleton(), statusReportsApi, ACCESS_LABELS, authorName() (+2 more)
...
Cohesion: 0.11
Nodes (21): App(), AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today() (+13 more)
...
Cohesion: 0.05
Nodes (58): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+50 more)
...
Cohesion: 0.09
Nodes (17): RecordHistoryService, Injectable, CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsDateString, IsIn (+9 more)
...
Cohesion: 0.13
Nodes (22): ProtectedRoute(), attachmentsApi, DirectoryPerson, registryApi, usePageTitle(), CodeTablesPage(), labelFor(), AttachmentDetailPage() (+14 more)
...
Cohesion: 0.08
Nodes (21): AuthedRequest, logger, DatabaseService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, Issue (+13 more)
...
Cohesion: 0.12
Nodes (20): COLUMNS, ProjectsGrid(), StatusPill(), TONE_CLASSES, toneFor(), Props, TagChips(), GlobalActionItem (+12 more)
...
## Knowledge Gaps
- **429 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+424 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `.add`, `DatabaseService`, `.add`, `AddActionItemDialog.tsx`, `ProjectsGrid.tsx`, `@types/node`, `PeoplePage.tsx`, `lookups.service.ts`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 7`, `Community 10`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 47`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `CreateRiskDto`, `CreatePersonDto`, `@nestjs/config`, `.add`, `PeoplePage.tsx`?**
