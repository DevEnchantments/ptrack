...
## Summary
- 1931 nodes · 4192 edges · 109 communities (90 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e7bf7aba`
...
Cohesion: 0.12
Nodes (29): AddIssueDialog(), emptyPerson(), Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, ConfirmDeleteButton(), Props (+21 more)
...
Cohesion: 0.12
Nodes (23): EditProjectDialog(), personFromProfile(), Props, PersonAutocomplete(), Props, categoriesApi, ProjectDetail, sectorsApi (+15 more)
...
Cohesion: 0.10
Nodes (10): ProjectsController, Controller, Delete, Get, Param, Query, ProjectsRepository, Injectable (+2 more)
...
Cohesion: 0.14
Nodes (16): AddRiskDialog(), emptyPerson(), ProtectedRoute(), Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+8 more)
...
Cohesion: 0.06
Nodes (42): Props, Props, Props, Props, Props, Props, Props, personName() (+34 more)
...
Cohesion: 0.22
Nodes (9): calculatedProgress(), MilestoneProgressRow, plannedProgress(), NotificationsModule, Module, Project, ProjectDetail, ProjectListRow (+1 more)
...
Cohesion: 0.11
Nodes (9): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, AppNotification, Cycle, Submission (+1 more)
...
### Community 76 - ".add"
Cohesion: 0.20
Nodes (24): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), CategorySelect(), Props, Input(), Label() (+16 more)

### Community 78 - "WorkflowPanel.tsx"
Cohesion: 0.15
Nodes (16): AddStatusReportDialog(), Props, today(), Chip(), CycleStatusReport, reportsApi, StatusReport, StatusReportDetail (+8 more)
...
Cohesion: 0.13
Nodes (21): ACTIONS, Entry, Props, COLUMNS, ProjectsGrid(), Project, ProjectListItem, projectsApi (+13 more)
...
## Knowledge Gaps
- **406 isolated node(s):** `What this project is`, `Tech stack`, `Hard architectural rules (do not violate)`, `Repo & environment`, `Current state — Phase 1 complete (full CRUD)` (+401 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 27`, `Community 34`, `status-reports.repository.ts`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `react-dom`, `.add`, `DatabaseService`, `kpis.repository.ts`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `@nestjs/swagger` to `Community 1`, `Community 7`, `Community 8`, `Community 10`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `RecordHistoryService`, `ProjectsController`, `.update`, `PeopleRepository`, `CreateRiskDto`, `.add`, `ActionItemsController`, `nest-cli.json`, `RisksModule`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 34`, `Community 26`, `CreateRiskDto`, `CreatePersonDto`, `Community 7`, `status-reports.repository.ts`, `.add`, `Community 10`, `nest-cli.json`, `RecordHistoryService`, `skeleton.tsx`, `@nestjs/swagger`, `ProjectsController`, `.update`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`?**
