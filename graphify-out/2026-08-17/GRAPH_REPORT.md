...
## Corpus Check
- 299 files · ~137,545 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2316 nodes · 5090 edges · 119 communities (98 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40c78e60`
...
Cohesion: 0.11
Nodes (9): HistoryInsert, ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository, Injectable, ActionItemsService, ownersLabel() (+1 more)
...
Cohesion: 0.06
Nodes (21): RecordHistoryService, Injectable, Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, AttachmentsRepository (+13 more)
...
Cohesion: 0.06
Nodes (43): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), personName() (+35 more)
...
Cohesion: 0.13
Nodes (18): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), DashboardController, Controller, Get, DashboardModule (+10 more)
...
Cohesion: 0.10
Nodes (20): App(), AddIssueDialog(), emptyPerson(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), today() (+12 more)
...
Cohesion: 0.08
Nodes (40): GlobalActionItem, GlobalMilestone, projectsApi, registryApi, reportsApi, usePageTitle(), ActionItemsPage(), isOverdue() (+32 more)
...
Cohesion: 0.06
Nodes (39): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), Props, dateParts() (+31 more)
...
Cohesion: 0.11
Nodes (21): AuthUser, CurrentUser, Delete, ApiBody, Body, Post, NotificationsController, Controller (+13 more)
...
Cohesion: 0.07
Nodes (19): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseModule, Module, DatabaseService, Injectable, Kpi (+11 more)
...
### Community 65 - ".add"
Cohesion: 0.13
Nodes (10): MilestoneProgressRow, HistoryEntry, logger, toHttpException(), Project, ProjectDetail, ProjectListRow, ProjectListStats (+2 more)

### Community 66 - "react-dom"
Cohesion: 0.10
Nodes (21): ActionItemsModule, Module, Owners, CreateActionItemDto, ApiProperty, ApiPropertyOptional, ArrayMaxSize, IsArray (+13 more)
...
Cohesion: 0.11
Nodes (28): Props, SectionCard(), Button(), buttonVariants, Card(), CardAction(), CardContent(), CardDescription() (+20 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.19
Nodes (34): STATUSES, FREQUENCIES, STATUSES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props (+26 more)
...
Cohesion: 0.12
Nodes (12): ApiTags, AppModule, Module, bootstrap(), ProjectSectionsController, Controller, Get, Param (+4 more)
...
Cohesion: 0.08
Nodes (19): ApiBody, ImportModule, Module, MilestonesModule, Module, ProjectsController, Controller, Get (+11 more)
...
Cohesion: 0.18
Nodes (8): NotificationsModule, Module, ACTION_BODY, CyclesController, ReportsController, Controller, SubmissionsModule, Module

### Community 120 - "moduleFileExtensions"
Cohesion: 0.50
...
## Knowledge Gaps
- **467 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+462 more)
...
- **Why does `toHttpException()` connect `.add` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 34`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `CreateLinkDto`, `eslint-plugin-react-hooks`, `ApiProperty`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.297) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `RecordHistoryService`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `Community 6`, `Community 10`, `CreateProjectDto`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `action-items.repository.ts`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `CreateLinkDto`, `README.md`, `status-reports.repository.ts`, `eslint-plugin-react-hooks`, `eslint-plugin-prettier`, `ApiProperty`, `ts-node`, `ProgramOutcomesService`?**
