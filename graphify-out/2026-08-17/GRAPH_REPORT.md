...
## Summary
- 2472 nodes · 5899 edges · 126 communities (112 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7d2695c`
...
Cohesion: 0.10
Nodes (39): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), CategorySelect(), Props (+31 more)
...
Cohesion: 0.07
Nodes (16): HistoryEntry, HistoryInsert, toHttpException(), ActionItem, ActionItemComment, ActionItemListItem, Milestone, MilestoneListItem (+8 more)
...
Cohesion: 0.07
Nodes (37): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), dateParts() (+29 more)
...
Cohesion: 0.10
Nodes (17): AdminOnly(), MinAppRole(), ProjectScoped(), AccessLevel, LEVEL_LABEL, UpdateActionItemDto, CreateRiskDto, ApiProperty (+9 more)
...
Cohesion: 0.15
Nodes (16): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, PARENT_TABLES, PARENT_TYPES, parseParent() (+8 more)
...
Cohesion: 0.11
Nodes (34): Props, Props, Props, Props, Props, apiUpload(), Attachment, AttachmentDetail (+26 more)
...
Cohesion: 0.08
Nodes (20): AuthedRequest, logger, DatabaseService, Injectable, AppNotification, ProgramOutcome, DirectoryMembership, DirectoryPerson (+12 more)
...
Cohesion: 0.19
Nodes (14): Props, Props, fmtAed(), ProjectOverviewCards(), Props, Issue, Risk, atRiskSuggested() (+6 more)
...
### Community 73 - ".add"
Cohesion: 0.06
Nodes (31): AuthUser, CurrentUser, Delete, Patch, Delete, DashboardController, Controller, Get (+23 more)
...
Cohesion: 0.16
Nodes (35): FREQUENCIES, ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), AddStatusReportDialog(), EDITABLE_OPTIONS, today() (+27 more)

### Community 76 - ".add"
Cohesion: 0.15
Nodes (15): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), ProtectedRoute(), GlobalActionItem, AuthContext (+7 more)
...
Cohesion: 0.14
Nodes (16): AppLayout(), NAV_ITEMS, AccessLevel, AccessLevelValue, MEMBERSHIP_LEVEL, projectAccessLevel(), Me, atLeastRole() (+8 more)
...
Cohesion: 0.07
Nodes (45): Props, Skeleton(), Chip(), personName(), STATUS_CHIP, WorkflowPanel(), accessApi, AdminUser (+37 more)
...
- **Why does `toHttpException()` connect `Community 26` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 16`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `Community 50`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `AuthUser`, `eslint-plugin-react-hooks`, `RisksService`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.206) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `.add` to `Community 1`, `.update`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 44`, `Community 50`, `action-items.repository.ts`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `react-dom`, `@nestjs/config`, `README.md`, `AddMilestoneDialog.tsx`, `@nestjs/swagger`, `AppModule`, `eslint-plugin-react-hooks`?**
