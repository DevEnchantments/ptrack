...
## Summary
- 2463 nodes · 5887 edges · 133 communities (114 shown, 19 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a062f894`
...
Cohesion: 0.10
Nodes (11): ProjectAccessService, Injectable, DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow, RegistryService (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (48): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), AvatarCluster(), colorOf(), InitialsAvatar() (+40 more)
...
Cohesion: 0.16
Nodes (35): FREQUENCIES, STATUSES, ACCESS_LEVELS, CategorySelect(), Props, FY_YEARS, FieldError(), PersonAutocomplete() (+27 more)
...
Cohesion: 0.10
Nodes (6): HistoryEntry, toHttpException(), ProjectsRepository, Injectable, SubmissionsRepository, Injectable
...
Cohesion: 0.07
Nodes (37): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddMilestoneDialog() (+29 more)
...
Cohesion: 0.11
Nodes (15): AdminOnly(), MinAppRole(), ProjectScoped(), AttachmentsController, Controller, CreateProgramOutcomeDto, ApiProperty, ApiPropertyOptional (+7 more)
...
Cohesion: 0.06
Nodes (56): Props, formatSize(), Props, TaskAttachments(), Skeleton(), Chip(), STATUS_CHIP, GlobalMilestone (+48 more)
...
Cohesion: 0.06
Nodes (45): AccessLevel, APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS (+37 more)
...
Cohesion: 0.08
Nodes (21): AuthedRequest, logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+13 more)
...
### Community 73 - ".add"
Cohesion: 0.07
Nodes (18): AuthUser, Delete, Delete, DashboardController, Controller, Get, Delete, Delete (+10 more)

### Community 74 - "DatabaseService"
Cohesion: 0.18
Nodes (7): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, projectColumns()

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.19
Nodes (18): AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Props, HelpDot() (+10 more)
...
Cohesion: 0.20
Nodes (11): AppLayout(), NAV_ITEMS, AccessLevel, AccessLevelValue, MEMBERSHIP_LEVEL, projectAccessLevel(), Me, atLeastRole() (+3 more)
...
Cohesion: 0.14
Nodes (16): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ProtectedRoute() (+8 more)
...
### Community 147 - "Global"
Cohesion: 0.67
Nodes (3): AccessModule, Global, Module

## Knowledge Gaps
- **488 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+483 more)
...
- **Why does `toHttpException()` connect `Community 26` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 34`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `Community 47`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `eslint-plugin-react-hooks`, `RisksService`, `ApiProperty`, `action-items.repository.ts`, `ProgramOutcomesService`, `AdjustWeightsDto`, `attachments.repository.ts`?**
  _High betweenness centrality (0.207) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `.add` to `Community 1`, `.update`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 47`, `Community 50`, `action-items.repository.ts`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `WorkflowPanel.tsx`, `2. Core functional modules`, `README.md`, `AddMilestoneDialog.tsx`, `@nestjs/swagger`, `AppModule`, `AuthUser`, `eslint-plugin-react-hooks`, `ApiProperty`?**
