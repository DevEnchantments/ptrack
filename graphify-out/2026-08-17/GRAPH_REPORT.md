...
Cohesion: 0.07
Nodes (19): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseModule, Module, DatabaseService, Injectable, RecordHistoryService (+11 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (27): AuthUser, CurrentUser, Delete, ApiBody, Body, Delete, Param, Patch (+19 more)
...
Cohesion: 0.05
Nodes (68): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddLinkDialog(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), today() (+60 more)
...
Cohesion: 0.07
Nodes (29): App(), AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), today(), AddKpiDialog(), emptyPerson() (+21 more)
...
Cohesion: 0.06
Nodes (55): Props, SectionCard(), Skeleton(), Chip(), Props, STATUS_CHIP, Cycle, cyclesApi (+47 more)
...
Cohesion: 0.10
Nodes (19): NotificationsController, Controller, AppNotification, SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength (+11 more)
...
Cohesion: 0.07
Nodes (32): Props, AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts(), MiniCalendar() (+24 more)
...
Cohesion: 0.08
Nodes (35): AppModule, Module, bootstrap(), ActionItemsModule, Module, AttachmentsModule, Module, ImportModule (+27 more)
...
Cohesion: 0.12
Nodes (16): HistoryEntry, HistoryInsert, logger, ActionItem, ActionItemComment, ActionItemListItem, ACCESS_LEVELS, AdminLookupRow (+8 more)
...
## Knowledge Gaps
- **484 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+479 more)
...
- **Why does `toHttpException()` connect `Community 16` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `RecordHistoryService`, `.add`, `AddMilestoneDialog.tsx`, `transform`, `@nestjs/swagger`, `Get`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 5`, `Community 6`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `action-items.repository.ts`, `@types/node`, `auth-context.tsx`, `.add`, `.add`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`?**
