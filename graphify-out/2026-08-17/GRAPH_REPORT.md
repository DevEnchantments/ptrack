...
## Summary
- 2327 nodes · 5268 edges · 125 communities (110 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c910881`
...
Cohesion: 0.09
Nodes (17): AuthedRequest, logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+9 more)
...
Cohesion: 0.14
Nodes (25): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), SelectContent(), SelectTrigger(), categoriesApi (+17 more)
...
Cohesion: 0.10
Nodes (33): App(), GlobalActionItem, GlobalMilestone, registryApi, AuthProvider(), usePageTitle(), ActionItemsPage(), isOverdue() (+25 more)
...
Cohesion: 0.17
Nodes (13): SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, ACTION_BODY, SubmissionsController, ApiBody (+5 more)
...
Cohesion: 0.14
Nodes (15): AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, Props, TagChips(), ActionItemComment (+7 more)
...
Cohesion: 0.12
Nodes (17): initials(), Props, RecordHistory(), relativeTime(), TABLE_NOUNS, username(), Props, SectionCard() (+9 more)
...
Cohesion: 0.04
Nodes (60): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+52 more)
...
Cohesion: 0.09
Nodes (18): columnsFrom(), ColumnSpec, CreateLinkDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsOptional (+10 more)
...
### Community 65 - ".add"
Cohesion: 0.15
Nodes (6): toHttpException(), ProgramOutcome, ProgramOutcomesRepository, Injectable, Injectable, UsersService
...
Cohesion: 0.14
Nodes (22): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddMilestoneDialog() (+14 more)
...
Cohesion: 0.14
Nodes (21): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), DialogDescription() (+13 more)
...
## Knowledge Gaps
- **482 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+477 more)
...
- **Why does `toHttpException()` connect `.add` to `Community 1`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `react-dom`, `CreateLinkDto`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `transform`, `@nestjs/swagger`, `Get`, `updates.controller.ts`, `PaginationQueryDto`, `shadcn`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 5`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `.add`, `CreateLinkDto`, `.add`, `.add`, `WorkflowPanel.tsx`, `README.md`, `lookups.service.ts`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `CreateUpdateDto`, `PaginationQueryDto`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 5`, `Community 9`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `CreateLinkDto`, `.add`, `.add`, `WorkflowPanel.tsx`, `README.md`, `lookups.service.ts`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `CreateUpdateDto`, `PaginationQueryDto`?**
