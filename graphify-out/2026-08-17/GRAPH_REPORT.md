...
## Summary
- 2293 nodes · 5225 edges · 122 communities (106 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `616125ed`
...
Cohesion: 0.11
Nodes (11): HistoryEntry, HistoryInsert, toHttpException(), ActionItem, ActionItemComment, ActionItemListItem, ActionItemsRepository, Injectable (+3 more)
...
Cohesion: 0.12
Nodes (9): DatabaseService, Injectable, RecordHistoryService, Injectable, Milestone, MilestoneListItem, Cycle, Submission (+1 more)
...
- **Why does `toHttpException()` connect `Community 5` to `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `Community 44`, `Community 45`, `Community 47`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `@nestjs/swagger`, `status-reports.repository.ts`, `eslint-plugin-react-hooks`, `ApiProperty`, `ProgramOutcomesService`, `kpis.repository.ts`?**
  _High betweenness centrality (0.287) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `RecordHistoryService`?**
  _High betweenness centrality (0.238) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `action-items.repository.ts`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `CreateLinkDto`, `README.md`, `AddMilestoneDialog.tsx`, `transform`, `Get`, `eslint-plugin-react-hooks`, `ApiProperty`, `.add`, `ProgramOutcomesService`?**
