...
## Summary
- 2283 nodes · 5197 edges · 118 communities (100 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34dd9dbf`
...
Cohesion: 0.10
Nodes (24): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+16 more)
...
Cohesion: 0.12
Nodes (24): App(), registryApi, reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), CategoriesPage() (+16 more)
...
Cohesion: 0.09
Nodes (14): ApiBody, Body, Controller, Delete, Get, Param, Patch, Post (+6 more)
...
Cohesion: 0.12
Nodes (8): logger, toHttpException(), MilestonesRepository, Injectable, MilestonesService, Injectable, TemplatesService, Injectable
...
Cohesion: 0.04
Nodes (67): Props, Props, Props, Props, Props, Props, CommandPalette(), Entry (+59 more)
...
Cohesion: 0.29
Nodes (9): atRiskSuggested(), calculatedProgress(), MilestoneProgressRow, plannedProgress(), riskScore(), riskSeverityTone(), ms(), MILESTONE_LABELS (+1 more)

### Community 69 - "WorkflowPanel.tsx"
Cohesion: 0.09
Nodes (29): FromTemplateDialog(), COLUMNS, ProjectsGrid(), ProjectTree(), Props, TreeRow, importApi, ImportSummary (+21 more)
...
Cohesion: 0.13
Nodes (22): Props, Props, Props, Props, formatAed(), milestoneShares(), MONTHS, ProjectDashboardTab() (+14 more)
...
Cohesion: 0.07
Nodes (25): AuthedRequest, DatabaseService, Injectable, RecordHistoryService, Injectable, Issue, IssueListItem, Kpi (+17 more)
...
Cohesion: 0.11
Nodes (19): AuthUser, CurrentUser, Delete, Delete, Delete, NotificationsController, Controller, Get (+11 more)
...
- **Why does `toHttpException()` connect `Community 45` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 47`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `.add`, `@nestjs/swagger`, `status-reports.repository.ts`, `Get`, `eslint-plugin-react-hooks`, `ApiProperty`?**
  _High betweenness centrality (0.283) - this node is a cross-community bridge._
- **Why does `ms()` connect `RecordHistoryService` to `Community 16`?**
  _High betweenness centrality (0.233) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `status-reports.repository.ts` to `Community 1`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `README.md`, `AddMilestoneDialog.tsx`, `Get`, `tailwind-merge`, `ApiProperty`?**
