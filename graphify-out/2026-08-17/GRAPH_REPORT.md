...
## Corpus Check
- 295 files · ~137,128 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2293 nodes · 5194 edges · 131 communities (117 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7844a12`
...
Cohesion: 0.13
Nodes (7): toHttpException(), Patch, ActionItemsRepository, Injectable, ActionItemsService, ownersLabel(), Injectable
...
Cohesion: 0.20
Nodes (12): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), logger, ChartPoint, CLOSED_PROJECT, DashboardData (+4 more)
...
Cohesion: 0.31
Nodes (8): CurrentUser, Param, Post, SubmissionsController, ApiBody, Body, Param, Post
...
Cohesion: 0.11
Nodes (27): App(), Props, SectionCard(), Skeleton(), reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage() (+19 more)
...
Cohesion: 0.21
Nodes (11): CreateTemplateDto, InstantiateTemplateDto, ApiProperty, ApiPropertyOptional, IsDateString, IsOptional, IsString, IsUUID (+3 more)
...
Cohesion: 0.13
Nodes (18): Props, TagChips(), GlobalActionItem, GlobalMilestone, registryApi, ActionItemsPage(), isOverdue(), ownerNames() (+10 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (20): ArrayMinSize, AuthUser, Delete, ImportRowsDto, ApiProperty, ArrayMaxSize, IsArray, ImportController (+12 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.04
Nodes (65): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+57 more)
...
Cohesion: 0.11
Nodes (11): AuthedRequest, DatabaseModule, Module, DatabaseService, Injectable, RecordHistoryService, Injectable, Cycle (+3 more)
...
Cohesion: 0.13
Nodes (24): ActionItemsModule, Module, AttachmentsModule, Module, ImportModule, Module, IssuesModule, Module (+16 more)
...
Cohesion: 0.19
Nodes (7): AppModule, Module, bootstrap(), KpisModule, Module, Module, UsersModule

### Community 113 - "DashboardService"
Cohesion: 0.21
...
### Community 125 - "kpis.repository.ts"
Cohesion: 0.50
...
- **Why does `toHttpException()` connect `Community 5` to `Community 1`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `Community 34`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `Get`, `jose`, `eslint-plugin-react-hooks`, `ts-jest`, `ApiProperty`, `ProgramOutcomesService`, `kpis.repository.ts`?**
  _High betweenness centrality (0.257) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `RecordHistoryService`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 47` to `Community 1`, `Community 5`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `action-items.repository.ts`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `CreateLinkDto`, `README.md`, `AddMilestoneDialog.tsx`, `transform`, `status-reports.repository.ts`, `eslint-plugin-react-hooks`, `ProjectsController`, `ApiProperty`, `.add`, `ProgramOutcomesService`?**
