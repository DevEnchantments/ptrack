...
## Corpus Check
- 297 files · ~138,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2323 nodes · 5347 edges · 126 communities (110 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81772edf`
...
Cohesion: 0.12
Nodes (16): HistoryEntry, HistoryInsert, logger, toHttpException(), DatabaseService, Injectable, ActionItem, ActionItemComment (+8 more)
...
Cohesion: 0.07
Nodes (46): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddLinkDialog(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), today() (+38 more)
...
Cohesion: 0.11
Nodes (20): Props, Props, CategorySelect(), Props, HelpDot(), NotificationBell(), timeAgo(), formatSize() (+12 more)
...
Cohesion: 0.18
Nodes (14): Project, sectorsApi, emptyMember(), Props, StepAccess(), StepConfirmation(), Props, StepDetails() (+6 more)
...
Cohesion: 0.10
Nodes (29): App(), Props, SectionCard(), Skeleton(), reportsApi, AuthProvider(), usePageTitle(), CodeTablesPage() (+21 more)
...
Cohesion: 0.14
Nodes (16): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), today(), Props, MilestoneDetail, auditLine() (+8 more)
...
Cohesion: 0.19
Nodes (11): initials(), Props, RecordHistory(), TABLE_NOUNS, username(), HistoryEntry, formatDate(), initials() (+3 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.06
Nodes (42): Props, Props, CommandPalette(), Entry, hitPath(), KIND_META, Props, ActionItemOwner (+34 more)
...
Cohesion: 0.08
Nodes (25): 1. Ground rules (every session obeys these), 2026-08-13 — Phase 0a, frontend test runner (no skill; a port, not a design pass), 2026-08-13 — Phase 0b, characterization tests for the three pilot modules, 2026-08-13 — Phase 1a, `modules/links/` (the control case), 2026-08-13 — Phase 1b, `modules/projects/` (the complex case), 2026-08-13 — Phase 1c, `modules/action-items/` + the shared-helper promotion, 2026-08-13 — Phase 2a, `modules/program-outcomes/` (+ a bug fix), 2026-08-13 — Phase 7 first item, frontend `lib/` (+17 more)

### Community 55 - "action-items.repository.ts"
Cohesion: 0.15
Nodes (16): Props, Props, fmtAed(), ProjectOverviewCards(), Props, Chip(), Issue, Risk (+8 more)
...
Cohesion: 0.19
Nodes (15): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CreateAccountDialog(), Props, peopleApi (+7 more)
...
Cohesion: 0.10
Nodes (17): AddKpiDialog(), emptyPerson(), Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, Textarea() (+9 more)

### Community 69 - "WorkflowPanel.tsx"
Cohesion: 0.18
Nodes (11): AppLayout(), NAV_ITEMS, EditProjectDialog(), personFromProfile(), ProtectedRoute(), AuthContext, AuthContextValue, useAuth() (+3 more)
...
Cohesion: 0.09
Nodes (17): AuthUser, ActionItemsController, ApiBody, Body, Controller, Delete, Get, Param (+9 more)
...
Cohesion: 0.13
Nodes (23): FromTemplateDialog(), Props, Props, Button(), buttonVariants, Card(), CardAction(), CardContent() (+15 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.21
Nodes (29): STATUSES, FREQUENCIES, STATUSES, ConfirmDeleteButton(), Props, FY_YEARS, FieldError(), PersonAutocomplete() (+21 more)

### Community 76 - ".add"
Cohesion: 0.10
Nodes (11): columnsFrom(), ColumnSpec, COLUMN_SPEC, CREATE_DEFAULTS, Owners, ProgramOutcomesRepository, Injectable, COLUMN_SPEC (+3 more)
...
Cohesion: 0.15
Nodes (15): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), DashboardController, Controller, Get (+7 more)
...
Cohesion: 0.18
Nodes (12): DashboardModule, Module, NotificationsModule, Module, ReportsModule, Module, RisksModule, Module (+4 more)
...
Cohesion: 0.14
Nodes (17): CurrentUser, NotificationsController, Controller, Get, Param, Post, SubmissionActionDto, ApiPropertyOptional (+9 more)
...
Cohesion: 0.16
Nodes (11): importApi, ImportSummary, projectsApi, buildCsv(), downloadCsv(), escapeCell(), parseCsv(), FieldDef (+3 more)
...
Cohesion: 0.19
Nodes (12): Props, dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, StatusReport, StatusReportDetail (+4 more)
...
Cohesion: 0.18
Nodes (12): AdjustWeightsDto, ApiProperty, ApiPropertyOptional, IsArray, IsNumber, IsOptional, IsUUID, Min (+4 more)
...
## Knowledge Gaps
- **487 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+482 more)
...
- **Why does `toHttpException()` connect `Community 7` to `Community 1`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `PeopleRepository`, `auth-context.tsx`, `react-dom`, `2. Core functional modules`, `.add`, `WorkflowPanel.tsx`, `lookups.service.ts`, `AddMilestoneDialog.tsx`, `transform`, `@nestjs/swagger`, `Get`, `ProjectsGrid.tsx`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `@nestjs/config` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `.add`, `WorkflowPanel.tsx`, `DatabaseModule`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `ProjectProgressReportPage.tsx`, `RecordHistoryService`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `DatabaseModule` to `Community 1`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `CreateProjectDto`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `@nestjs/config`, `.add`, `WorkflowPanel.tsx`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `ProjectProgressReportPage.tsx`, `RecordHistoryService`?**
