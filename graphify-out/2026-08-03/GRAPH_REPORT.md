...
## Summary
- 1588 nodes · 3241 edges · 96 communities (76 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `50ae1e67`
...
1. `toHttpException()` - 75 edges
2. `AuthUser` - 45 edges
3. `CurrentUser` - 45 edges
...
Cohesion: 0.11
Nodes (17): logger, toHttpException(), LookupsController, Body, Controller, Get, Param, Post (+9 more)
...
Cohesion: 0.06
Nodes (44): Props, Props, Props, Props, Props, fmtAed(), ProjectOverviewCards(), Props (+36 more)
...
Cohesion: 0.20
Nodes (5): Project, ProjectDetail, ProjectListStats, ProjectsRepository, Injectable
...
Cohesion: 0.09
Nodes (32): AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry, Props (+24 more)
...
Cohesion: 0.15
Nodes (21): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, ActionItemOwner, apiDelete(), apiGet() (+13 more)
...
Cohesion: 0.10
Nodes (31): Props, Props, AddRiskDialog(), emptyPerson(), AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS (+23 more)
...
### Community 65 - ".add"
Cohesion: 0.22
Nodes (16): Props, CategorySelect(), Props, SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), Lookup (+8 more)
...
Cohesion: 0.18
Nodes (11): App(), ProtectedRoute(), KIND_CLASSES, TOAST_MS, Toaster(), ToastItem, AuthProvider(), subscribeToasts() (+3 more)
...
Cohesion: 0.15
Nodes (8): ProjectsController, ProjectsService, Injectable, Controller, Delete, Get, Param, Query
...
## Knowledge Gaps
- **356 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+351 more)
...
- **Why does `toHttpException()` connect `Community 12` to `Community 1`, `Community 2`, `Community 34`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 9`, `Community 10`, `ProjectOverviewCards.tsx`, `Community 13`, `Community 16`, `action-items.repository.ts`, `Community 26`, `PeopleRepository`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `@types/node` to `Community 1`, `Community 2`, `Community 34`, `Community 5`, `status-reports.repository.ts`, `Community 7`, `Community 10`, `tw-animate-css`, `nest-cli.json`, `nest-cli.json`, `RecordHistoryService`, `CreateProjectDto`, `Community 20`, `Community 26`, `PeopleRepository`, `AddMilestoneDialog.tsx`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 5`, `status-reports.repository.ts`, `Community 7`, `Community 10`, `Community 44`, `nest-cli.json`, `Community 16`, `@types/node`, `Community 26`, `Community 27`, `PeopleRepository`?**
