...
Cohesion: 0.07
Nodes (38): Props, Props, Props, Props, Props, Props, ACTIONS, CommandPalette() (+30 more)
...
Cohesion: 0.11
Nodes (21): Props, AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, initials(), Props (+13 more)
...
Cohesion: 0.13
Nodes (20): Props, SectionCard(), Button(), buttonVariants, Card(), CardAction(), CardContent(), CardDescription() (+12 more)
...
Cohesion: 0.12
Nodes (20): App(), AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ProtectedRoute(), KIND_CLASSES, TOAST_MS (+12 more)
...
Cohesion: 0.18
Nodes (32): STATUSES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props, ConfirmDeleteButton(), Props (+24 more)
...
Cohesion: 0.13
Nodes (19): Props, attachmentsApi, usersApi, UserSummary, emptyMember(), usePageTitle(), AttachmentDetailPage(), formatSize() (+11 more)
