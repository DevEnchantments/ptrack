...
## Corpus Check
- 203 files · ~83,736 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1638 nodes · 3547 edges · 85 communities (76 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4a1ddc10`
...
Cohesion: 0.18
Nodes (14): SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, SubmissionsController, ApiBody, Body (+6 more)
...
Cohesion: 0.26
Nodes (6): ActionItemsController, Controller, Delete, Get, Param, Patch
...
Cohesion: 0.11
Nodes (14): AuthUser, CurrentUser, ApiBody, Body, Post, Delete, Delete, Delete (+6 more)
...
Cohesion: 0.16
Nodes (12): calculatedProgress(), MilestoneProgressRow, plannedProgress(), Project, ProjectDetail, ProjectListStats, ProjectsRepository, Injectable (+4 more)
...
Cohesion: 0.11
Nodes (22): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AppLayout() (+14 more)
...
Cohesion: 0.11
Nodes (27): Props, Props, Props, Props, personName(), Props, STATUS_CHIP, WorkflowPanel() (+19 more)
...
Cohesion: 0.18
Nodes (13): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, PersonAutocomplete(), Props, Input() (+5 more)
...
Cohesion: 0.27
Nodes (7): logger, Attachment, AttachmentDetail, AttachmentListItem, Cycle, Submission, SubmissionListItem

### Community 59 - "@types/node"
Cohesion: 0.13
Nodes (29): Props, AddIssueDialog(), emptyPerson(), Props, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, Props, ConfirmDeleteButton() (+21 more)
...
### Community 65 - ".add"
Cohesion: 0.15
Nodes (27): Props, CategorySelect(), Props, SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), categoriesApi (+19 more)
...
Cohesion: 0.17
Nodes (7): DatabaseModule, Module, DatabaseService, Injectable, RecordHistoryService, Injectable, Global
...
Cohesion: 0.47
Nodes (5): AddRiskDialog(), emptyPerson(), Props, Risk, risksApi
...
Cohesion: 0.39
Nodes (7): HomePage(), initials(), prefersReducedMotion(), relativeTime(), ROWS_OPTIONS, SORTS, useEntranceFlag()
...
## Knowledge Gaps
- **359 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+354 more)
...
- **Why does `toHttpException()` connect `ProjectsController` to `Community 1`, `Community 2`, `Community 34`, `ProjectsRepository`, `Community 26`, `Community 6`, `Community 7`, `Community 5`, `status-reports.repository.ts`, `Community 10`, `Community 9`, `Community 44`, `Community 13`, `Community 12`, `action-items.repository.ts`, `@nestjs/swagger`, `PeopleRepository`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `react-dom`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 44`, `nest-cli.json`, `Community 16`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `react-dom`, `Community 5`, `Community 6`, `Community 7`, `status-reports.repository.ts`, `Community 10`, `Community 44`, `nest-cli.json`, `Community 16`, `Community 26`, `Community 27`, `PeopleRepository`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
