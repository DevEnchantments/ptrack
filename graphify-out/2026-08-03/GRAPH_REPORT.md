...
## Summary
- 1533 nodes · 3096 edges · 85 communities (68 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e381fde3`
...
Cohesion: 0.09
Nodes (29): Props, Props, Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost() (+21 more)
...
Cohesion: 0.12
Nodes (25): ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES, fileExt(), formatReportDate(), formatSize(), initials() (+17 more)
...
Cohesion: 0.11
Nodes (18): AuthUser, CurrentUser, ActionItemsController, ApiBody, Body, Controller, Delete, Get (+10 more)
...
Cohesion: 0.17
Nodes (13): ACTIONS, CommandPalette(), Entry, Props, EditProjectDialog(), personFromProfile(), Props, categoriesApi (+5 more)
...
Cohesion: 0.07
Nodes (76): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+68 more)
...
### Community 65 - ".update"
Cohesion: 0.20
Nodes (6): Props, Props, Props, ActionItem, Issue, Risk
...
Cohesion: 0.14
Nodes (7): AuthedRequest, DatabaseService, Injectable, Link, LinkListItem, Resource, ResourceListItem

### Community 69 - "nest-cli.json"
Cohesion: 0.67
Nodes (3): Props, Milestone, MilestoneDetail
...
## Knowledge Gaps
- **346 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+341 more)
...
- **Why does `AuthUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `CreateProjectDto`, `Community 34`, `Community 6`, `Community 7`, `Community 26`, `Community 5`, `Community 10`, `status-reports.repository.ts`, `nest-cli.json`, `reflect-metadata`, `PeopleRepository`, `AttachmentDetailPage.tsx`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `Community 1`, `Community 2`, `nest-cli.json`, `CreateProjectDto`, `Community 34`, `Community 6`, `Community 7`, `Community 26`, `Community 5`, `Community 10`, `status-reports.repository.ts`, `nest-cli.json`, `reflect-metadata`, `PeopleRepository`, `AttachmentDetailPage.tsx`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `react-dom` to `Community 1`, `Community 2`, `RecordHistoryService`, `CreateProjectDto`, `Community 6`, `Community 7`, `Community 5`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 10`, `Community 12`, `@types/node`, `status-reports.repository.ts`, `Community 16`, `Community 26`, `PeopleRepository`?**
