...
## Corpus Check
- 175 files · ~69,257 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1427 nodes · 2968 edges · 76 communities (65 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7f57e5a9`
...
Cohesion: 0.14
Nodes (15): ArrayMaxSize, ActionItemsService, Owners, Injectable, CreateActionItemDto, ApiProperty, ApiPropertyOptional, IsArray (+7 more)
...
Cohesion: 0.18
Nodes (10): logger, toHttpException(), Issue, IssueListItem, Link, LinkListItem, Resource, ResourceListItem (+2 more)
...
Cohesion: 0.19
Nodes (16): StatusPill(), TONE_CLASSES, toneFor(), CardEditorial(), EDGE, CardLedger(), CardVitals(), prefersReducedMotion() (+8 more)
...
Cohesion: 0.12
Nodes (8): AuthedRequest, DatabaseService, Injectable, RecordHistoryService, Injectable, Attachment, AttachmentDetail, AttachmentListItem
...
Cohesion: 0.12
Nodes (18): App(), AddIssueDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette(), Entry (+10 more)
...
Cohesion: 0.06
Nodes (109): STATUSES, Props, Props, Props, AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName() (+101 more)
...
Cohesion: 0.18
Nodes (13): AddStatusReportDialog(), Props, today(), StatusReport, StatusReportDetail, statusReportsApi, usePageTitle(), HomePage() (+5 more)
...
## Knowledge Gaps
- **344 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+339 more)
...
- **Why does `toHttpException()` connect `Community 27` to `Community 1`, `Community 2`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `CreateProjectDto`, `CreateProjectDto`, `nest-cli.json`, `status-reports.repository.ts`, `@types/node`, `.update`, `PeopleRepository`, `.update`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 20` to `nest-cli.json`, `Community 2`, `Community 1`, `.update`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `status-reports.repository.ts`, `CreateProjectDto`, `PeopleRepository`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 20` to `nest-cli.json`, `Community 2`, `Community 1`, `.update`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `status-reports.repository.ts`, `CreateProjectDto`, `PeopleRepository`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
