...
## Summary
- 1237 nodes · 2473 edges · 63 communities (55 shown, 8 thin omitted)
...
Cohesion: 0.15
Nodes (14): AuthUser, CurrentUser, ApiBody, Body, Patch, Post, PeopleController, ApiBody (+6 more)
...
Cohesion: 0.05
Nodes (48): App(), dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, ProtectedRoute(), initials() (+40 more)
...
Cohesion: 0.14
Nodes (20): AddUpdateDialog(), EditProjectDialog(), ACTIONS, attachmentUploader(), EXT_STYLES, fileExt(), formatReportDate(), formatSize() (+12 more)
...
Cohesion: 0.10
Nodes (29): AddAttachmentDialog(), Props, AddLinkDialog(), Props, AddResourceDialog(), Props, AddStatusReportDialog(), EDITABLE_OPTIONS (+21 more)
...
Cohesion: 0.27
Nodes (15): Props, CategorySelect(), Props, Props, Input(), SelectContent(), SelectItem(), SelectTrigger() (+7 more)
...
Cohesion: 0.27
Nodes (9): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, DialogHeader(), peopleApi, ProjectMemberDetail (+1 more)
...
Cohesion: 0.05
Nodes (41): ArrayMaxSize, HistoryEntry, HistoryInsert, logger, toHttpException(), ActionItemsController, ApiBody, Body (+33 more)
...
Cohesion: 0.15
Nodes (16): AddIssueDialog(), emptyPerson(), Props, Props, ActionItemOwner, Issue, issuesApi, projectsApi (+8 more)
...
Cohesion: 0.17
Nodes (15): PersonAutocomplete(), Props, Props, StepAccess(), StepConfirmation(), Props, StepDetails(), Props (+7 more)
...
## Knowledge Gaps
- **273 isolated node(s):** `$schema`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)`, `Bash(npm run build:*)` (+268 more)
...
- **Why does `toHttpException()` connect `CreateActionItemDto` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `status-reports.repository.ts`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 16`, `PeopleRepository`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 6` to `CreateActionItemDto`, `Community 1`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `@base-ui/react`, `Community 10`, `Community 16`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 6` to `CreateActionItemDto`, `Community 1`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `@base-ui/react`, `Community 10`, `Community 16`?**
