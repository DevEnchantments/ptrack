...
## Summary
- 2479 nodes · 5935 edges · 131 communities (115 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d2435958`
...
Cohesion: 0.05
Nodes (51): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), AvatarCluster(), colorOf(), InitialsAvatar() (+43 more)
...
Cohesion: 0.10
Nodes (41): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), ACCESS_LEVELS, AddPersonDialog() (+33 more)
...
Cohesion: 0.10
Nodes (14): AdminOnly(), MinAppRole(), ProjectScoped(), PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max (+6 more)
...
Cohesion: 0.09
Nodes (16): MilestoneProgressRow, Project, ProjectDetail, ProjectListRow, ProjectListStats, ProjectsRepository, Injectable, COLUMN_SPEC (+8 more)
...
Cohesion: 0.13
Nodes (14): IssuesModule, Module, LinksModule, Module, ProgramOutcomesModule, Module, ProjectSectionsModule, Module (+6 more)
...
Cohesion: 0.08
Nodes (13): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, Issue, IssueListItem, IssuesRepository (+5 more)
...
Cohesion: 0.18
Nodes (16): AppRole, CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES, GrantableRole, isCapability() (+8 more)
...
Cohesion: 0.15
Nodes (18): Props, Props, Props, fmtAed(), ProjectOverviewCards(), Props, Project, ProjectDetail (+10 more)

### Community 69 - "WorkflowPanel.tsx"
Cohesion: 0.08
Nodes (13): toHttpException(), SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, Cycle, Submission (+5 more)
...
### Community 73 - ".add"
Cohesion: 0.09
Nodes (19): AuthUser, CurrentUser, Delete, DashboardController, Controller, Get, NotificationsController, Controller (+11 more)
...
Cohesion: 0.20
Nodes (25): AddIssueDialog(), emptyPerson(), FREQUENCIES, AddRiskDialog(), emptyPerson(), EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton() (+17 more)

### Community 76 - ".add"
Cohesion: 0.11
Nodes (20): AppLayout(), NAV_ITEMS, NotificationBell(), timeAgo(), AppNotification, Cycle, CycleStatusReport, CycleStatusRow (+12 more)
...
Cohesion: 0.15
Nodes (12): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, Owners, COLUMN_SPEC (+4 more)
...
Cohesion: 0.08
Nodes (19): APP_ROLES, isAppRole(), AccessAdminController, ApiBody, Body, Controller, Get, Param (+11 more)
...
Cohesion: 0.17
Nodes (4): IssuesService, Injectable, ProjectSectionsService, Injectable
...
Cohesion: 0.09
Nodes (39): Props, Props, Props, Props, Props, Props, Props, apiUpload() (+31 more)
...
Cohesion: 0.06
Nodes (50): App(), ProtectedRoute(), Props, Skeleton(), Chip(), personName(), STATUS_CHIP, WorkflowPanel() (+42 more)
...
Cohesion: 0.09
Nodes (19): AccessLevel, atLeastRole(), defaultLevelFor(), ProjectAccessInput, resolveProjectLevel(), base, LEVEL_LABEL, ProjectAccessGuard (+11 more)

### Community 133 - ".update"
Cohesion: 0.15
Nodes (12): ProjectAccess(), Post, ProjectsController, ApiBody, Body, Controller, Delete, Get (+4 more)
...
## Knowledge Gaps
- **497 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+492 more)
...
- **Why does `toHttpException()` connect `WorkflowPanel.tsx` to `Community 1`, `Injectable`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 34`, `CreateProjectDto`, `Community 44`, `Community 45`, `Community 50`, `ProjectsController`, `PeopleRepository`, `auth-context.tsx`, `PaginationQueryDto`, `react-dom`, `.add`, `AddMilestoneDialog.tsx`, `@nestjs/swagger`, `status-reports.repository.ts`, `AuthUser`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `RisksService`, `submissions.module.ts`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.212) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `.add` to `Community 1`, `Injectable`, `.update`, `Community 6`, `Community 7`, `Community 10`, `Community 13`, `CreateProjectDto`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `status-reports.repository.ts`, `Community 50`, `action-items.repository.ts`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `react-dom`, `2. Core functional modules`, `WorkflowPanel.tsx`, `README.md`, `@nestjs/swagger`, `AppModule`, `eslint-plugin-react-hooks`?**
