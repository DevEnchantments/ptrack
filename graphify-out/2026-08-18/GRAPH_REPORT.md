...
## Summary
- 2528 nodes · 6096 edges · 127 communities (111 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c96a1ed`
...
Cohesion: 0.12
Nodes (6): LinksRepository, Injectable, LinksService, Injectable, ProjectSectionsService, Injectable
...
Cohesion: 0.09
Nodes (23): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), DashboardController, Controller, DashboardModule, Module (+15 more)
...
Cohesion: 0.11
Nodes (14): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, Owners, Link (+6 more)
...
Cohesion: 0.08
Nodes (36): Props, Skeleton(), Chip(), personName(), STATUS_CHIP, WorkflowPanel(), accessApi, AdminUser (+28 more)
...
Cohesion: 0.07
Nodes (21): CurrentUser, Delete, Get, NotificationsController, Controller, Get, Param, Post (+13 more)
...
Cohesion: 0.17
Nodes (6): logger, toHttpException(), RegistryService, Injectable, Get, Query
...
### Community 73 - ".add"
Cohesion: 0.15
Nodes (7): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AuthUser, Post, @nestjs/swagger
...
Cohesion: 0.11
Nodes (11): ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, Query, PendingMembershipRow (+3 more)

### Community 85 - "@nestjs/swagger"
Cohesion: 0.24
Nodes (14): APP_ROLES, AppRole, CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES, GrantableRole (+6 more)
...
Cohesion: 0.06
Nodes (37): Props, CommandPalette(), Entry, hitPath(), KIND_META, Props, AdminLookupRow, adminLookupsApi (+29 more)
...
Cohesion: 0.33
Nodes (5): DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone, MemberRow
...
## Knowledge Gaps
- **511 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+506 more)
...
- **Why does `AuthUser` connect `.add` to `Injectable`, `.update`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `CreateLinkDto`, `README.md`, `users.service.ts`, `@nestjs/swagger`, `ActionItemsController`, `CreateRiskDto`, `ProjectsController`, `app.module.ts`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `CreateLinkDto` to `Community 1`, `Injectable`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 27`, `ProjectsRepository`, `CreateProjectDto`, `Community 44`, `Community 45`, `ProjectsController`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `.add`, `AddMilestoneDialog.tsx`, `users.service.ts`, `@nestjs/swagger`, `AuthUser`, `CreateRiskDto`, `project-sections.service.ts`, `project-sections.service.ts`?**
