...
## Corpus Check
- 336 files · ~152,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2519 nodes · 6085 edges · 135 communities (119 shown, 16 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81afab30`
...
Cohesion: 0.13
Nodes (7): logger, toHttpException(), RegistryService, Injectable, Query, Injectable, UsersService
...
Cohesion: 0.07
Nodes (36): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddMilestoneDialog() (+28 more)
...
Cohesion: 0.07
Nodes (47): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), EditProjectDialog(), personFromProfile(), ExportCsvDialog() (+39 more)
...
Cohesion: 0.09
Nodes (15): ProjectAccessRow, AuthedRequest, DatabaseService, Injectable, DirectoryMembership, DirectoryPerson, GlobalActionItem, GlobalMilestone (+7 more)
...
Cohesion: 0.07
Nodes (26): AuthUser, CurrentUser, Delete, Patch, Delete, Get, Delete, Delete (+18 more)
...
Cohesion: 0.11
Nodes (23): Props, SectionCard(), formatSize(), Props, TaskAttachments(), Button(), buttonVariants, Skeleton() (+15 more)
...
### Community 73 - ".add"
Cohesion: 0.14
Nodes (9): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, LEVEL_LABEL, UpdateActionItemDto, ACTION_BODY (+1 more)
...
Cohesion: 0.19
Nodes (33): FREQUENCIES, STATUSES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props, ConfirmDeleteButton() (+25 more)
...
Cohesion: 0.14
Nodes (13): NotificationBell(), timeAgo(), Props, AppNotification, Cycle, CycleStatusRow, dashboardApi, DashboardChartPoint (+5 more)
...
Cohesion: 0.11
Nodes (22): AppLayout(), NAV_ITEMS, FromTemplateDialog(), usersApi, atLeastRole(), fetchMe(), listeners, RANK (+14 more)
...
Cohesion: 0.22
Nodes (16): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, CAPABILITY_KEYS, DEFAULT_GRANTS, GRANTABLE_ROLES (+8 more)
...
Cohesion: 0.06
Nodes (36): AddKpiDialog(), emptyPerson(), Props, accessApi, AdminLookupRow, adminLookupsApi, AdminLookupTable, AdminUser (+28 more)
...
### Community 120 - "DashboardService"
Cohesion: 0.25
Nodes (6): DashboardController, Controller, DashboardModule, Module, DashboardService, Injectable

### Community 122 - "CommandPalette.tsx"
Cohesion: 0.40
Nodes (5): CommandPalette(), Entry, hitPath(), KIND_META, Props
...
### Community 125 - "moduleFileExtensions"
Cohesion: 0.50
Nodes (4): moduleFileExtensions, js, json, ts

### Community 126 - "status-reports.repository.ts"
Cohesion: 0.83
...
## Knowledge Gaps
- **509 isolated node(s):** `Props`, `Entry`, `KIND_META`, `$schema`, `includeCoAuthoredBy` (+504 more)
...
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 45`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `.add`, `README.md`, `users.service.ts`, `@nestjs/swagger`, `ActionItemsController`, `CreateRiskDto`, `app.module.ts`, `ts-loader`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `auth-context.tsx` to `.update`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `Community 44`, `Community 45`, `Community 50`, `@types/node`, `PeopleRepository`, `CreateMilestoneDto`, `.add`, `README.md`, `@nestjs/swagger`, `ActionItemsController`, `CreateRiskDto`, `app.module.ts`, `ts-loader`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **What connects `Props`, `Entry`, `KIND_META` to the rest of the system?**
