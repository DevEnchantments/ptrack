...
## Corpus Check
- 334 files · ~148,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2496 nodes · 6000 edges · 129 communities (115 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `773bed4c`
...
Cohesion: 0.12
Nodes (23): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddIssueDialog() (+15 more)
...
Cohesion: 0.06
Nodes (45): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), Props (+37 more)
...
Cohesion: 0.17
Nodes (14): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData, DashboardService (+6 more)
...
Cohesion: 0.12
Nodes (21): dateParts(), MiniCalendar(), MONTHS, Props, WEEKDAY_HEADERS, ActionItemComment, statusReportsApi, cache (+13 more)
...
Cohesion: 0.15
Nodes (14): AdminOnly(), MinAppRole(), ProjectAccess(), ProjectScoped(), AccessLevel, LEVEL_LABEL, AuthUser, ApiBody (+6 more)
...
Cohesion: 0.15
Nodes (7): GRANTABLE_ROLES, isCapability(), AccessAdminController, Controller, Get, AccessAdminService, Injectable
...
Cohesion: 0.07
Nodes (20): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, AttachmentsRepository, PARENT_TABLES, Injectable (+12 more)
...
Cohesion: 0.20
Nodes (13): AppLayout(), NAV_ITEMS, NotificationBell(), timeAgo(), ProfileDialog(), AppNotification, notificationsApi, atLeastRole() (+5 more)
...
Cohesion: 0.07
Nodes (17): AuthedRequest, SupabaseAuthGuard, Injectable, logger, DatabaseService, Injectable, Issue, IssueListItem (+9 more)
...
Cohesion: 0.15
Nodes (21): APP_ROLES, AppRole, atLeastRole(), CAPABILITIES, Capability, DEFAULT_GRANTS, defaultLevelFor(), GrantableRole (+13 more)
...
Cohesion: 0.20
Nodes (12): fmtAed(), ProjectOverviewCards(), Chip(), atRiskSuggested(), calculatedProgress(), MilestoneProgressRow, plannedProgress(), riskScore() (+4 more)
...
### Community 73 - ".add"
Cohesion: 0.09
Nodes (16): CurrentUser, Delete, Delete, Delete, NotificationsController, Controller, Get, Param (+8 more)
...
Cohesion: 0.22
Nodes (21): AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Props, FieldError() (+13 more)

### Community 76 - ".add"
Cohesion: 0.13
Nodes (16): Skeleton(), Cycle, cyclesApi, CycleStatusReport, CycleStatusRow, dashboardApi, DashboardChartPoint, DashboardData (+8 more)
...
Cohesion: 0.12
Nodes (21): Props, TagChips(), Props, TasksCard(), GlobalActionItem, GlobalMilestone, registryApi, dueIn() (+13 more)
...
Cohesion: 0.14
Nodes (14): Textarea(), personName(), STATUS_CHIP, WorkflowPanel(), importApi, ImportSummary, projectsApi, FieldDef (+6 more)
...
Cohesion: 0.17
Nodes (15): AddKpiDialog(), emptyPerson(), FREQUENCIES, Props, PersonAutocomplete(), Props, Kpi, KpiReading (+7 more)

### Community 91 - "DatabaseModule"
Cohesion: 0.08
Nodes (26): CommandPalette(), Entry, hitPath(), KIND_META, Props, formatSize(), Props, TaskAttachments() (+18 more)
...
Cohesion: 0.09
Nodes (19): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, Owners, CreateActionItemDto (+11 more)
...
Cohesion: 0.24
Nodes (15): Props, apiUpload(), Attachment, AttachmentDetail, apiDelete(), apiGet(), apiPatch(), apiPost() (+7 more)
...
Cohesion: 0.13
Nodes (18): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, CreateAccountDialog(), AppRole, lookupCache (+10 more)
...
Cohesion: 0.12
Nodes (23): Props, Props, Props, Props, Props, Props, Props, Props (+15 more)
...
Cohesion: 0.15
Nodes (20): App(), AuthProvider(), usePageTitle(), CodeTablesPage(), labelFor(), UsersRolesPage(), AttachmentDetailPage(), formatSize() (+12 more)
...
Cohesion: 0.14
Nodes (6): ProjectAccessGuard, Injectable, ProjectAccessService, Injectable, RegistryService, Injectable
...
## Knowledge Gaps
- **499 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+494 more)
...
- **Why does `fetchMe()` connect `status-reports.repository.ts` to `status-reports.repository.ts`?**
  _High betweenness centrality (0.241) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `ProjectsRepository` to `Community 1`, `.update`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `auth-context.tsx`, `react-dom`, `WorkflowPanel.tsx`, `.add`, `DatabaseService`, `WorkflowPanel.tsx`, `README.md`, `@nestjs/swagger`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`, `supabase.ts`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `.add` to `Community 1`, `.update`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `WorkflowPanel.tsx`, `DatabaseService`, `WorkflowPanel.tsx`, `README.md`, `@nestjs/swagger`, `CreateRiskDto`, `eslint-plugin-react-hooks`, `ProjectsController`, `supabase.ts`, `ProgramOutcomesService`?**
