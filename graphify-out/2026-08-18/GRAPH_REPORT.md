...
## Corpus Check
- 330 files · ~147,156 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2481 nodes · 5775 edges · 132 communities (112 shown, 20 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fd50272`
...
- `AppLayout()` --calls--> `useMe()`  [EXTRACTED]
  frontend/src/components/AppLayout.tsx → frontend/src/lib/use-me.ts
...
Cohesion: 0.08
Nodes (21): ApiBody, ProvisionUserDto, ApiProperty, IsEmail, IsString, MaxLength, MinLength, UsersController (+13 more)
...
Cohesion: 0.29
Nodes (3): ActionItemsService, normalizeOwnerIds(), Injectable
...
Cohesion: 0.06
Nodes (27): ApiTags, ProjectSectionsController, Controller, Get, Param, ProjectSectionsService, Injectable, CreateResourceDto (+19 more)
...
Cohesion: 0.09
Nodes (33): fetchMe(), hasCapability(), RANK, useMe(), ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES (+25 more)
...
Cohesion: 0.19
Nodes (13): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData, DashboardService (+5 more)
...
Cohesion: 0.09
Nodes (15): MilestoneProgressRow, Delete, Get, Param, Project, ProjectDetail, ProjectListRow, ProjectListStats (+7 more)
...
Cohesion: 0.18
Nodes (10): ProjectScoped(), StatusReportsController, ApiBody, Body, Controller, Delete, Get, Param (+2 more)
...
Cohesion: 0.25
Nodes (17): Props, Props, apiUpload(), Attachment, AttachmentDetail, apiDelete(), apiGet(), apiPatch() (+9 more)
...
Cohesion: 0.06
Nodes (24): AuthedRequest, SupabaseAuthGuard, Injectable, logger, DatabaseService, Injectable, Issue, IssueListItem (+16 more)
...
Cohesion: 0.09
Nodes (7): toHttpException(), ActionItemsRepository, Injectable, RegistryService, Injectable, SubmissionsRepository, Injectable
...
### Community 73 - ".add"
Cohesion: 0.07
Nodes (22): AdminOnly(), MinAppRole(), ProjectAccess(), AuthUser, CurrentUser, Delete, Delete, Delete (+14 more)
...
Cohesion: 0.15
Nodes (31): FREQUENCIES, ACCESS_LEVELS, Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton() (+23 more)

### Community 76 - ".add"
Cohesion: 0.11
Nodes (22): App(), AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today() (+14 more)
...
Cohesion: 0.12
Nodes (14): columnsFrom(), ColumnSpec, RecordHistoryService, Injectable, COLUMN_SPEC, CREATE_DEFAULTS, CreateStatusReportDto, ApiProperty (+6 more)

### Community 84 - "transform"
Cohesion: 0.17
Nodes (12): ImportSummary, buildCsv(), downloadCsv(), escapeCell(), parseCsv(), FieldDef, ImportPage(), MILESTONE_FIELDS (+4 more)
...
Cohesion: 0.05
Nodes (69): colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts(), MiniCalendar(), MONTHS, Props (+61 more)
...
Cohesion: 0.13
Nodes (12): AccessLevel, LEVEL_LABEL, ProjectAccessGuard, Injectable, ProjectAccessRow, ProjectAccessService, Injectable, DirectoryMembership (+4 more)
...
Cohesion: 0.13
Nodes (14): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max, Min, Type, ProjectsController (+6 more)

## Knowledge Gaps
- **496 isolated node(s):** `AppRole`, `lookupCache`, `RANK`, `ProjectDashboardTab`, `ACTIONS` (+491 more)
...
- **Why does `toHttpException()` connect `WorkflowPanel.tsx` to `Community 1`, `Injectable`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 16`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `Community 50`, `ProjectsController`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `PaginationQueryDto`, `react-dom`, `@nestjs/swagger`, `AppModule`, `status-reports.repository.ts`, `AuthUser`, `CreateLookupValueDto`, `eslint-plugin-react-hooks`, `RisksService`, `ProgramOutcomesService`?**
  _High betweenness centrality (0.230) - this node is a cross-community bridge._
- **Why does `ms()` connect `Community 16` to `auth-context.tsx`?**
  _High betweenness centrality (0.228) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `.add` to `Community 1`, `Injectable`, `.update`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `CreateProjectDto`, `Community 28`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `Community 50`, `action-items.repository.ts`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `WorkflowPanel.tsx`, `README.md`, `@nestjs/swagger`, `AppModule`, `eslint-plugin-react-hooks`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **What connects `AppRole`, `lookupCache`, `RANK` to the rest of the system?**
