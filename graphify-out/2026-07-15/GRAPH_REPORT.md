...
## Summary
- 1244 nodes · 2409 edges · 64 communities (55 shown, 9 thin omitted)
...
Cohesion: 0.05
Nodes (35): collection, compilerOptions, deleteOutDir, plugins, $schema, sourceRoot, CreateMilestoneDto, ApiProperty (+27 more)
...
Cohesion: 0.10
Nodes (26): AddAttachmentDialog(), AddIssueDialog(), emptyPerson(), AddLinkDialog(), AddResourceDialog(), Props, AddUpdateDialog(), Resource (+18 more)
...
Cohesion: 0.25
Nodes (15): STATUSES, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Button(), buttonVariants, Dialog() (+7 more)
...
Cohesion: 0.05
Nodes (38): ArrayMaxSize, AuthUser, CurrentUser, HistoryEntry, HistoryInsert, ActionItemsController, ApiBody, Body (+30 more)
...
Cohesion: 0.12
Nodes (24): Props, Props, Props, Props, Props, ActionItem, ActionItemOwner, apiDelete() (+16 more)
...
Cohesion: 0.16
Nodes (24): CategorySelect(), Props, EditProjectDialog(), Props, SelectContent(), SelectItem(), SelectTrigger(), SelectValue() (+16 more)
...
## Knowledge Gaps
- **276 isolated node(s):** `What this project is`, `Tech stack`, `Hard architectural rules (do not violate)`, `Repo & environment`, `Current state — Phase 1 complete (full CRUD)` (+271 more)
...
- **Why does `AuthUser` connect `CreateActionItemDto` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `toHttpException`, `PeopleRepository`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `CreateActionItemDto` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `toHttpException`, `PeopleRepository`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `Community 3` to `CreateActionItemDto`, `Community 1`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `toHttpException`, `PeopleRepository`, `StatusReportDetailPage.tsx`?**
