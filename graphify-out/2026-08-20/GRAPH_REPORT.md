...
## Corpus Check
- 379 files · ~182,501 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2750 nodes · 6564 edges · 134 communities (116 shown, 18 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 13 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `81bafcd8`
...
8. `toast` - 39 edges
9. `RecordHistoryService` - 36 edges
10. `cn()` - 36 edges
...
- `ProfileRow` --references--> `AppRole`  [EXTRACTED]
  backend/src/modules/access-admin/access-admin.repository.ts → backend/src/common/access/access.logic.ts
...
Cohesion: 0.08
Nodes (40): Props, Button(), buttonVariants, Skeleton(), Chip(), STATUS_CHIP, usersApi, statusReportsApi (+32 more)
...
Cohesion: 0.05
Nodes (48): AddAttachmentDialog(), AddLinkDialog(), AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog(), SectionCard() (+40 more)
...
Cohesion: 0.10
Nodes (13): PortfolioReportsController, Controller, ReportsModule, Module, MilestoneDateRow, MilestoneProgressRow, Person, ReportProjectRow (+5 more)
...
Cohesion: 0.12
Nodes (17): App(), AddIssueDialog(), emptyPerson(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), today() (+9 more)
...
Cohesion: 0.06
Nodes (45): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), dateParts() (+37 more)
...
Cohesion: 0.13
Nodes (9): ProjectAccessGuard, Injectable, ProjectAccessService, Injectable, DashboardActionItemRow, DashboardMilestoneRow, DashboardProjectRow, DashboardSource (+1 more)
...
Cohesion: 0.19
Nodes (8): DashboardController, Controller, DashboardModule, Module, DashboardRepository, Injectable, DashboardService, Injectable
...
Cohesion: 0.18
Nodes (32): FREQUENCIES, STATUSES, ACCESS_LEVELS, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, ConfirmDeleteButton() (+24 more)
...
Cohesion: 0.07
Nodes (28): 1. Baseline, measured 2026-08-18 on this branch, 2026-08-19 — B1, public surface per module, 2026-08-19 — B2 + B3, the rule and the last reach-in, 2026-08-19 — B4, contract conformance. **Phase B complete.**, 2026-08-19 — Clearing the register before Phase 1 (APPROVED BEHAVIOUR CHANGES), 2026-08-19 — Gate review, then one APPROVED BEHAVIOUR CHANGE, 2026-08-19 — Phase 0, `access-admin` (seam first, then net), 2026-08-19 — Phase 0, `kpis`. **The three high-value modules are done.** (+20 more)
...
Cohesion: 0.05
Nodes (38): HistoryEntry, HistoryInsert, ActionItemsController, ApiBody, Body, Controller, Get, Param (+30 more)

### Community 59 - "@types/node"
Cohesion: 0.08
Nodes (14): logger, toHttpException(), AccessAdminRepository, ProfileRoleRow, ProfileRow, Injectable, Kpi, KpiActionPlan (+6 more)
...
Cohesion: 0.06
Nodes (34): ArrayMinSize, AuthUser, CurrentUser, Delete, Delete, Get, ImportRowsDto, ApiProperty (+26 more)
...
Cohesion: 0.09
Nodes (15): KpisController, ApiBody, Body, Controller, Delete, Get, Param, Patch (+7 more)
...
Cohesion: 0.10
Nodes (29): AdminOnly(), MinAppRole(), ProjectAccess(), RequireCapability(), AccessLevel, APP_ROLES, AppRole, atLeastRole() (+21 more)
...
Cohesion: 0.09
Nodes (17): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, AttachmentsRepository, PARENT_TABLES, Injectable (+9 more)

### Community 84 - "users.service.ts"
Cohesion: 0.15
Nodes (6): Issue, IssueListItem, IssuesRepository, Injectable, IssuesService, Injectable
...
Cohesion: 0.24
Nodes (8): ImportSummary, FieldDef, ImportPage(), MILESTONE_FIELDS, PROJECT_FIELDS, RowCheck, validDate(), validNumber()
...
Cohesion: 0.08
Nodes (23): CreatePersonDto, ApiProperty, ApiPropertyOptional, IsEmail, IsIn, IsOptional, IsString, IsUUID (+15 more)

### Community 114 - "CreateLookupValueDto"
Cohesion: 0.16
Nodes (12): AppModule, Module, AccessModule, Global, Module, bootstrap(), AccessAdminModule, Module (+4 more)

### Community 115 - "CreateMilestoneDto"
Cohesion: 0.09
Nodes (18): ApiConsumes, AttachmentsController, ApiBody, Body, Controller, Get, Param, Patch (+10 more)
...
### Community 121 - ".me"
Cohesion: 0.19
Nodes (13): calculatedProgress(), INITIATIVE_BUCKETS, initiativeBucket, MilestoneProgressRow, plannedProgress(), ChartPoint, CLOSED_PROJECT, DashboardData (+5 more)
...
Cohesion: 0.33
Nodes (6): UpdateMilestoneDto, Milestone, MilestoneListItem, COLUMN_SPEC, CREATE_DEFAULTS, @nestjs/swagger
...
Cohesion: 0.07
Nodes (29): AddKpiDialog(), emptyPerson(), Props, accessApi, AdminLookupRow, adminLookupsApi, AdminLookupTable, AdminUser (+21 more)
...
## Knowledge Gaps
- **579 isolated node(s):** `COLUMN_SPEC`, `CREATE_DEFAULTS`, `COLUMN_SPEC`, `CREATE_DEFAULTS`, `1. Defects and gaps` (+574 more)
...
- **Why does `fetchMe()` connect `Community 9` to `WorkflowPanel.tsx`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `ProjectSectionsController`, `Community 16`, `CreateProjectDto`, `UsersModule`, `ProjectsRepository`, `Community 44`, `Community 45`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `CreateMilestoneDto`, `PaginationQueryDto`, `react-dom`, `links.service.ts`, `RecordHistoryService`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `ActionItemsController`, `ts-loader`, `CreateMilestoneDto`, `project-sections.service.ts`, `ProjectSectionsController`, `milestones.service.ts`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `.update`, `AdjustWeightsDto`, `Community 5`, `Community 10`, `Community 12`, `ProjectSectionsController`, `Community 16`, `nest-cli.json`, `ProjectsRepository`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `CreateMilestoneDto`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `users.service.ts`, `templates.service.ts`, `ActionItemsController`, `AuthUser`, `action-items.repository.ts`, `ts-loader`, `CreateMilestoneDto`, `project-sections.service.ts`, `.me`, `ProjectSectionsController`, `UpdateMeDto`, `milestones.service.ts`?**
