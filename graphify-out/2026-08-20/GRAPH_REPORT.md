...
Cohesion: 0.06
Nodes (35): devDependencies, eslint, @eslint/eslintrc, @eslint/js, eslint-plugin-prettier, globals, jest, @nestjs/schematics (+27 more)
...
Cohesion: 0.07
Nodes (34): App(), AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, NotificationBell() (+26 more)
...
Cohesion: 0.06
Nodes (42): AddAttachmentDialog(), AddLinkDialog(), Props, AddResourceDialog(), AddUpdateDialog(), AdjustWeightsDialog(), OutcomeDialog(), SaveTemplateDialog() (+34 more)
...
Cohesion: 0.09
Nodes (27): Props, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle() (+19 more)
...
Cohesion: 0.22
Nodes (22): FREQUENCIES, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Props, Props, FieldError() (+14 more)
...
Cohesion: 0.07
Nodes (29): AuthUser, CurrentUser, Delete, Delete, DashboardController, Controller, Get, Delete (+21 more)
...
### Community 73 - ".add"
Cohesion: 0.15
Nodes (17): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParent, AttachmentParentType, PARENT_TABLES, COLUMN_SPEC, PARENT_TYPES (+9 more)
...
Cohesion: 0.10
Nodes (6): AuthedRequest, SupabaseAuthGuard, Injectable, DatabaseService, Injectable, ProgramOutcome
...
Cohesion: 0.08
Nodes (38): ExportCsvDialog(), Props, TagChips(), GlobalActionItem, GlobalMilestone, importApi, ImportSummary, registryApi (+30 more)
...
Cohesion: 0.09
Nodes (14): ApiTags, ProjectScoped(), Issue, IssueListItem, IssuesRepository, Injectable, IssuesService, Injectable (+6 more)
...
Cohesion: 0.06
Nodes (36): AddKpiDialog(), emptyPerson(), Props, CommandPalette(), Entry, hitPath(), KIND_META, Props (+28 more)
...
Cohesion: 0.06
Nodes (25): SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, ACTION_BODY, CyclesController, ReportsController (+17 more)
...
## Knowledge Gaps
- **579 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+574 more)
...
- **Why does `fetchMe()` connect `Community 8` to `ProjectsRepository`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `auth-context.tsx` to `.update`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 11`, `ProjectSectionsController`, `CreateProjectDto`, `HomePage`, `Community 20`, `UsersModule`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `Community 50`, `PeopleRepository`, `CreateMilestoneDto`, `react-dom`, `links.service.ts`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `ActionItemsController`, `ts-loader`, `CreateMilestoneDto`, `project-sections.service.ts`, `ProjectSectionsController`, `milestones.service.ts`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `ProgramOutcomesController` to `Community 1`, `.update`, `Community 5`, `Community 6`, `Community 10`, `Community 11`, `ProjectSectionsController`, `Community 16`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `@types/node`, `CreateMilestoneDto`, `PaginationQueryDto`, `RecordHistoryService`, `.add`, `WorkflowPanel.tsx`, `lookups.service.ts`, `AddMilestoneDialog.tsx`, `users.service.ts`, `templates.service.ts`, `ActionItemsController`, `AuthUser`, `action-items.repository.ts`, `ts-loader`, `project-sections.service.ts`, `.me`, `UpdateAttachmentDto`, `ProjectSectionsController`, `UpdateMeDto`, `milestones.service.ts`?**
