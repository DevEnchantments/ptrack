...
Cohesion: 0.14
Nodes (14): ApiBody, ApiConsumes, AttachmentsController, Body, Controller, CurrentUser, Delete, Get (+6 more)
...
Cohesion: 0.16
Nodes (5): Delete, ActionItemsService, Owners, ownersLabel(), Injectable
...
Cohesion: 0.04
Nodes (66): Props, Props, Props, Props, Props, CommandPalette(), Entry, hitPath() (+58 more)
...
Cohesion: 0.06
Nodes (30): RecordHistoryService, Injectable, AdjustWeightsDto, ApiProperty, ApiPropertyOptional, IsArray, IsNumber, IsOptional (+22 more)
...
Cohesion: 0.22
Nodes (6): CreateCommentDto, ApiProperty, IsString, MinLength, UpdateActionItemDto, @nestjs/swagger
...
Cohesion: 0.17
Nodes (12): formatSize(), Props, TaskAttachments(), ActionItemComment, actionItemsApi, attachmentsApi, ActionItemDetailPage(), commentAuthor() (+4 more)
...
Cohesion: 0.27
Nodes (8): Attachment, AttachmentDetail, AttachmentListItem, AttachmentParentType, PARENT_TABLES, PARENT_TYPES, parseParent(), UploadedFileLike
...
## Knowledge Gaps
- **452 isolated node(s):** `Owners`, `PARENT_TABLES`, `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)` (+447 more)
...
- **Why does `toHttpException()` connect `Get` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `AddMilestoneDialog.tsx`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `CreateLinkDto`, `lookups.service.ts`, `@nestjs/swagger`, `ApiProperty`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `action-items.repository.ts`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `CreateLinkDto`, `RecordHistoryService`, `README.md`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 10`, `CreateProjectDto`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `action-items.repository.ts`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `CreateLinkDto`, `RecordHistoryService`, `README.md`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **What connects `Owners`, `PARENT_TABLES`, `1.1 Project → `projects` (EXTEND)` to the rest of the system?**
