...
## Summary
- 2188 nodes · 4955 edges · 113 communities (101 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `991b335b`
...
Cohesion: 0.07
Nodes (18): AuthUser, Delete, Delete, NotificationsController, Controller, Get, Param, Post (+10 more)
...
Cohesion: 0.04
Nodes (68): AddAttachmentDialog(), Props, AddLinkDialog(), AddResourceDialog(), Props, AddUpdateDialog(), AdjustWeightsDialog(), Props (+60 more)
...
Cohesion: 0.10
Nodes (29): Props, AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), Props, STATUSES, today() (+21 more)
...
Cohesion: 0.14
Nodes (15): AppLayout(), NAV_ITEMS, CommandPalette(), Entry, hitPath(), KIND_META, Props, NotificationBell() (+7 more)
...
Cohesion: 0.13
Nodes (14): ActionItemsModule, Module, DashboardModule, Module, KpisModule, Module, ResourcesModule, Module (+6 more)
...
Cohesion: 0.06
Nodes (34): App(), AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), today(), AddIssueDialog() (+26 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.05
Nodes (50): Props, Props, Props, Props, Props, Props, ActionItemOwner, AdminLookupRow (+42 more)
...
Cohesion: 0.17
Nodes (12): AttachmentsModule, Module, IssuesModule, Module, LinksModule, Module, NotificationsModule, Module (+4 more)
...
Cohesion: 0.06
Nodes (56): AddStatusReportDialog(), today(), AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, dateParts() (+48 more)

### Community 73 - ".add"
Cohesion: 0.08
Nodes (18): ActionItemsRepository, Injectable, ActionItemsService, Owners, ownersLabel(), Injectable, CreateActionItemDto, ApiProperty (+10 more)

### Community 74 - "DatabaseService"
Cohesion: 0.08
Nodes (23): AuthedRequest, logger, DatabaseService, Injectable, Issue, IssueListItem, Link, LinkListItem (+15 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.19
Nodes (35): STATUSES, FREQUENCIES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, CategorySelect(), Props, ConfirmDeleteButton() (+27 more)
...
Cohesion: 0.14
Nodes (17): CurrentUser, SubmissionActionDto, ApiPropertyOptional, IsOptional, IsString, MaxLength, ACTION_BODY, ReportsController (+9 more)
...
Cohesion: 0.10
Nodes (21): db, ensure(), env, PROGRAMS, root, rows(), STANDARD, formatAed() (+13 more)
...
- **Why does `toHttpException()` connect `Community 28` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 26`, `Community 27`, `nest-cli.json`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `.add`, `react-dom`, `.add`, `DatabaseService`, `2. Findings per surface`, `milestones.repository.ts`, `AppModule`, `Get`, `PeoplePage.tsx`, `users.module.ts`, `ApiProperty`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `🚀 Quick start`, `transform`, `AppModule`, `ApiProperty`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `WorkflowPanel.tsx` to `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 26`, `status-reports.repository.ts`, `Community 44`, `Community 45`, `RecordHistoryService`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `PaginationQueryDto`, `WorkflowPanel.tsx`, `.add`, `.add`, `🚀 Quick start`, `transform`, `AppModule`, `ApiProperty`?**
