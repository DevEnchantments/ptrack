...
## Summary
- 2296 nodes · 5213 edges · 121 communities (108 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8a6355e8`
...
Cohesion: 0.06
Nodes (31): CreateProgramOutcomeDto, ApiProperty, ApiPropertyOptional, IsDateString, IsInt, IsOptional, IsString, MaxLength (+23 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (14): AuthUser, CurrentUser, Delete, Delete, Delete, Get, Param, Post (+6 more)
...
Cohesion: 0.12
Nodes (30): CategorySelect(), Props, EditProjectDialog(), FY_YEARS, personFromProfile(), PersonAutocomplete(), Props, SelectContent() (+22 more)
...
Cohesion: 0.09
Nodes (35): App(), Chip(), GlobalActionItem, GlobalMilestone, registryApi, reportsApi, AuthProvider(), usePageTitle() (+27 more)
...
Cohesion: 0.11
Nodes (20): AvatarCluster(), colorOf(), InitialsAvatar(), initialsOf(), PALETTE, initials(), Props, RecordHistory() (+12 more)
...
Cohesion: 0.08
Nodes (19): CreateSavedSearchDto, ApiProperty, IsString, MaxLength, MinLength, SearchController, ApiBody, Body (+11 more)
...
Cohesion: 0.10
Nodes (16): logger, DatabaseService, Injectable, Milestone, MilestoneListItem, ProgramOutcome, ChildRow, SavedSearch (+8 more)
...
## Knowledge Gaps
- **475 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+470 more)
...
- **Why does `toHttpException()` connect `AddMilestoneDialog.tsx` to `Community 1`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `nest-cli.json`, `Community 34`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `PaginationQueryDto`, `CreateLinkDto`, `WorkflowPanel.tsx`, `WorkflowPanel.tsx`, `AddMilestoneDialog.tsx`, `@nestjs/swagger`, `Get`, `PeoplePage.tsx`, `ProjectsGrid.tsx`, `eslint-plugin-react-hooks`, `shadcn`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 10`, `CreateProjectDto`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 44`, `Community 45`, `RecordHistoryService`, `@nestjs/swagger`, `PeopleRepository`, `.add`, `CreateLinkDto`, `WorkflowPanel.tsx`, `.add`, `.add`, `WorkflowPanel.tsx`, `README.md`, `lookups.service.ts`, `DatabaseModule`, `ProjectsGrid.tsx`, `RecordHistoryService`?**
