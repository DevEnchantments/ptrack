...
Cohesion: 0.10
Nodes (18): AuthUser, CurrentUser, Delete, ApiBody, Body, Post, Delete, Delete (+10 more)
...
Cohesion: 0.09
Nodes (31): Props, TasksCard(), ACTIONS, attachmentUploader(), collapsePrefsKey(), EXT_STYLES, fileExt(), formatReportDate() (+23 more)
...
Cohesion: 0.08
Nodes (46): CategorySelect(), Props, Props, Card(), CardAction(), CardContent(), CardDescription(), CardFooter() (+38 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.04
Nodes (62): Props, Props, Props, Props, Props, Props, AppLayout(), NAV_ITEMS (+54 more)
...
Cohesion: 0.06
Nodes (47): Props, TagChips(), attachmentsApi, GlobalActionItem, GlobalMilestone, importApi, ImportSummary, KpiReading (+39 more)
...
Cohesion: 0.15
Nodes (12): logger, Issue, IssueListItem, Link, LinkListItem, Resource, ResourceListItem, Risk (+4 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.17
Nodes (26): FREQUENCIES, ACCESS_LEVELS, EDITABLE_OPTIONS, VIEWABLE_OPTIONS, ConfirmDeleteButton(), Props, Props, FY_YEARS (+18 more)
...
Cohesion: 0.09
Nodes (26): App(), AddIssueDialog(), emptyPerson(), AddKpiDialog(), emptyPerson(), AddMilestoneDialog(), emptyOwner(), ownerFromMilestone() (+18 more)

### Community 82 - "🚀 Quick start"
Cohesion: 0.09
Nodes (33): Props, Props, Props, Props, Props, Props, formatAed(), milestoneShares() (+25 more)
...
Cohesion: 0.06
Nodes (44): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), STATUSES, today(), AddStatusReportDialog() (+36 more)
...
## Knowledge Gaps
- **450 isolated node(s):** `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)`, `1.4 Risk → BUILD `risks` (new module, follows our new-record-type recipe)`, `1.5 Issue → `issues` (EXTEND)` (+445 more)
...
- **Why does `toHttpException()` connect `Community 20` to `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 16`, `CreateProjectDto`, `Community 26`, `Community 27`, `AddMilestoneDialog.tsx`, `status-reports.repository.ts`, `Community 44`, `RecordHistoryService`, `Community 50`, `ProjectsController`, `@nestjs/swagger`, `@types/node`, `PeopleRepository`, `auth-context.tsx`, `.add`, `.add`, `DatabaseService`, `milestones.repository.ts`, `@nestjs/swagger`, `Get`, `PeoplePage.tsx`, `ApiProperty`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `Community 28`, `AddMilestoneDialog.tsx`, `nest-cli.json`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `.add`, `WorkflowPanel.tsx`, `AppModule`, `tailwind-merge`, `ApiProperty`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 8` to `Community 1`, `Community 6`, `Community 9`, `Community 10`, `CreateProjectDto`, `Community 26`, `Community 28`, `nest-cli.json`, `status-reports.repository.ts`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `Community 50`, `@nestjs/swagger`, `PeopleRepository`, `react-dom`, `.add`, `WorkflowPanel.tsx`, `AppModule`, `tailwind-merge`, `ApiProperty`?**
