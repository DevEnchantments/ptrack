...
Cohesion: 0.14
Nodes (11): AuthUser, CurrentUser, Delete, Delete, Delete, Get, Delete, Delete (+3 more)
...
Cohesion: 0.15
Nodes (20): Props, ACTIONS, CommandPalette(), Entry, Props, ActionItemOwner, apiDelete(), apiGet() (+12 more)
...
Cohesion: 0.11
Nodes (32): Props, AddIssueDialog(), emptyPerson(), Props, Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today() (+24 more)
...
Cohesion: 0.16
Nodes (14): App(), AppLayout(), NAV_ITEMS, EditProjectDialog(), personFromProfile(), ProtectedRoute(), AuthContext, AuthContextValue (+6 more)
...
Cohesion: 0.13
Nodes (31): AddRiskDialog(), emptyPerson(), CategorySelect(), Props, PersonAutocomplete(), Props, Label(), SelectContent() (+23 more)
...
Cohesion: 0.19
Nodes (12): NotificationBell(), timeAgo(), KIND_CLASSES, TOAST_MS, Toaster(), ToastItem, AppNotification, notificationsApi (+4 more)

### Community 75 - "AddStatusReportDialog.tsx"
Cohesion: 0.21
Nodes (16): Button(), buttonVariants, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader() (+8 more)
...
Cohesion: 0.16
Nodes (15): Props, SectionCard(), Skeleton(), attachmentsApi, statusReportsApi, usePageTitle(), AttachmentDetailPage(), formatSize() (+7 more)
...
## Knowledge Gaps
- **361 isolated node(s):** `$schema`, `includeCoAuthoredBy`, `defaultMode`, `Bash(npm run dev:*)`, `Bash(npm run start:*)` (+356 more)
...
- **Why does `toHttpException()` connect `Community 16` to `Community 1`, `Community 2`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `@types/node`, `@nestjs/swagger`, `PeopleRepository`, `ResourcesRepository`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 6`, `Community 7`, `Community 8`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 10`, `.add`, `Community 13`, `CreateProjectDto`, `RecordHistoryService`, `ApiPropertyOptional`, `Community 26`, `Community 27`, `PeopleRepository`, `auth-context.tsx`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `nest-cli.json` to `Community 1`, `Community 2`, `Community 34`, `Community 6`, `Community 7`, `Community 8`, `status-reports.repository.ts`, `CreateProjectDto`, `Community 10`, `.add`, `Community 13`, `CreateProjectDto`, `RecordHistoryService`, `ApiPropertyOptional`, `Community 26`, `Community 27`, `PeopleRepository`, `auth-context.tsx`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
