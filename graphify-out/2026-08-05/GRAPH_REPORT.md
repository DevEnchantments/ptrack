...
Cohesion: 0.05
Nodes (40): collection, compilerOptions, deleteOutDir, plugins, $schema, sourceRoot, HistoryEntry, AdjustWeightsDto (+32 more)
...
Cohesion: 0.12
Nodes (11): NotificationsModule, Module, AppNotification, NotificationsRepository, Injectable, NotificationsService, Injectable, ProjectsModule (+3 more)
...
Cohesion: 0.12
Nodes (15): AppModule, Module, bootstrap(), DashboardController, DashboardModule, Module, ChartPoint, CLOSED_PROJECT (+7 more)
...
Cohesion: 0.06
Nodes (34): PaginationQueryDto, ApiPropertyOptional, IsInt, IsOptional, Max, Min, Type, CreateUpdateDto (+26 more)
...
Cohesion: 0.05
Nodes (32): ArrayMaxSize, HistoryInsert, ActionItemsController, Controller, Get, Param, ActionItemsModule, Module (+24 more)

### Community 48 - "status-reports.repository.ts"
Cohesion: 0.08
Nodes (36): Props, Props, Props, Props, NotificationBell(), timeAgo(), personName(), Props (+28 more)
...
Cohesion: 0.15
Nodes (9): UpdateIssueDto, IssuesModule, Module, Issue, IssueListItem, IssuesRepository, Injectable, IssuesService (+1 more)
...
Cohesion: 0.12
Nodes (21): App(), ProtectedRoute(), Chip(), attachmentsApi, CycleStatusReport, reportsApi, AuthProvider(), usePageTitle() (+13 more)
...
Cohesion: 0.12
Nodes (32): CategorySelect(), Props, EditProjectDialog(), personFromProfile(), Props, PersonAutocomplete(), Props, SelectContent() (+24 more)
...
Cohesion: 0.11
Nodes (17): AddIssueDialog(), emptyPerson(), AddRiskDialog(), emptyPerson(), AppLayout(), NAV_ITEMS, ACTIONS, CommandPalette() (+9 more)
...
## Knowledge Gaps
- **360 isolated node(s):** `ChartPoint`, `DashboardData`, `1.1 Project → `projects` (EXTEND)`, `1.2 Milestone → `milestones` (mostly HAVE — big head start)`, `1.3 Task / Work Activity → `action_items` (EXTEND)` (+355 more)
...
- **Why does `toHttpException()` connect `@types/node` to `Community 1`, `Community 6`, `Community 7`, `Community 10`, `Community 12`, `Community 13`, `CreateProjectDto`, `Community 20`, `Community 26`, `Community 34`, `ProjectsRepository`, `status-reports.repository.ts`, `Community 45`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `PeopleRepository`, `PaginationQueryDto`, `.add`, `WorkflowPanel.tsx`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `@nestjs/swagger` connect `Community 6` to `Community 1`, `Community 34`, `nest-cli.json`, `CreateRiskDto`, `status-reports.repository.ts`, `Community 7`, `CreateProjectDto`, `Community 10`, `Community 44`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `Community 26`, `Community 27`, `PeopleRepository`, `AddMilestoneDialog.tsx`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `nest-cli.json` to `Community 1`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 16`, `Community 26`, `Community 34`, `status-reports.repository.ts`, `nest-cli.json`, `RecordHistoryService`, `ProjectsController`, `action-items.repository.ts`, `PeopleRepository`, `.add`, `CreateRiskDto`, `.add`, `.add`?**
