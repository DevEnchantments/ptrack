...
## Corpus Check
- 138 files · ~40,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1219 nodes · 2157 edges · 69 communities (61 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53076402`
...
1. `toHttpException()` - 43 edges
2. `cn()` - 34 edges
3. `@nestjs/swagger` - 33 edges
4. `DatabaseService` - 22 edges
5. `compilerOptions` - 22 edges
6. `compilerOptions` - 20 edges
7. `AttachmentsRepository` - 17 edges
8. `CreateMilestoneDto` - 17 edges
9. `CreateProjectDto` - 17 edges
10. `Button()` - 17 edges
...
Cohesion: 0.07
Nodes (28): CreateMilestoneDto, ApiProperty, ApiPropertyOptional, IsArray, IsBoolean, IsDateString, IsIn, IsOptional (+20 more)
...
Cohesion: 0.09
Nodes (17): StatusReportsController, ApiBody, Body, Controller, CurrentUser, Delete, Get, Param (+9 more)
...
Cohesion: 0.09
Nodes (16): IssuesController, ApiBody, Body, Controller, CurrentUser, Delete, Get, Param (+8 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (16): LinksController, ApiBody, Body, Controller, CurrentUser, Delete, Get, Param (+8 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (18): ApiBody, Body, Controller, CurrentUser, Delete, Get, Param, Patch (+10 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (16): ResourcesController, ApiBody, Body, Controller, CurrentUser, Delete, Get, Param (+8 more)
...
Cohesion: 0.16
Nodes (21): CategorySelect(), Props, SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), Lookup, lookupsApi (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.17
Nodes (16): ACCESS_LEVELS, AddPersonDialog(), emptyPerson(), memberName(), Props, Props, Button(), buttonVariants (+8 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (46): AddAttachmentDialog(), Props, AddIssueDialog(), emptyPerson(), Props, AddLinkDialog(), Props, AddResourceDialog() (+38 more)
...
Cohesion: 0.14
Nodes (17): AddStatusReportDialog(), EDITABLE_OPTIONS, Props, today(), VIEWABLE_OPTIONS, dateParts(), MiniCalendar(), MONTHS (+9 more)
...
Cohesion: 0.24
Nodes (14): Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch(), apiPost(), apiUpload(), authHeader() (+6 more)
...
Cohesion: 0.19
Nodes (17): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), DialogDescription() (+9 more)
...
Cohesion: 0.11
Nodes (19): ArrayMaxSize, ActionItem, ActionItemComment, ActionItemListItem, CreateActionItemDto, ApiProperty, ApiPropertyOptional, IsArray (+11 more)
...
Cohesion: 0.18
Nodes (11): CreateIssueDto, ApiProperty, ApiPropertyOptional, IsArray, IsIn, IsOptional, IsString, IsUUID (+3 more)
...
Cohesion: 0.24
Nodes (11): AddMilestoneDialog(), emptyOwner(), ownerFromMilestone(), profileName(), STATUSES, today(), PersonAutocomplete(), Props (+3 more)
...
Cohesion: 0.16
Nodes (18): AddActionItemDialog(), emptyOwner(), ownerFromItem(), ownersFromItem(), profileName(), Props, STATUSES, today() (+10 more)

### Community 68 - "links.repository.ts"
Cohesion: 0.29
Nodes (6): collection, compilerOptions, deleteOutDir, plugins, $schema, sourceRoot

## Knowledge Gaps
- **276 isolated node(s):** `Props`, `VIEWABLE_OPTIONS`, `EDITABLE_OPTIONS`, `ActionItemOwner`, `ActionItemComment` (+271 more)
...
- **Why does `@nestjs/swagger` connect `supabase-error.ts` to `CreateActionItemDto`, `Community 1`, `Community 34`, `Community 3`, `links.repository.ts`, `attachments.repository.ts`, `Community 6`, `Community 7`, `Community 8`, `EditProjectDialog.tsx`, `Community 10`, `Community 5`, `Community 9`, `StatusReportDetailPage.tsx`, `ProjectsRepository`, `AttachmentDetailPage.tsx`, `StatusReportDetailPage.tsx`, `AddActionItemDialog`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `toHttpException()` connect `ProjectsRepository` to `CreateActionItemDto`, `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 17`, `Community 28`, `AttachmentDetailPage.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `CreateProjectDto` connect `CreateProjectDto` to `ProjectsRepository`, `Community 31`?**
