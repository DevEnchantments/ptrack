...
## Corpus Check
- 138 files · ~38,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1171 nodes · 2261 edges · 73 communities (59 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ef10f47`
...
Cohesion: 0.07
Nodes (23): collection, compilerOptions, deleteOutDir, plugins, $schema, sourceRoot, CreateIssueDto, IsArray (+15 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (16): CreateLinkDto, IsArray, IsBoolean, IsOptional, IsString, MaxLength, UpdateLinkDto, LinksController (+8 more)
...
Cohesion: 0.27
Nodes (18): STATUSES, ACCESS_LEVELS, CategorySelect(), Props, PersonAutocomplete(), Props, Dialog(), DialogTitle() (+10 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (14): AddLinkDialog(), Props, AddStatusReportDialog(), EDITABLE_OPTIONS, today(), VIEWABLE_OPTIONS, DialogContent(), DialogDescription() (+6 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (31): Props, AddIssueDialog(), emptyPerson(), AddPersonDialog(), emptyPerson(), memberName(), Props, AddResourceDialog() (+23 more)
...
Cohesion: 0.06
Nodes (30): ArrayMaxSize, logger, toHttpException(), ActionItemsController, Body, Controller, Delete, Get (+22 more)
...
Cohesion: 0.12
Nodes (24): AddAttachmentDialog(), Props, Props, Props, ActionItemOwner, apiDelete(), apiGet(), apiPatch() (+16 more)
...
Cohesion: 0.11
Nodes (18): AppModule, Module, ActionItemsModule, Module, IssuesModule, Module, LinksModule, Module (+10 more)

### Community 32 - "Community 32"
Cohesion: 0.12
Nodes (15): AuthUser, CurrentUser, Body, Get, Param, Patch, Post, Body (+7 more)

### Community 33 - "Community 33"
Cohesion: 0.36
Nodes (7): Props, StatusReport, StatusReportDetail, ACCESS_LABELS, authorName(), longDate(), StatusReportDetailPage()
...
Cohesion: 0.20
Nodes (11): projectsApi, Props, StepAccess(), StepConfirmation(), Props, StepDetails(), Props, StepProject() (+3 more)
...
### Community 61 - "ProjectsController"
Cohesion: 0.19
...
Cohesion: 0.33
Nodes (7): EditProjectDialog(), Props, Button(), buttonVariants, categoriesApi, Project, ProjectDetail
...
- **Why does `toHttpException()` connect `Community 17` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `ProjectsRepository`, `Community 10`, `Community 9`, `Community 27`, `Community 28`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 32` to `UpdateProjectDto`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 17`, `ProjectsController`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Community 32` to `UpdateProjectDto`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 17`, `ProjectsController`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
